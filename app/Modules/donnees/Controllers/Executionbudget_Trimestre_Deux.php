...
class Executionbudget_Trimestre_Deux extends BaseController
{
  protected $session;
  protected $ModelPs;
  ...
  public function index()
  {
    ...
    $data=$this->urichk();
    return view('App\Modules\donnees\Views\Executionbudget_Trimestre_Deux_view',$data);
  }
  ...
  public function importfile()
  {
      ...
      { 
        ...
        if($IMPUTATION_NUMBER==26)
        {
          ...
          if(!empty($resultatinst) && !empty($LIBELLE))
          {
            ...
            $valuecolumsinsertbrut="'".$IMPUTATION."','".$LIBELLE."',".$CREDIT_VOTE.",".$TRANSFERTS_CREDITS.",".$CREDIT_APRES_TRANSFERT.",".$ENG_BUDGETAIRE.",".$ENG_JURIDIQUE.",".$LIQUIDATION.",".$ORDONNANCEMENT.",".$PAIEMENT.",".$DECAISSEMENT.",".$ANNEE_BUDGETAIRE_ID.",'".$DATE_DEMANDE."',".$IS_TRANSFERTS.",".$INSTITUTION_ID.",".$SOUS_TUTEL_ID.",2";
            ...
            if(!empty($EXECUTION_BUDGETAIRE_BRUT_ID))
            {
              if($EXECUTION_BUDGETAIRE_BRUT_ID>0)
              {
                ...
                $columsinserte="EXECUTION_BUDGETAIRE_BRUT_ID,IMPUTATION,LIBELLE,CREDIT_VOTE,TRANSFERTS_CREDITS,CREDIT_APRES_TRANSFERT,ENG_BUDGETAIRE,ENG_JURIDIQUE,LIQUIDATION,ORDONNANCEMENT,PAIEMENT,DECAISSEMENT,ANNEE_BUDGETAIRE_ID,DATE_DEMANDE,IS_TRANSFERTS,INSTITUTION_ID,SOUS_TUTEL_ID,IS_RACCROCHE,TRIMESTRE_ID";
                $valuecolumsinserte=$EXECUTION_BUDGETAIRE_BRUT_ID.",'".$IMPUTATION."','".$LIBELLE."',".$CREDIT_VOTE.",".$TRANSFERTS_CREDITS.",".$CREDIT_APRES_TRANSFERT.",".$ENG_BUDGETAIRE.",".$ENG_JURIDIQUE.",".$LIQUIDATION.",".$ORDONNANCEMENT.",".$PAIEMENT.",".$DECAISSEMENT.",".$ANNEE_BUDGETAIRE_ID.",'".$DATE_DEMANDE."',".$IS_TRANSFERTS.",".$INSTITUTION_ID.",".$SOUS_TUTEL_ID.",0,2";
            ...
            // Debut enregistrement execution budgetaire brut new
            $insertIntoTableNew='execution_budgetaire_brut_new';
            $EXECUTION_BUDGETAIRE_BRUT_NEW_ID=$this->save_all_table($insertIntoTableNew,$columsinsertbrut,$valuecolumsinsertbrut);
            // Fin enregistrement execution budgetaire brut new

            // Debut enregistrement execution budgetaire
            if(!empty($EXECUTION_BUDGETAIRE_BRUT_NEW_ID))
            {
              if($EXECUTION_BUDGETAIRE_BRUT_NEW_ID>0)
              {
                $insertIntoTableeNew='execution_budgetaire_new';
                $columsinserte_new="EXECUTION_BUDGETAIRE_BRUT_ID,IMPUTATION,LIBELLE,CREDIT_VOTE,TRANSFERTS_CREDITS,CREDIT_APRES_TRANSFERT,ENG_BUDGETAIRE,ENG_JURIDIQUE,LIQUIDATION,ORDONNANCEMENT,PAIEMENT,DECAISSEMENT,ANNEE_BUDGETAIRE_ID,DATE_DEMANDE,IS_TRANSFERTS,INSTITUTION_ID,SOUS_TUTEL_ID,IS_RACCROCHE,TRIMESTRE_ID";
                $valuecolumsinserte_new=$EXECUTION_BUDGETAIRE_BRUT_NEW_ID.",'".$IMPUTATION."','".$LIBELLE."',".$CREDIT_VOTE.",".$TRANSFERTS_CREDITS.",".$CREDIT_APRES_TRANSFERT.",".$ENG_BUDGETAIRE.",".$ENG_JURIDIQUE.",".$LIQUIDATION.",".$ORDONNANCEMENT.",".$PAIEMENT.",".$DECAISSEMENT.",".$ANNEE_BUDGETAIRE_ID.",'".$DATE_DEMANDE."',".$IS_TRANSFERTS.",".$INSTITUTION_ID.",".$SOUS_TUTEL_ID.",0,2";
                $EXECUTION_BUDGETAIRE_NEW_ID=$this->save_all_table($insertIntoTableeNew,$columsinserte_new,$valuecolumsinserte_new);
              }
            }
            // Fin enregistrement execution budgetaire
          }
    ...
    return redirect('donnees/Executionbudget_Trimestre_Deux');
  }
}
?>