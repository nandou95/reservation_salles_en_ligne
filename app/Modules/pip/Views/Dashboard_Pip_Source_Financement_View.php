...
$.ajax({
  url : "<?=base_url('pip/Dashboard_Pip_Source_Financement/Get_financement')?>",
  type : "GET",
  dataType: "JSON",
  cache:false,
...
<script type="text/javascript">
  ...
  function liste(){
    ...
    $("#list_table").DataTable(
    {
      ...
      "oreder":[[ 0, 'desc' ]],
      "ajax":{
        url:"<?= base_url('pip/Dashboard_Pip_Source_Financement/listing')?>",
        type:"POST",
        data:{
...
function exporter()
  ...
  var ID_AXE_INTERVENTION_PND = $('#ID_AXE_INTERVENTION_PND').val();
    ...
    document.getElementById("btnexport").href = "<?=base_url('pip/Dashboard_Pip_Source_Financement/exporter/')?>"+'/'+INSTITUTION_ID+'/'+ID_AXE_INTERVENTION_PND;
}
</script>
