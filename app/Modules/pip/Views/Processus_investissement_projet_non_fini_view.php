              ...
              <div style="box-shadow: rgba(100, 100, 111, 0.25) 0px 7px 29px 0px;padding: 13px !important" class="card">
                <div class="col-md-12 d-flex">
                  <div class="col-md-6" style="float: left;">
                    <h4 style="margin-left: 1%;margin-top:10px"><?= lang('messages_lang.titre_projet_non_fini') ?></h4>
                  </div>
                      ...
                      <table id="mytable" class=" table table-striped table-bordered">
                        <thead>
                          <tr>
                            ...
                            <th><?= lang('messages_lang.nom_projet') ?></th>
...
<script>
  function liste() {
    ...
    $("#mytable").DataTable({
      ...
      "serverSide": true,
      "ajax": {
        url: "<?= base_url('pip/Processus_Investissement_Public_Demande/listing_unfished_project') ?>",
        type: "POST",
        data: {
