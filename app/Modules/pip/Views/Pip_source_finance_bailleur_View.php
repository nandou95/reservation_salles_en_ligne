              ...
              <div style="box-shadow: rgba(100, 100, 111, 0.25) 0px 7px 29px 0px" class="card">
                ...
                <div class="card-body">
                  <div class="table-responsive container " style="margin-top:50px">
                    <form action="<?=base_url('pip/Nouvelle_source_finance_bailleur')?>" id="Myform" method="POST" enctype="multipart/form-data">
                      <div class="card-body">
                        <div class="row">
                        <?php
                    ...
                    ?>
                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <?php endif ?>
                            <span class="text-danger" id="error_Names"></span>
                          </div>
                        </div>
                            <div style="" id="bouton_cart" class="col-md-12"><br>
                              <button id="bouton_envoyer" type="submit" class="btn btn-primary btn-block"><?= lang('messages_lang.bouton_ajouter') ?> <span id="loading_cart"></span></button>
                            </div>
                          </div>
                        </form>
                      </div> 
