                  ...
                  <div class="col-md-12 d-flex">
                    <div class="col-md-9" style="float: left;">
                      <h1 class="header-title text-black">
                        <?= lang('messages_lang.labelle_liste_sfp') ?>
                      </h1>
                    </div>
                    <div class="col-md-3" style="float: right;">
                      <a href="<?= base_url("pip/Nouv_Source_finance_bailleur")?>" style="float: right;margin: 40px" class="btn btn-primary"><i class="fa fa-plus" aria-hidden="true"></i> <?= lang('messages_lang.labelle_et_nouveau') ?> </a>
                    </div>
                  </div>
                </div>
                    ...
                    <div class="table-responsive" style="width: 100%;">
                      <table id="mytable" class=" table table-striped table-bordered">
                        <thead>
                          <tr>
                            <th>#</th>
                            <th><?= lang('messages_lang.th_code_bailleur') ?></th>
                            <th><?= lang('messages_lang.th_nom_source_finance') ?></th>
...
<script>
  ...
  $(document).ready(function()
  {
    ...
    $("#mytable").DataTable(
    {
      ...
      "ajax":
      {
        url:"<?= base_url('pip/Liste_Source_finance_bailleur')?>",
        type:"POST", 
      },
