              ...
              <div style="box-shadow: rgba(100, 100, 111, 0.25) 0px 7px 29px 0px;padding: 13px !important" class="card">
                <div class="col-md-12 d-flex">
                  <div class="col-md-6" style="float: left;">
                    <h4 style="margin-left: 1%;margin-top:10px"><?= lang('messages_lang.titre_pip_valide') ?></h4>
                  </div>
...
<script>
   ...
   */
   function get_pip_valider(id) {
    ...
    $("#document").DataTable({
      ...
      "oreder":[[ 0, 'desc' ]],
      "ajax":{
        url: "<?= base_url() ?>/pip/Fiche_Pip_Valider/projet_valider//" + id,
       type:"POST", 
     },
  ...
  <script>
    ...
    { 
      ...
      $("#mytable").DataTable({
        ...
        "serverSide": true,
        "ajax": {
          url: "<?= base_url('pip/Fiche_Pip_Valider/liste_projet_valider')?>",
          type: "POST",
          data: {}
        },
  ...
  <div class="modal fade" id="doc_pip">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <center><?= lang('messages_lang.titre_pip_valide') ?></center>
  ...
  function pip_doc(id)
  {
    ...
    $.ajax(
    {
      url:"<?=base_url()?>/pip/Fiche_Pip_Valider/get_valider_pip/"+id,
      type:"POST",
      dataType:"JSON",
