              ...
              <div style="box-shadow: rgba(100, 100, 111, 0.25) 0px 7px 29px 0px;padding: 13px !important" class="card">
                <div class="col-md-12 d-flex">
                  <div class="col-md-6" style="float: left;">
                    <h4 style="margin-left: 1%;margin-top:10px"><?= lang('messages_lang.titre_projet_transmis') ?></h4>
                  </div>
...
<script>
  function confirmer()
  {
    ...
    $.ajax(
					{
						type: 'POST',
						url: '<?= base_url()?>/pip/Projet_Pip_Fini/annuler_projet_complet/'+id,
              ...
              if(response == 1)
              {
							window.location.href='<?= base_url('pip/Projet_Pip_Fini/liste_pip_fini')?>'
              }
						}
				}
  ...
  function liste() 
  {
   ...
   $('#message').delay('slow').fadeOut(3000);
    ...
    $("#mytable").DataTable({
      ...
      "serverSide": true,
      "ajax": {
        url: "<?= base_url('pip/Projet_Pip_Fini/liste_projet_fini')?>",
        type: "POST",
        data: {
