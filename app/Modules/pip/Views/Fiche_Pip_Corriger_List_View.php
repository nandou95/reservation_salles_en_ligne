                ...
                <div style="box-shadow: rgba(100, 100, 111, 0.25) 0px 7px 29px 0px;padding: 13px !important" class="card">
                  <div class="col-md-12 d-flex">
                    <div class="col-md-6" style="float: left;">
                      <h4 style="margin-left: 1%;margin-top:10px"><?= lang('messages_lang.titre_pip_corriger') ?></h4>
                    </div>
                  </div>
  ...
  <div class="modal-dialog  modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel"><?= lang('messages_lang.titre_projet_propose')?></h5>
...
<script>
  ...
  function get_pip_corriger(id)
  {
    ...
    $("#document").DataTable(
    {
      ...
      "ajax":
      {
        url: "<?= base_url() ?>/pip/Fiche_Pip_Corriger/projet_corriger//" + id,
        type:"POST", 
      },
...
<script>
  ...
  { 
    ...
    $("#mytable").DataTable(
    {
      ...
      "ajax":
      {
        url: "<?= base_url('pip/Fiche_Pip_Corriger/liste_projet_corriger')?>",
        type: "POST",
        data: {}
      },
...
<div class="modal fade" id="doc_pip">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <center><?= lang('messages_lang.titre_pip_corriger') ?></center>
...
<script type="text/javascript">
  function pip_doc(id)
  {
    $.ajax(
    {
      url:"<?=base_url()?>/pip/Fiche_Pip_Corriger/get_corriger_pip/"+id,
      type:"POST",
      dataType:"JSON",
