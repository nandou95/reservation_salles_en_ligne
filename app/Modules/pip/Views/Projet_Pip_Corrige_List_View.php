              ...
              <div style="box-shadow: rgba(100, 100, 111, 0.25) 0px 7px 29px 0px;padding: 13px !important" class="card">
                <div class="col-md-12 d-flex">
                  <div class="col-md-6" style="float: left;">
                    <h4 style="margin-left: 1%;margin-top:10px"><?= lang('messages_lang.titre_projet_corriger') ?></h4>
                  </div>
              ...
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="form-group">
                      <label for="Nom" class="form-label">Institution</label>
...
function liste() 
  {
    ...
    $("#mytable").DataTable({
      ...
      "serverSide": true,
      "ajax": {
        url: "<?= base_url('pip/Projet_Pip_Corrige/liste_projet_corrige')?>",
        type: "POST",
        data: {
