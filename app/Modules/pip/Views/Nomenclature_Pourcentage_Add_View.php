              ...
              <div class="col-12">
                <div style="box-shadow: rgba(100, 100, 111, 0.25) 0px 7px 29px 0px" class="card">
                  <div style="float: right;">
                    <a href="<?php echo base_url('pip/Nomenclature_Pourcentage/liste_pourcentage_nomenclature')?>" style="float: right;margin-right: 80px;margin-top:5px" class="btn btn-primary"><i class="fa fa-list" aria-hidden="true"></i> <?= lang('messages_lang.link_list') ?></a>
                  </div>
                  <div class="car-body">
                    ...
                    <div class=" container " style="width:90%">
                      <form enctype='multipart/form-data' name="pourcent" id="pourcent" action="<?=base_url('pip/Nomenclature_Pourcentage/ajouter_pourcentage')?>" method="post" >
                        <div class="container">
                          <div class="row">
                            <div class="col-md-6">
                              <div class='form-froup'>
                                ...
                                <select class="select2 form-control" name="ID_NOMENCLATURE" id="ID_NOMENCLATURE">
                                  ...
                                  <?php  foreach ($get_nomenclature as $keys) { ?>
                                    <?php if($keys->ID_NOMENCLATURE==set_value('ID_NOMENCLATURE')) { ?>
                                ...
                                <div class="col-md-6">
                                  <div class="form-group">
                                    ...
                                    <input onpaste="return false;" type="text" maxlength="20" class="form-control allownumericwithdecimal" name="POURCENTAGE_NOMENCLATURE" id="POURCENTAGE_NOMENCLATURE" placeholder="" value="<?=set_value('POURCENTAGE_NOMENCLATURE')?>" onpaste="return false;" min="1" onkeydown="qte();" onkeyup="qte();">
                              ...
                              <div class="col-md-2 mt-5 " style="float:right;" >
                                <div class="form-group " >
                                  <button onclick="save_pourcent()" id="btn_save"  class="btn" style="float:right;background:#061e69;color:white"><?= lang('messages_lang.bouton_enregistrer') ?></button>
                                </div>
                              </div>
                            </div>
                          </form><br><br>
