                  ...
                  <div class="col-md-12 d-flex">
                    ...
                    <div class="col-md-12" style="text-align: center;">
                      <h1 class="header-title text-black">
                        Repartition de l'investissement public selon les piliers de la Vision Burundi 40-60 (en BIF)
                      </h1>
                    </div>
...
function list_pilier()
{
  ...
  $("#mytable").DataTable(
  {
    ...
    "ajax":
    {
      url:"<?= base_url('pip/Repartition_pilier/list_pilier')?>",
      type:"POST", 
      data:
      {
      } 
