              ...
              <div style="box-shadow: rgba(100, 100, 111, 0.25) 0px 7px 29px 0px;padding: 13px !important" class="card">
                <div class="col-md-12 d-flex">
                  <div class="col-md-6" style="float: left;">
                    <h4 style="margin-left: 1%;margin-top:10px"><?= lang('messages_lang.titre_projet_compiler') ?></h4>
                  </div>

                </div>
                <div class="col-md-12">
                  <form action="<?= base_url('pip/Processus_Investissement_Public/save_doc_compilation')?>" method="post"  enctype="multipart/form-data">
                  <div class="form-group col-md-8 d-flex">
                       <input type="file" name="file_compiler" accept='.pdf' class="form-control w-75 mt-4" required>
                       <button type="submit" class="btn btn-primary mt-4 ml-3 " style="width:100px;height:40px" href=""><?= lang('messages_lang.btn_televerser') ?></button>
                        </div>
                  </form>
                </div>
              <hr>
...
function liste() 
  {
    ...
    $("#mytable").DataTable({
      ...
      "serverSide": true,
      "ajax": {
        url: "<?= base_url('pip/Projet_Pip_A_Compiler/liste_projet_compiler')?>",
        type: "POST",
        data: {
