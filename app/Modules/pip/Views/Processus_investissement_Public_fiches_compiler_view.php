              ...
              <div style="box-shadow: rgba(100, 100, 111, 0.25) 0px 7px 29px 0px;padding: 13px !important" class="card">
                <div class="col-md-12 d-flex">
                  <div class="col-md-6" style="float: left;">
                    <h4 style="margin-left: 1%;margin-top:10px"><?= lang('messages_lang.titre_fiche_compile') ?></h4>
                  </div>
                ...
                <div class="row">
                  <div class="table-responsive" style="width: 100%;">
                    <table id="mytable" class=" table table-striped table-bordered">
                      <thead>
                        <tr>
                          <th><?= lang('messages_lang.th_fiche_compile') ?></th>
     ...
     <div class="modal-dialog  modal-lg">
           <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel"><?= lang('messages_lang.labelle_liste_projet') ?></h5>
                        ...
                        <table id="document" class='table table-bordered mb-0' id="table1">
                            <thead>
                                <tr>
                                    ...
                                    <th><?= lang('messages_lang.labelle_date_de_debut') ?></th>
                                    <th><?= lang('messages_lang.labelle_date_de_fin') ?></th>
                                </tr>
                            </thead>
                            <tbody>
...
<script>
   ...
   */
    function modal_odd(id) {
      ...
      "oreder":[[ 0, 'desc' ]],
      "ajax":{
         url: "<?= base_url() ?>/pip/Processus_Investissement_Public/listing_projet_sur_fiches_compil//" + id,
        type:"POST", 
      },
...
function liste() 
  {
    ...
    $("#mytable").DataTable({
      ...
      "serverSide": true,
      "ajax": {
        url: "<?= base_url('pip/Processus_Investissement_Public/listing_complilation')?>",
        type: "POST",
