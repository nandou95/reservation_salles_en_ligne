...
class Projet_Pip_Valide extends BaseController
{
  protected $library;
  protected $ModelPs;
  protected $session;
  ...
  function liste_pip_valide()
  {
    ...
    return view('App\Modules\pip\Views\Projet_Pip_Valide_List_View',$data);
  }

  function liste_projet_valide()
  {
    $session  = \Config\Services::session();
    ...
    foreach($fetch_cov_frais as $info)
    {
      ...
      $action = $action ="<a class='btn btn-primary btn-sm' title='Détail' href='".base_url("pip/Processus_Investissement_Public/demande/update/".$info->ID_DEMANDE)."' ><i class='fa fa-list'></a>";
