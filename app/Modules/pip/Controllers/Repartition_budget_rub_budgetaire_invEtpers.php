...
class Repartition_budget_rub_budgetaire_invEtpers extends BaseController
{
	protected $session;
	...
	public function index()
	{
		...
		return view('App\Modules\pip\Views\Repartition_budget_rub_budgetaire_invEtpers_list_view',$data); 
	}

	//Debut de la recuperation des projets par ministere 
	public function list_budgt_invEtpers()
	{
		$db = db_connect();
		$session  = \Config\Services::session();
