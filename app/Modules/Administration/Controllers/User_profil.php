...
// CORRECTION_LIQUIDATION_SALAIRE
			...
			$CONTROLE_BESD=$this->request->getPost('CONTROLE_BESD') != null ? 1 : 0;
			$CONTROLE_BRB=$this->request->getPost('CONTROLE_BRB') != null ? 1 : 0;
			$TRANSMISSION_BRB_MINFIN=$this->request->getPost('TRANSMISSION_BRB_MINFIN') != null ? 1 : 0;
