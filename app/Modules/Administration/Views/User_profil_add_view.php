                    ...
                    <form name="myform" id="myform" action="<?=base_url('Administration/User_profil/insert')?>" method="POST" enctype="multipart/form-data">
                      <div class="card-body">
                        ...
                        <div class="row" id="div_double_commande">
                          ...
                          <div class="col-md-4">
                            <input type="checkbox" value="1" name="CONTROLE_BRB"><span style="margin-left:5px;"></span><?=lang('messages_lang.controle_brb')?>
                          </div>
                          <div class="col-md-4">
                            <input type="checkbox" value="1" name="CONTROLE_BESD"><span style="margin-left:5px;"></span><?=lang('messages_lang.controle_besd')?>
                          </div>
                          <div class="col-md-4">
                            <input type="checkbox" value="1" name="TRANSMISSION_BRB_MINFIN"><span style="margin-left:5px;"></span><?=lang('messages_lang.label_trans_brb_minfin')?>
                          </div>
                          <div class="col-md-4">
                        ...
                        <div class="row" id="div_double_commande_salaire">
                          ...
                          <br>
                          <div class="col-md-4">
                            <input type="checkbox" value="1" name="LIQUIDATION_SALAIRE"><span style="margin-left:5px;"></span><?=lang('messages_lang.labelle_liquidation')?>
                          </div>
                          <div class="col-md-4">
                            <input type="checkbox" value="1" name="CONFIRM_LIQUIDATION_SALAIRE"><span style="margin-left:5px;"></span><?=lang('messages_lang.labelle_liquidation_confirm')?>
                          </div>
                          <div class="col-md-4">
                            <input type="checkbox" value="1" name="ORDONANCEMENT_SALAIRE"><span style="margin-left:5px;"></span><?=lang('messages_lang.labelle_ordonan')?>
                          </div>
                          <div class="col-md-4">
                            <input type="checkbox" value="1" name="PRISE_CHARGE_SALAIRE"><span style="margin-left:5px;"></span><?=lang('messages_lang.labelle_prise_en_charge')?>
                          </div>
                          <div class="col-md-4">
                            <input type="checkbox" value="1" name="ETABLISSEMENT_TD_NET"><span style="margin-left:5px;"></span><?=lang('messages_lang.labelle_TD_cas_net')?>
                          </div>
                           <div class="col-md-4">
                            <input type="checkbox" value="1" name="ETABLISSEMENT_TD_RETENUS"><span style="margin-left:5px;"></span><?=lang('messages_lang.labelle_TD_cas_retenus')?>
                          </div>
                           <div class="col-md-4">
                            <input type="checkbox" value="1" name="SIGNATURE_DIR_COMPT_SALAIRE"><span style="margin-left:5px;"></span><?=lang('messages_lang.labelle_sign_dir_comptabilite')?>
                          </div>
                          <div class="col-md-4">
                            <input type="checkbox" value="1" name="SIGNATURE_DGFP_SALAIRE"><span style="margin-left:5px;"></span><?=lang('messages_lang.labelle_signature_DGFP')?>
                          </div>
                           <div class="col-md-4">
                            <input type="checkbox" value="1" name="SIGNATURE_MIN_SALAIRE"><span style="margin-left:5px;"></span><?=lang('messages_lang.labelle_signature_min')?>
                          </div>

                          <div class="col-md-4">
                            <input type="checkbox" value="1" name="VALIDATION_SALAIRE_NET"><span style="margin-left:5px;"></span><?=lang('messages_lang.validation_salaire_net')?>
                          </div>
                          <div class="col-md-4">
                            <input type="checkbox" value="1" name="VALIDATION_RETENUS_SALAIRE"><span style="margin-left:5px;"></span><?=lang('messages_lang.validation_autre_retenus')?>
                          </div>
                          <div class="col-md-4">
                            <input type="checkbox" value="1" name="DECAISSEMENT_SALAIRE"><span style="margin-left:5px;"></span><?=lang('messages_lang.labelle_decaisse')?>
                          </div>

                           <div class="col-md-4">
                            <input type="checkbox" value="1" name="CORRECTION_LIQUIDATION_SALAIRE"><span style="margin-left:5px;"></span>Correction liquidation
                          </div>
