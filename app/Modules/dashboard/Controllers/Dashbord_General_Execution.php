...
class Dashbord_General_Execution extends BaseController
{
 ...
 public function listing_execution() 
 {
  ...
  $query_principal="SELECT inst_institutions.DESCRIPTION_INSTITUTION AS INTITULE_MINISTERE,inst_institutions_programmes.INTITULE_PROGRAMME, inst_institutions_actions.LIBELLE_ACTION,inst_institutions_ligne_budgetaire.CODE_NOMENCLATURE_BUDGETAIRE,`DESC_TACHE`,`RESULTAT_ATTENDUS_TACHE`,tache.MONTANT_ENG_BUDGETAIRE AS ENG_BUDGETAIRE,tache.MONTANT_LIQUIDATION AS LIQUIDATION,tache.MONTANT_DECAISSEMENT AS DECAISSEMENT,pap_activites.DESC_PAP_ACTIVITE,tache.MONTANT_ENG_JURIDIQUE AS ENG_JURIDIQUE,tache.MONTANT_ORDONNANCEMENT AS ORDONNANCEMENT,tache.MONTANT_PAIEMENT AS
PAIEMENT,ptba_tache.GRANDE_MASSE_ID,DESCRIPTION_GRANDE_MASSE FROM execution_budgetaire activite JOIN execution_budgetaire_execution_tache tache ON tache.EXECUTION_BUDGETAIRE_ID=activite.EXECUTION_BUDGETAIRE_ID JOIN ptba_tache ON tache.PTBA_TACHE_ID=ptba_tache.PTBA_TACHE_ID JOIN inst_institutions ON inst_institutions.INSTITUTION_ID=ptba_tache.INSTITUTION_ID JOIN inst_institutions_programmes ON inst_institutions_programmes.PROGRAMME_ID=ptba_tache.PROGRAMME_ID JOIN inst_institutions_actions ON inst_institutions_actions.ACTION_ID=ptba_tache.ACTION_ID JOIN inst_grande_masse ON inst_grande_masse.GRANDE_MASSE_ID = ptba_tache.GRANDE_MASSE_ID LEFT JOIN execution_budgetaire_tache_detail detail ON detail.EXECUTION_BUDGETAIRE_ID = activite.EXECUTION_BUDGETAIRE_ID LEFT JOIN pap_activites ON pap_activites.PAP_ACTIVITE_ID=ptba_tache.PAP_ACTIVITE_ID LEFT JOIN inst_institutions_ligne_budgetaire ON inst_institutions_ligne_budgetaire.CODE_NOMENCLATURE_BUDGETAIRE_ID=ptba_tache.CODE_NOMENCLATURE_BUDGETAIRE_ID WHERE 1 ".$cond." ".$cond_trim."";
  ...
  $output = array(
    ...
    function exporter($TYPE_INSTITUTION_ID='',$INSTITUTION_ID='',$PROGRAMME_ID='',$ACTION_ID='',$IS_PRIVATE='')
    {
      ...
      $getRequete="SELECT inst_institutions.DESCRIPTION_INSTITUTION AS INTITULE_MINISTERE,inst_institutions_programmes.INTITULE_PROGRAMME, inst_institutions_actions.LIBELLE_ACTION,inst_institutions_ligne_budgetaire.LIBELLE_CODE_NOMENCLATURE_BUDGETAIRE,`DESC_TACHE`,`RESULTAT_ATTENDUS_TACHE`,activite.ENG_BUDGETAIRE AS ENG_BUDGETAIRE,activite.LIQUIDATION,activite.DECAISSEMENT,pap_activites.DESC_PAP_ACTIVITE,activite.ENG_JURIDIQUE,activite.ORDONNANCEMENT,activite.PAIEMENT,ptba_tache.GRANDE_MASSE_ID,DESCRIPTION_GRANDE_MASSE FROM execution_budgetaire activite JOIN execution_budgetaire_execution_tache detail ON detail.EXECUTION_BUDGETAIRE_ID = activite.EXECUTION_BUDGETAIRE_ID JOIN ptba_tache ON ptba_tache.PTBA_TACHE_ID=detail.PTBA_TACHE_ID JOIN inst_institutions ON inst_institutions.INSTITUTION_ID=ptba_tache.INSTITUTION_ID JOIN inst_institutions_programmes ON inst_institutions_programmes.PROGRAMME_ID=ptba_tache.PROGRAMME_ID JOIN inst_institutions_actions ON inst_institutions_actions.ACTION_ID=ptba_tache.ACTION_ID JOIN inst_grande_masse ON inst_grande_masse.GRANDE_MASSE_ID = ptba_tache.GRANDE_MASSE_ID   LEFT JOIN pap_activites ON pap_activites.PAP_ACTIVITE_ID=ptba_tache.PAP_ACTIVITE_ID LEFT JOIN inst_institutions_ligne_budgetaire ON inst_institutions_ligne_budgetaire.CODE_NOMENCLATURE_BUDGETAIRE_ID=ptba_tache.CODE_NOMENCLATURE_BUDGETAIRE_ID WHERE 1 ".$cond." ".$cond_trim." ORDER BY DESCRIPTION_INSTITUTION ASC";
...
$name_table= " JOIN execution_budgetaire_execution_tache ON execution_budgetaire_execution_tache.EXECUTION_BUDGETAIRE_ID=execution_budgetaire.EXECUTION_BUDGETAIRE_ID JOIN ptba_tache on execution_budgetaire_execution_tache.PTBA_TACHE_ID=ptba_tache.PTBA_TACHE_ID  JOIN inst_institutions ON inst_institutions.INSTITUTION_ID=ptba_tache.INSTITUTION_ID";
$format=" {point.y:.3f} %";
$type="column";
if(!empty($TYPE_INSTITUTION_ID))
{
...
if(! empty($INSTITUTION_ID))
{
  ...
  $name_table= " JOIN execution_budgetaire_execution_tache ON execution_budgetaire_execution_tache.EXECUTION_BUDGETAIRE_ID=execution_budgetaire.EXECUTION_BUDGETAIRE_ID JOIN ptba_tache on ptba_tache.PTBA_TACHE_ID=execution_budgetaire_execution_tache.PTBA_TACHE_ID JOIN inst_institutions ON inst_institutions.INSTITUTION_ID=ptba_tache.INSTITUTION_ID JOIN inst_institutions_sous_tutel ON inst_institutions_sous_tutel.CODE_SOUS_TUTEL=SUBSTRING(ptba_tache.CODE_NOMENCLATURE_BUDGETAIRE, 5,3)";
  $format=" {point.y:.3f} %";
  $type="column";
...
$name_table= " JOIN execution_budgetaire_execution_tache ON execution_budgetaire_execution_tache.EXECUTION_BUDGETAIRE_ID=execution_budgetaire.EXECUTION_BUDGETAIRE_ID JOIN ptba_tache on execution_budgetaire_execution_tache.PTBA_TACHE_ID=ptba_tache.PTBA_TACHE_ID  JOIN inst_institutions ON inst_institutions.INSTITUTION_ID=ptba_tache.INSTITUTION_ID JOIN inst_institutions_programmes ON inst_institutions_programmes.PROGRAMME_ID=ptba_tache.PROGRAMME_ID";
  $cond.=" AND SUBSTRING(ptba_tache.CODE_NOMENCLATURE_BUDGETAIRE, 5,3)='".$SOUS_TUTEL_ID."'";
...
if(!empty($LIGNE_BUDGETAIRE))
  ...
  $name_table= " JOIN execution_budgetaire_execution_tache ON execution_budgetaire_execution_tache.EXECUTION_BUDGETAIRE_ID=execution_budgetaire.EXECUTION_BUDGETAIRE_ID JOIN ptba_tache on execution_budgetaire_execution_tache.PTBA_TACHE_ID=ptba_tache.PTBA_TACHE_ID JOIN inst_institutions ON inst_institutions.INSTITUTION_ID=ptba_tache.INSTITUTION_ID JOIN pap_activites ON pap_activites.PAP_ACTIVITE_ID=ptba_tache.PAP_ACTIVITE_ID";
  $cond.=" AND ptba_tache.CODE_NOMENCLATURE_BUDGETAIRE_ID='".$LIGNE_BUDGETAIRE."'";
...
$activites_exec=("SELECT ".$name_decl." AS Name,".$id_decl." AS ID,count(execution_budgetaire.EXECUTION_BUDGETAIRE_ID) AS enga FROM `execution_budgetaire` ".$name_table." WHERE 1 ".$cond." ".$cond2." ".$cond_trim." ".$cond_affectations." GROUP BY ".$name_decl.",".$id_decl." ORDER BY ".$name_decl." ASC ");
...
{
  $pourcent=0;
  $taux=("SELECT SUM(ENG_BUDGETAIRE) AS taux FROM `execution_budgetaire` JOIN execution_budgetaire_execution_tache ON execution_budgetaire_execution_tache.EXECUTION_BUDGETAIRE_ID=execution_budgetaire.EXECUTION_BUDGETAIRE_ID JOIN ptba_tache on execution_budgetaire_execution_tache.PTBA_TACHE_ID=ptba_tache.PTBA_TACHE_ID JOIN inst_institutions ON inst_institutions.INSTITUTION_ID=ptba_tache.INSTITUTION_ID WHERE 1 ".$cond." ".$cond_trim." ");
...
{
 $pourcent=0;
 $taux=("SELECT count(execution_budgetaire.EXECUTION_BUDGETAIRE_ID) AS taux FROM `execution_budgetaire` JOIN execution_budgetaire_execution_tache ON execution_budgetaire_execution_tache.EXECUTION_BUDGETAIRE_ID=execution_budgetaire.EXECUTION_BUDGETAIRE_ID JOIN ptba_tache on execution_budgetaire_execution_tache.PTBA_TACHE_ID=ptba_tache.PTBA_TACHE_ID JOIN inst_institutions ON inst_institutions.INSTITUTION_ID=ptba_tache.INSTITUTION_ID WHERE 1 ".$cond." ".$cond_trim." ".$cond_affectations1." ");
...
$tauxt=("SELECT SUM(ENG_BUDGETAIRE) AS taux FROM `execution_budgetaire` JOIN execution_budgetaire_execution_tache ON execution_budgetaire_execution_tache.EXECUTION_BUDGETAIRE_ID=execution_budgetaire.EXECUTION_BUDGETAIRE_ID JOIN ptba_tache on execution_budgetaire_execution_tache.PTBA_TACHE_ID=ptba_tache.PTBA_TACHE_ID JOIN inst_institutions ON inst_institutions.INSTITUTION_ID=ptba_tache.INSTITUTION_ID WHERE 1 ".$cond." ".$cond_trim." ".$cond_affectations1." ");
...
####rapport des budgets vote par grande masse
             $grande_masse="SELECT if(inst_grande_masse.GRANDE_MASSE_ID in (6,7,8),7,inst_grande_masse.GRANDE_MASSE_ID) as ID, if(inst_grande_masse.GRANDE_MASSE_ID in (6,7,8),'transferts et subsides',inst_grande_masse.DESCRIPTION_GRANDE_MASSE) as NAME,SUM(`ENG_BUDGETAIRE`) as MONTANT FROM execution_budgetaire JOIN execution_budgetaire_execution_tache ON  execution_budgetaire_execution_tache.EXECUTION_BUDGETAIRE_ID=execution_budgetaire.EXECUTION_BUDGETAIRE_ID JOIN ptba_tache ON ptba_tache.PTBA_TACHE_ID=execution_budgetaire_execution_tache.PTBA_TACHE_ID  JOIN inst_grande_masse ON ptba_tache.GRANDE_MASSE_ID=inst_grande_masse.GRANDE_MASSE_ID   JOIN inst_institutions ON inst_institutions.INSTITUTION_ID=ptba_tache.INSTITUTION_ID WHERE 1 ".$cond." ".$cond_trim." ".$cond_affectations1." GROUP BY ID,NAME ORDER BY MONTANT DESC";
             ...
             { 
              ...
              $pourcent=0;
              $taux2=("SELECT SUM(ENG_BUDGETAIRE) AS tau FROM `execution_budgetaire` JOIN execution_budgetaire_execution_tache ON execution_budgetaire_execution_tache.EXECUTION_BUDGETAIRE_ID=execution_budgetaire.EXECUTION_BUDGETAIRE_ID JOIN ptba_tache on execution_budgetaire_execution_tache.PTBA_TACHE_ID=ptba_tache.PTBA_TACHE_ID JOIN inst_institutions ON inst_institutions.INSTITUTION_ID=ptba_tache.INSTITUTION_ID WHERE 1 ".$cond." ".$cond_trim." ".$cond_affectations1." ");
...
####### rapport des budget par mouvement dépense
        $mouvement_depense="SELECT SUM(execution_budgetaire.ENG_BUDGETAIRE) as engage, SUM(execution_budgetaire.ENG_JURIDIQUE) as juridiq, SUM(execution_budgetaire.LIQUIDATION) as liquid, SUM(execution_budgetaire.ORDONNANCEMENT) as ordonnance, SUM(execution_budgetaire.PAIEMENT) as paiement, SUM(execution_budgetaire.DECAISSEMENT) as decaisse FROM execution_budgetaire JOIN execution_budgetaire_execution_tache ON execution_budgetaire_execution_tache.EXECUTION_BUDGETAIRE_ID=execution_budgetaire.EXECUTION_BUDGETAIRE_ID LEFT JOIN ptba_tache ON ptba_tache.PTBA_TACHE_ID=execution_budgetaire_execution_tache.PTBA_TACHE_ID JOIN inst_institutions ON inst_institutions.INSTITUTION_ID=ptba_tache.INSTITUTION_ID WHERE 1 ".$cond." ".$cond_trim." ".$cond_affectations1." ";
        $nbre_mvt_depense=$this->ModelPs->getRequeteOne(' CALL getTable("'.$mouvement_depense.'")');
        $tauxx=("SELECT SUM(ENG_BUDGETAIRE+ENG_JURIDIQUE+LIQUIDATION+ORDONNANCEMENT+PAIEMENT+DECAISSEMENT) AS taux FROM execution_budgetaire JOIN execution_budgetaire_execution_tache ON execution_budgetaire_execution_tache.EXECUTION_BUDGETAIRE_ID=execution_budgetaire.EXECUTION_BUDGETAIRE_ID LEFT JOIN ptba_tache ON ptba_tache.PTBA_TACHE_ID=execution_budgetaire_execution_tache.PTBA_TACHE_ID JOIN inst_institutions ON inst_institutions.INSTITUTION_ID=ptba_tache.INSTITUTION_ID WHERE 1 ");
        ...
        $total_mouvement=$engagee+$juridique+$liquidat+$ordonance+$paiementt+$decais;
             ...
             echo json_encode($arrayName = array('rapp' =>$rapp ,'rapp_gde_masse'=>$rapp_gde_masse,'rapp_mouvement'=>$rapp_mouvement,'program'=>$program,'actions'=>$actions,'ligne_budgetaires'=>$ligne_budgetaires,'ligne_activite'=>$ligne_activite,'inst'=>$inst, 'soustutel'=>$soustutel));
              ...
              $var_search = !empty($_POST['search']['value']) ? $_POST['search']['value'] : null; 
            $query_principal="SELECT inst_institutions.DESCRIPTION_INSTITUTION AS INTITULE_MINISTERE,inst_institutions_programmes.INTITULE_PROGRAMME, inst_institutions_actions.LIBELLE_ACTION,execution_budgetaire.ENG_BUDGETAIRE, `DESC_TACHE`, `RESULTAT_ATTENDUS_TACHE`, date_format(execution_budgetaire.DATE_DEMANDE,'%d-%m-%Y')as datee, REPLACE(RTRIM(execution_budgetaire.`ENG_BUDGETAIRE`),' ','') AS ENG_BUDGETAIRE FROM `ptba_tache` JOIN inst_institutions ON inst_institutions.INSTITUTION_ID=ptba_tache.INSTITUTION_ID JOIN inst_institutions_programmes ON inst_institutions_programmes.PROGRAMME_ID=ptba_tache.PROGRAMME_ID JOIN inst_institutions_actions ON inst_institutions_actions.ACTION_ID=ptba_tache.ACTION_ID JOIN execution_budgetaire_execution_tache ON execution_budgetaire_execution_tache.PTBA_TACHE_ID=ptba_tache.PTBA_TACHE_ID JOIN execution_budgetaire on execution_budgetaire_execution_tache.PTBA_TACHE_ID=ptba_tache.PTBA_TACHE_ID LEFT JOIN execution_budgetaire_tache_detail det ON det.EXECUTION_BUDGETAIRE_ID=execution_budgetaire.EXECUTION_BUDGETAIRE_ID  WHERE 1 ".$cond." ".$cond1." ".$cond_trim." ";
           ...
           foreach ($fetch_data as $row) 
           {
             ...
             if (strlen($row->DESC_TACHE) > 10){ 
              ...
              $sub_array[] ='<center><font color="#000000" size=2><label>'.$row->ENG_BUDGETAIRE.'</label></font> </center>';
  ...
  function detail_execution_Gdemasses(){
      ...
      if(!empty($session->get('SESSION_SUIVIE_PTBA_USER_ID')))
      {
        ...
        $query_principal="SELECT inst_grande_masse.GRANDE_MASSE_ID,inst_grande_masse.DESCRIPTION_GRANDE_MASSE, inst_institutions.DESCRIPTION_INSTITUTION AS INTITULE_MINISTERE,inst_institutions_programmes.INTITULE_PROGRAMME, inst_institutions_actions.LIBELLE_ACTION,ptba_tache.DESC_TACHE,execution_budgetaire.ENG_BUDGETAIRE,ptba_tache.RESULTAT_ATTENDUS_TACHE, inst_grande_masse.DESCRIPTION_GRANDE_MASSE,execution_budgetaire.DATE_DEMANDE as datee FROM ptba_tache JOIN execution_budgetaire_execution_tache ON execution_budgetaire_execution_tache.PTBA_TACHE_ID=ptba_tache.PTBA_TACHE_ID JOIN execution_budgetaire ON execution_budgetaire.EXECUTION_BUDGETAIRE_ID=execution_budgetaire_execution_tache.EXECUTION_BUDGETAIRE_ID JOIN inst_grande_masse ON inst_grande_masse.GRANDE_MASSE_ID=ptba_tache.GRANDE_MASSE_ID  JOIN inst_institutions ON inst_institutions.INSTITUTION_ID=ptba_tache.INSTITUTION_ID JOIN inst_institutions_programmes ON inst_institutions_programmes.PROGRAMME_ID=ptba_tache.PROGRAMME_ID JOIN inst_institutions_actions ON inst_institutions_actions.ACTION_ID=ptba_tache.ACTION_ID LEFT JOIN execution_budgetaire_tache_detail det ON det.EXECUTION_BUDGETAIRE_ID=execution_budgetaire.EXECUTION_BUDGETAIRE_ID WHERE 1 ".$cond." ".$cond11." ".$cond1." ".$cond_trim.""; 
