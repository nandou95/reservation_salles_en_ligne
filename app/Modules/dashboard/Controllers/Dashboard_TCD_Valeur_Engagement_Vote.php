	  ...
	  ######liste des entites responsable
		function liste_institution_engage_votes() 
			...
			$search = !empty($_POST['search']['value']) ? ("AND (
				DESCRIPTION_INSTITUTION LIKE '%$var_search%' OR INTITULE_PROGRAMME LIKE '%$var_search%' OR LIBELLE_ACTION LIKE '%$var_search%' OR DESC_PAP_ACTIVITE LIKE '%$var_search%' OR RESULTAT_PAP_ACTIVITE LIKE '%$var_search%' OR ligne.CODE_NOMENCLATURE_BUDGETAIRE LIKE '%$var_search%')") : '';
			$critere=' ';
