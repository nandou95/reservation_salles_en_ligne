...
if(!empty($PAP_ACTIVITE_ID))
  ...
  gmas.DESCRIPTION_GRANDE_MASSE FROM execution_budgetaire  racc JOIN execution_budgetaire_execution_tache ON execution_budgetaire_execution_tache.EXECUTION_BUDGETAIRE_ID=racc.EXECUTION_BUDGETAIRE_ID JOIN ptba_tache p ON execution_budgetaire_execution_tache.PTBA_TACHE_ID=p.PTBA_TACHE_ID JOIN inst_institutions  ON p.INSTITUTION_ID=inst_institutions.INSTITUTION_ID JOIN inst_grande_masse gmas 
...
public function get_rapport()
{
  ...
  //      }
   ...
   $cond_exec="";
  $Tot_GM_VOTE="SELECT  ".$totaux." AS bug_vote FROM ptba_tache JOIN execution_budgetaire_execution_tache ON execution_budgetaire_execution_tache.PTBA_TACHE_ID=ptba_tache.PTBA_TACHE_ID JOIN execution_budgetaire  ex_budg_raccr ON execution_budgetaire_execution_tache.EXECUTION_BUDGETAIRE_ID=ex_budg_raccr.EXECUTION_BUDGETAIRE_ID JOIN inst_grande_masse ON inst_grande_masse.GRANDE_MASSE_ID =ptba_tache.GRANDE_MASSE_ID ".$jointure." WHERE 1 ".$cond." ".$cond_exec." ";
...
##Calcul du montant total du montant exécuté
 $req_Tot_Exec="SELECT SUM(ex_budg_raccr.ENG_BUDGETAIRE) AS bug_exec FROM ptba_tache JOIN execution_budgetaire_execution_tache ON execution_budgetaire_execution_tache.PTBA_TACHE_ID=ptba_tache.PTBA_TACHE_ID JOIN execution_budgetaire  ex_budg_raccr ON execution_budgetaire_execution_tache.EXECUTION_BUDGETAIRE_ID=ex_budg_raccr.EXECUTION_BUDGETAIRE_ID JOIN inst_grande_masse ON inst_grande_masse.GRANDE_MASSE_ID =ptba_tache.GRANDE_MASSE_ID ".$jointure." WHERE 1 ".$cond_tr." ".$cond."";
