...
<div class="main">
  ...
  <main class="content">
    <div class="container-fluid">
      <!-- <div class="header">
       <h1 class="header-title text-black"> Répartition de l’investissement public selon les Piliers
       </h1>
     </div -->
     <div class="row" style="margin-top: -5px">
      <div class="col-12">
        <div style="box-shadow: rgba(100, 100, 111, 0.25) 0px 7px 29px 0px" class="card">
          ...
          <h1 class="header-title text-black"><?=lang('messages_lang.pip_rapport_pilier_annee_titre')?> 
       </h1>
          <div class="card-body" style="overflow-x:auto;">
           <div class="row">
            ...
            <div class="form-group col-md-6">
              ...
              <div class="form-group col-md-6">
                <label><b><?=lang('messages_lang.pip_rapport_institutio_program_piliers')?></b></label>
                <select class="form-control" onchange="get_rapport();listing()" name="ID_PILIER" id="ID_PILIER">
                  <option value=""><?=lang('messages_lang.label_selecte')?></option>

                    <?php
                    foreach ($pillierrrr as $value)
                    {
                      if ($value->ID_PILIER==$ID_PILIER)
                      {
                        ?>
                        <option value="<?= $value->ID_PILIER ?>" selected><?=$value->DESCR_PILIER ?></option>
                        <?php
                      }else
                      { 
                        ?>
                        <option value="<?=$value->ID_PILIER?>"><?=$value->DESCR_PILIER ?></option>
                        <?php 
                      } 
                    } 
                    ?>
                      ...
                      <table style="width: 100%;" id='mytable' class='table table-bordered table-striped table-hover table-condensed table-responsive'>
                        <thead>
                          <th style='width:30px'><center><font color="white" size="3"><label>#</label></font></center></th>
                           <th ><center><font ><label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?=lang('messages_lang.pip_rapport_institutio_filtre')?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label></font></center></th>
                           
                          <th style='width:70px'><center><font><label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?=lang('messages_lang.pip_rapport_institutio_projet')?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label></font></center></th>

                          <th ><center><font><label>&nbsp;&nbsp;&nbsp;&nbsp;<?=lang('messages_lang.pip_rapport_pilier_annee_titre_ann')?>&nbsp;&nbsp;<?=lang('messages_lang.pip_rapport_institutio_program_budgetaire')?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label></font></center></th>
                          <th ><center><font><label>&nbsp;&nbsp;&nbsp;<?=lang('messages_lang.pip_rapport_institutio_monta')?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label></font></center></th>
                  ...
                  <div style="box-shadow: rgba(100, 100, 111, 0.25) 0px 7px 29px 0px;padding: 13px !important" class="card">
                    <div class="car-body">
                      <div class="row col-md-12">
                        <div class="col-md-12">
                          <h3 class="header-title text-black"><?=lang('messages_lang.pip_rapport_objectifs_piliers')?></h3>
                            ...
                            <thead>
                              ...
                              <th><center>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?=lang('messages_lang.pip_rapport_institutio_filtre')?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</center></th>
                                <th>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?=lang('messages_lang.pip_rapport_institutio_projet')?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
                                  <th><center>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?=lang('messages_lang.pip_rapport_institutio_program_piliers')?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</center></th>
                                <th>2024&nbsp;&nbsp;-&nbsp;2025&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
                                 <th>2025&nbsp;&nbsp;-&nbsp;2026&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
                               <th>2026&nbsp;&nbsp;-&nbsp;2027&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
...
$.ajax({
  url : "<?=base_url('dashboard/Rapport_Pip_piliers/Get_Pillier')?>",
  type : "GET",
  dataType: "JSON",
  cache:false,
  data:{
  ...
  function listing()
    {
      ...
      var inst_conn=$('#inst_conn').val();
        ...
        $("#mytable1").DataTable({
          ...
          "oreder":[[ 0, 'desc' ]],
          "ajax":{
            url:"<?= base_url('dashboard/Rapport_Pip_piliers/liste')?>",
            type:"POST", 
             data:{
               ID_PILIER:ID_PILIER,
               INSTITUTION_ID:INSTITUTION_ID,
...
function exporter()
  ...
  var INSTITUTION_ID = $('#INSTITUTION_ID').val();
    ...
    document.getElementById("btnexport").href = "<?=base_url('dashboard/Rapport_Pip_piliers/exporter/')?>"+'/'+INSTITUTION_ID;
}
</script>
