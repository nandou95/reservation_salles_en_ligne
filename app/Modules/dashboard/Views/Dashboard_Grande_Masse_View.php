          ...
          <div class="card-body" style="overflow-x:auto;">
           ...
           <div class="row">
            ...
            <div class="form-group col-md-2">
             ...
             <!--  <div class="form-group col-md-3"> 
                <label><b>
                  <?=lang('messages_lang.label_droit_execution')?></b>
                </label>
                <select class="form-control" onchange="get_rapport();liste()" name="IS_DOUBLE_COMMANDE" id="IS_DOUBLE_COMMANDE">
                  <option value=""><?=lang('messages_lang.labelle_selecte')?></option>
                  <option value="1"><?=lang('messages_lang.label_droit_raccrochage')?>
                  </option>
                  <option value="2"><?=lang('messages_lang.label_droit_double_com')?>
                  </option>
                </select>        
              </div> -->
