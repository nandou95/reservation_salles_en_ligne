                        ...
                        <div class="modal-content  ">
                          ...
                          <div class="modal-body">
                            <table style="width: 100%;" id='mytable_deux' class='table table-bordered table-striped table-hover table-condensed table-responsive'>
                             ...
                             <th style='width:120px'><center><font color="white" size="3"><label>&nbsp&nbsp&nbsp&nbsp&nbsAXES&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</label></font></center></th>
          ...
          <table id="mytable2" class=" table table-striped table-bordered">
            <thead>
              <tr>
                ...
                <th>AXES&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</th>
...
<script type="text/javascript">
 ...
 var IS_PRIVATE = document.getElementById('IS_PRIVATE5').value;
    ...
    $.ajax({
      url : "<?=base_url('dashboard/Dashboard_Ptba_Execution_Axes/get_Rapport_Axes')?>",
      type : "GET",
      dataType: "JSON",
      cache:false,
      data:{
...
<script>
  function liste()
  {
    ...
    $("#mytable2").DataTable(
    {
      ...
      "ajax":
      {
        url:"<?= base_url('dashboard/Dashboard_Ptba_Execution_Axes/listing_budget')?>",
        type:"POST", 
        data:
        {
          TYPE_INSTITUTION_ID:TYPE_INSTITUTION_ID,
...
function exporter()
{
  if (document.getElementById('IS_PRIVATE1').checked){
    ...
    document.getElementById("btnexport").href = "<?=base_url('dashboard/Dashboard_Ptba_Execution_Axes/exporter/')?>"+'/'+TYPE_INSTITUTION_ID+'/'+INSTITUTION_ID+'/'+PROGRAMME_ID+'/'+ACTION_ID+'/'+LIGNE_BUDGETAIRE+'/'+IS_PRIVATE+'/'+PAP_ACTIVITE_ID;
}
</script>