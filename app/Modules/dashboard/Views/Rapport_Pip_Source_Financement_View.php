...
<script type="text/javascript">
  ...
  function get_rapport(){ 
   ...
   $.ajax({
    url : "<?=base_url('dashboard/Rapport_Pip_Source_Financement/get_rapport')?>",
    type : "POST",
    dataType: "JSON",
    cache:false,
...
<script type="text/javascript">
  ...
  function liste(){
    ...
    $("#list_table").DataTable(
      ...
      "oreder":[[ 0, 'desc' ]],
      "ajax":{
        url:"<?= base_url('dashboard/Rapport_Pip_Source_Financement/listing')?>",
        type:"POST",
        data:{INSTITUTION_ID:INSTITUTION_ID,
        ID_AXE_INTERVENTION_PND:ID_AXE_INTERVENTION_PND
      },
  ...
  function get_lieux(id) {
   ...
   table = $("#table_pad").DataTable({
    ...
    "ajax": {
       ...
       url:"<?= base_url('dashboard/Rapport_Pip_Source_Financement/get_lieux')?>",
      type: "POST",
      data: {id:id}
    },
    lengthMenu: [
...
function exporter()
  ...
  var ID_AXE_INTERVENTION_PND = $('#ID_AXE_INTERVENTION_PND').val();
    ...
    document.getElementById("btnexport").href = "<?=base_url('dashboard/Rapport_Pip_Source_Financement/exporter/')?>"+'/'+INSTITUTION_ID+'/'+ID_AXE_INTERVENTION_PND;
}
</script>
