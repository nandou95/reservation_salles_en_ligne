          ...
          <div class="row">
            <div class="col-md-12">
              <div style="box-shadow: rgba(100, 100, 111, 0.25) 0px 7px 29px 0px;padding: 13px !important" class="card" >
                <div class="row">
                  <div class="">
                    <h3 class="text-black"> <?=lang('messages_lang.pip_rapport_institutio_titre')?></h3>
                    </div>
                  ...
                  <div style="box-shadow: rgba(100, 100, 111, 0.25) 0px 7px 29px 0px;padding: 13px !important" class="card">
                    <div class="car-body">
                      <div class="row col-md-12">
                        <div class="col-md-12">
                          <h3 class="header-title text-black"><?=lang('messages_lang.pip_rapport_institutio_list')?> </h3>
                            ...
                            <thead>
                              <tr>
                                ...
                                <th>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?=lang('messages_lang.pip_rapport_institutio_projet')?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
                                 ...
                                 <th><center>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?=lang('messages_lang.pip_rapport_institutio_livrable')?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</center></th>
                               ...
                               <th><?=lang('messages_lang.pip_rapport_institutio_annee1')?>&nbsp;2026&nbsp;-&nbsp;2027&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
                                ...
                                <th><?=lang('messages_lang.pip_rapport_institutio_indi')?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?=lang('messages_lang.pip_rapport_institutio_indi_mes')?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
                               
                               <th><?=lang('messages_lang.pip_rapport_institutio_unit')?>&nbsp;&nbsp;&nbsp;<?=lang('messages_lang.pip_rapport_institutio_unit_mes')?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>

                               <th><?=lang('messages_lang.pip_rapport_institutio_cible_annee1')?>&nbsp;&nbsp;2024&nbsp;-&nbsp;2025&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
                                 <th><?=lang('messages_lang.pip_rapport_institutio_cible_annee1')?>&nbsp;&nbsp;2025&nbsp;-&nbsp;2026&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
                               <th><?=lang('messages_lang.pip_rapport_institutio_cible_annee1')?>&nbsp;&nbsp;&nbsp;2026&nbsp;-&nbsp;&nbsp;2027&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
...
<script type="text/javascript">
  ...
  function get_rapport(){ 
   ...
   $.ajax({
    url : "<?=base_url('dashboard/Rapport_Pip_Institution/get_rapport')?>",
    type : "POST",
    dataType: "JSON",
    cache:false,
...
<script type="text/javascript">
  ...
  function liste(){
    ...
    $("#list_table").DataTable(
    {
      ...
      "oreder":[[ 0, 'desc' ]],
      "ajax":{
        url:"<?= base_url('dashboard/Rapport_Pip_Institution/listing')?>",
        type:"POST",
        data:{INSTITUTION_ID:INSTITUTION_ID,
        ID_AXE_INTERVENTION_PND:ID_AXE_INTERVENTION_PND
      },
  ...
  function get_lieux(id) {
   ...
   table = $("#table_pad").DataTable({
    ...
    "ajax": {
       ...
       url:"<?= base_url('dashboard/Rapport_Pip_Institution/get_lieux')?>",
      type: "POST",
      data: {id:id}
    },
    lengthMenu: [
...
function exporter()
  ...
  var ID_AXE_INTERVENTION_PND = $('#ID_AXE_INTERVENTION_PND').val();
    ...
    document.getElementById("btnexport").href = "<?=base_url('dashboard/Rapport_Pip_Institution/exporter/')?>"+'/'+INSTITUTION_ID+'/'+ID_AXE_INTERVENTION_PND;
}
</script>
