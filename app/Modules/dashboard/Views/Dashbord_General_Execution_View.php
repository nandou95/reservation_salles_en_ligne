        ...
        <div class="container-fluid">
           <div class="row" style="margin-top: -5px">
              ...
              <div style="box-shadow: rgba(100, 100, 111, 0.25) 0px 7px 29px 0px" class="card">
                <div class="card-header">
                 ...
                 <h1 class="header-title text-black">
                   <?=lang('messages_lang.budget_exec')?> 
                 </h1>
                 <div class="card-body" style="overflow-x:auto;">
                   <div class="row">
                    ...
                    <div class="form-group col-md-2">
                      ...
                      <div class="form-group col-md-4">
                        ...
                        <select class="form-control " onchange="get_m()" name="INSTITUTION_ID" id="INSTITUTION_ID">
                          <option value="">Administrations Personnalisées/Ministères</option>
                        </select>        
                      </div>
                    ...
                    <!--   <div class="form-group col-md-3"> 
                        ...
                        <select class="form-control" onchange="get_rapport();liste()" name="IS_DOUBLE_COMMANDE" id="IS_DOUBLE_COMMANDE">
                        ...
                        <div class="modal-dialog" style ="max-width: 70%;">
                          <div class="modal-content  ">
                            <div class="modal-header">
                              <h4 class="modal-title"><span id="titre" style="color: black"></span>
                            </h4>
                            </div>
                            <div class="modal-body">
                              <table style="width: 100%;" id='mytable' class='table table-bordered table-striped table-hover table-condensed table-responsive'>
                                <thead>
                                 ...
                                 <th style='width:50px'><center><font color="white" size="3"><label>&nbsp&nbsp&nbspInstitution&nbspou&nbsp<?=lang('messages_lang.minister')?>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</label></font></center></th>
                                 ...
                                 <th style='width:70px'><center><font color="white" size="3"><label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<?=lang('messages_lang.labelle_montant')?>&nbsp&nbsp&nbsp&nbsp&nbsp</label></font></center></th>
                                 <th style='width:70px'><center><font color="white" size="3"><label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?=lang('messages_lang.label_quantite_racc')?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label></font></center></th>
                                 <!-- <th style='width:70px'><center><font color="white" size="3"><label>&nbsp&nbsp&nbsp&nbspRésultats&nbspattendus&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</label></font></center></th> -->
                                 <th style='width:70px'><center><font color="white" size="3"><label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?=lang('messages_lang.labelle_action')?>&nbsp;&nbsp&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label></font></center></th>

                                 <th style='width:70px'><center><font color="white" size="3"><label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<?=lang('messages_lang.labelle_programme')?>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</label></font></center></th>
                                 <th style='width:70px'><center><font color="white" size="3"><label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbspDate&nbsp&nbsp&nbsp&nbsp</label></font></center></th>
                            ...
                            <table style="width: 100%;" id='mytable_phase' class='table table-bordered table-striped table-hover table-condensed table-responsive'>
                              <thead>
                               <th style='width:30px'><center><font color="white" size="3"><label>#</label></font></center>
                                ...
                                <th style='width:120px'><center><font color="white" size="3"><label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspType&nbspinstitution&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</label></font></center></th>
                              </th>   
                              
                              <th style='width:90px'><center><font color="white" size="3"><label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspProgramme&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</label></font></center></th>
                              <th style='width:70px'><center><font color="white" size="3"><label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspAction&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</label></font></center></th>
                              <th style='width:70px'><center><font color="white" size="3"><label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspActivité&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</label></font></center></th>

                              <th style='width:70px'><center><font color="white" size="3"><label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspRésultats&nbspattendus&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</label></font></center></th>

                              <th style='width:70px'><center><font color="white" size="3"><label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspMontant&nbsp&nbsp&nbsp&nbsp&nbsp</label></font></center></th>
                              <th style='width:70px'><center><font color="white" size="3"><label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbspDate&nbsp&nbsp&nbsp&nbsp</label></font></center></th>
                  ...
                  <div class="modal fade" id="myModal_masse" role="dialog">
                    <div class="modal-dialog" style ="max-width: 70%;">
                      <div class="modal-content  ">
                        <div class="modal-header">
                          <h4 class="modal-title"><span id="titre_masse" style="color: white"></span></h4>
                        </div>
                        <div class="modal-body">
                          <table style="width: 100%;" id='mytable_masse' class='table table-bordered table-striped table-hover table-condensed table-responsive'>
                            <thead>
                              ...
                              <th style='width:50px'><center><font color="white" size="3"><label>&nbsp&nbsp&nbsp;&nbsp;<?=lang('messages_lang.labelle_inst_min')?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label></font></center></th>
                              <th style='width:70px'><center><font color="white" size="3"><label>&nbsp;<?=lang('messages_lang.labelle_activites')?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label></font></center></th>
                              <th style='width:70px'><center><font color="white" size="3"><label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?=lang('messages_lang.label_Montant_racc')?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label></font></center></th>
                              <th style='width:70px'><center><font color="white" size="3"><label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?=lang('messages_lang.label_quantite_racc')?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label></font></center></th>
                              <th style='width:70px'><center><font color="white" size="3"><label>&nbsp&nbsp<?=lang('messages_lang.labelle_action')?>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</label></font></center></th>
                              <th style='width:70px'><center><font color="white" size="3"><label>&nbsp&nbsp&nbsp<?=lang('messages_lang.labelle_programme')?>e&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</label></font></center></th>
                              <th style='width:70px'><center><font color="white" size="3"><label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbspDate&nbsp&nbsp&nbsp&nbsp</label></font></center></th>
                            </thead>
                          </table>  
                        </div>
                  ...
                  <div class="modal fade" id="myModal_mvt" role="dialog">
                    <div class="modal-dialog" style ="max-width: 70%;">
                      <div class="modal-content  ">
                        <div class="modal-header">
                          <h4 class="modal-title"><span id="titre_mvt" style="color: black"></span></h4>
                        </div>
                        <div class="modal-body">
                          <table style="width: 100%;" id='mytable_mvt' class='table table-bordered table-striped table-hover table-condensed table-responsive'>
                            <thead>
                              <th style='width:30px'><center><font color="white" size="3"><label>#</label></font></center></th>

                              <th style='width:50px'><center><font color="white" size="3"><label>&nbsp;&nbsp;&nbsp;&nbsp;<?=lang('messages_lang.labelle_inst_min')?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label></font></center></th> 
                              <th style='width:70px'><center><font color="white" size="3"><label>&nbsp<?=lang('messages_lang.labelle_activites')?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label></font></center></th>
                              <th style='width:70px'><center><font color="white" size="3"><label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp<?=lang('messages_lang.label_Montant_racc')?>&nbsp;&nbsp;&nbsp;&nbsp;</label></font></center></th>
                              <th style='width:70px'><center><font color="white" size="3"><label>&nbsp&nbsp&nbsp&nbsp;&nbsp;&nbsp<?=lang('messages_lang.labelle_eng_jud')?>&nbsp&nbsp&nbsp&nbsp</label></font></center></th>
                              <th style='width:70px'><center><font color="white" size="3"><label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp;<?=lang('messages_lang.labelle_liquidation')?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label></font></center></th>
                              <th style='width:70px'><center><font color="white" size="3"><label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?=lang('messages_lang.labelle_ordonan')?>&nbsp&nbsp&nbsp;&nbsp;&nbsp;</label></font></center></th>
                              <th style='width:70px'><center><font color="white" size="3"><label>&nbsp&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?=lang('messages_lang.labelle_paiement')?>&nbsp&nbsp&nbsp&nbsp;&nbsp;</label></font></center></th>
                              <th style='width:70px'><center><font color="white" size="3"><label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<?=lang('messages_lang.labelle_decaisse')?>&nbsp&nbsp&nbsp&nbsp&nbsp</label></font></center></th>

                              <th style='width:70px'><center><font color="white" size="3"><label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<?=lang('messages_lang.label_quantite_racc')?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label></font></center></th>


                              <th style='width:70px'><center><font color="white" size="3"><label>&nbsp;&nbsp;<?=lang('messages_lang.labelle_action')?>;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label></font></center></th>
                              <th style='width:70px'><center><font color="white" size="3"><label>&nbsp&nbsp;<?=lang('messages_lang.labelle_programme')?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp</label></font></center></th>
                              <th style='width:70px'><center><font color="white" size="3"><label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Date&nbsp;&nbsp;&nbsp;&nbsp;</label></font></center></th>
                            </thead>
                          </table>  
                        </div>
                        <div class="modal-footer">
            ...
            <div class="row">
              ...
              <div class="col-md-12" style="margin-bottom: 20px"></div>
              <div id="container_active"  class="col-md-12"></div>
              <div class="col-md-12" style="margin-bottom: 20px"></div>
              <div id="container_gde_masse"  class="col-md-6"></div>
              <div id="container_mouvement"  class="col-md-6"></div>
              <div id="nouveau"></div>
              <div id="nouveau1"></div>
              <div id="nouveau2"></div>
              <div id="nouveau3"></div>
...
<script type="text/javascript">
  function get_rapport(){
   ...
   $.ajax({
    url : "<?=base_url('dashboard/Dashbord_General_Execution/get_general_execution_Rapport')?>",
    type : "GET",
    dataType: "JSON",
    cache:false,
    data:{
   ...
   success:function(data){
    ...
    $('#nouveau7').html(data.rapp_activ);

    $('#container_mouvement').html("");             
    $('#nouveau3').html(data.rapp_mouvement);

    $('#container_gde_masse').html("");             
    $('#nouveau4').html(data.rapp_gde_masse);
    ...
    if (TYPE_INSTITUTION_ID==1) {
      $("#idmin").html("Administration&nbsppersonnalisée");
     ...
     $("#idmin").html("Administration&nbsppersonnalisée/Ministère");
...
<script>
  function liste()
  {
    ...
    $("#mytable2").DataTable(
    {
      ...
      "ajax":
      {
        url:"<?= base_url('dashboard/Dashbord_General_Execution/listing_execution')?>",
        type:"POST", 
        data:
        {
          TYPE_INSTITUTION_ID:TYPE_INSTITUTION_ID,
...
<script type="text/javascript">
  function exporter()
  {
    ...
    if (IS_PRIVATE == '' || IS_PRIVATE == null) {IS_PRIVATE = 0}
      ...
      document.getElementById("btnexport").href = "<?=base_url('dashboard/Dashbord_General_Execution/exporter/')?>"+'/'+TYPE_INSTITUTION_ID+'/'+INSTITUTION_ID+'/'+PROGRAMME_ID+'/'+ACTION_ID+'/'+IS_PRIVATE+'/'+LIGNE_BUDGETAIRE+'/'+PAP_ACTIVITE_ID;
  }
</script>