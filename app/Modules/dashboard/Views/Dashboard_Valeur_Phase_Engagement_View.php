    ...
    <div class="main">
      ...
      <main class="content">
        <div class="container-fluid">
          ...
          <?=lang('messages_lang.dashboard_exec')?>
             </div>
                </h1>
                   <?=$inst_connexion?>
                          ...
                          <div class="modal-body">
                            <table style="width: 100%;" id='mytable' class='table table-bordered table-striped table-hover table-condensed table-responsive'>
                              <thead>
                               ...
                               <th style='width:100px'><center><font color="white" size="3"><label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<?=lang('messages_lang.admin_perso')?>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</label></font></center></th>
                          ...
                          <div class="modal-body">
                            <table style="width: 100%;" id='mytable_phase' class='table table-bordered table-striped table-hover table-condensed table-responsive'>
                              ...
                              <th style='width:120px'><center><font color="white" size="3"><label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspType&nbspinstitution&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</label></font></center></th>
                               ...
                               <th style='width:70px'><center><font color="white" size="3"><label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspRésultat&nbspAttendus&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</label></font></center></th>
                ...
                <div class="modal-content  ">
                  ...
                  <div class="modal-body">
                    <table style="width: 100%;" id='mytable_masse' class='table table-bordered table-striped table-hover table-condensed table-responsive'>
                      ...
                      <th style='width:120px'><center><font color="white" size="3"><label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspGrande&nbspmasse&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</label></font></center></th>
                      <th style='width:120px'><center><font color="white" size="3"><label>&nbsp&nbspMinistère&nbsp&nbsp</label></font></center></th>
                       <th style='width:120px'><center><font color="white" size="3"><label>&nbsp&nbspProgramme&nbsp&nbsp&nbsp</label></font></center></th>
                        <th style='width:120px'><center><font color="white" size="3"><label>&nbspObjectif&nbspdu&nbspprogramme&nbsp</label></font></center></th>
                        <th style='width:120px'><center><font color="white" size="3"><label>&nbsp&nbspAction&nbsp&nbsp</label></font></center></th>
                        <th style='width:120px'><center><font color="white" size="3"><label>&nbspActivités&nbsp&nbsp</label></font></center></th>
                ...
                <div class="modal-content  ">
                  ...
                  <div class="modal-body">
                    <table style="width: 100%;" id='mytable_transfert' class='table table-bordered table-striped table-hover table-condensed table-responsive'>
                      <thead>
                      <th style='width:30px'><center><font color="white" size="3"><label>#</label></font></center></th>
                      <th style='width:90px'><center><font color="white" size="3"><label>&nbsp&nbspMinistère&nbsp&nbsp<a id='idpro'><a>&nbsp&nbsp</label></font></center></th>
                       <th style='width:70px'><center><font color="white" size="3"><label>&nbsp&nbspProgramme&nbsp&nbsp&nbsp<a id='idcod'><a>&nbsp&nbsp&nbsp</label></font></center></th>
                        <th style='width:70px'><center><font color="white" size="3"><label>&nbspObjectif&nbspdu&nbspprogramme&nbsp<a id='idcod'><a>&nbsp&nbsp&nbsp</label></font></center></th>
                        <th style='width:70px'><center><font color="white" size="3"><label>&nbsp&nbspAction&nbsp&nbsp<a id='idobj'><a>&nbsp&nbsp&nbsp&nbsp</label></font></center></th>

                         <th style='width:70px'><center><font color="white" size="3"><label>&nbspRésultat&nbsp&nbspattendus&nbsp&nbs<a id='idobj'><a>&nbsp&nbsp&nbsp&nbsp</label></font></center></th>
                        <th style='width:70px'><center><font color="white" size="3"><label>&nbspActivités&nbsp&nbsp&nbsp&nbsp<a id='idobj'><a>&nbsp&nbsp&nbsp&nbsp</label></font></center></th>
                        <th style='width:120px'><center><font color="white" size="3"><label>&nbspBudget&nbsp&nbspvoté&nbsp&nbsp&nbsp&nbsp&nbsp</label></font></center></th> 
                       <th style='width:50px'><center><font color="white" size="3"><label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspBudget&nbsptransferé&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</label></font></center></th> 
                     </thead>
                   </table>  
                 </div>
                 <div class="modal-footer">
          ...
          <div class="modal fade" id="myModal_recu" role="dialog">
              <div class="modal-dialog" style ="max-width: 70%;">
                <div class="modal-content  ">
                  ...
                  <div class="modal-body">
                    <table style="width: 100%;" id='mytable_recu' class='table table-bordered table-striped table-hover table-condensed table-responsive'>
                      <thead>
                      <th style='width:30px'><center><font color="white" size="3"><label>#</label></font></center></th>
                      <th style='width:90px'><center><font color="white" size="3"><label>&nbsp&nbspMinistère&nbsp&nbsp</label></font></center></th>
                       <th style='width:70px'><center><font color="white" size="3"><label>&nbsp&nbspProgramme&nbsp&nbsp&nbsp<a></label></font></center></th>
                        <th style='width:70px'><center><font color="white" size="3"><label>&nbspObjectif&nbspdu&nbspprogramme&nbsp</label></font></center></th>
                        <th style='width:70px'><center><font color="white" size="3"><label>&nbsp&nbspAction&nbsp&nbsp</label></font></center></th>

                         <th style='width:70px'><center><font color="white" size="3"><label>&nbspRésultat&nbsp&nbspattendus&nbsp&nbsp</label></font></center></th>
                        <th style='width:70px'><center><font color="white" size="3"><label>&nbspActivités&nbsp&nbsp&nbsp&nbsp</label></font></center></th>
                        <th style='width:120px'><center><font color="white" size="3"><label>&nbspBudget&nbsp&nbspvoté&nbsp&nbsp&nbsp&nbsp&nbsp</label></font></center></th> 
                       <th style='width:50px'><center><font color="white" size="3"><label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspBudget&nbspreçu&nbsp&nbspdu&nbsp&nbsptransfert&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</label></font></center></th> 
                     </thead>
                   </table>  
                 </div>
                 <div class="modal-footer">
                ...
                <div  class="container" style= "width:95%">
                  <h3 class="text-black"><?=lang('messages_lang.liste_entit_respo')?></h3>
...
<script type="text/javascript">
 ...
 var IS_PRIVATE = document.getElementById('IS_PRIVATE5').value;
    ...
    $.ajax({
      url : "<?=base_url('dashboard/Dashboard_Valeur_Phase_Engagement/execution_valeur_dynamique')?>",
      type : "GET",
      dataType: "JSON",
      cache:false,
      data:{
...
<script>
  function liste_programme()
  {
    ...
    $("#mytable1").DataTable({
      ...
      "serverSide": true,
      "ajax": {
        url:"<?= base_url('dashboard/Dashboard_Valeur_Phase_Engagement/liste_institution_valeur_dynamiques')?>",
        type: "POST",
       ...
       if (TYPE_INSTITUTION_ID == '' || TYPE_INSTITUTION_ID == null){TYPE_INSTITUTION_ID = 0}
        if (SOUS_TUTEL_ID == '' || SOUS_TUTEL_ID == null) {SOUS_TUTEL_ID = 0}
          if (IS_PRIVATE == '' || IS_PRIVATE == null) {IS_PRIVATE = 0}
           if (inst_conn == '' || inst_conn == null) {inst_conn = 0}
              if (PROGRAMME_ID == '' || PROGRAMME_ID == null) {PROGRAMME_ID = 0}
               ...
               if (PAP_ACTIVITE_ID == '' || PAP_ACTIVITE_ID == null) {PAP_ACTIVITE_ID = 0}
                document.getElementById("btnexport").href = "<?=base_url('dashboard/Dashboard_Valeur_Phase_Engagement/exporter/')?>"+'/'+TYPE_INSTITUTION_ID+'/'+INSTITUTION_ID+'/'+SOUS_TUTEL_ID+'/'+IS_PRIVATE+'/'+PAP_ACTIVITE_ID+'/'+PROGRAMME_ID+'/'+ACTION_ID;
    }
</script>