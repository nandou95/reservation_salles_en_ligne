              ...
              <div style="box-shadow: rgba(100, 100, 111, 0.25) 0px 7px 29px 0px" class="card">
                <div class="card-header">
                  <div class="row col-md-12">
                    <div class="col-md-6">
                      <h1 class="header-title text-black"> <?= lang('messages_lang.ajoue_programme_ptba_programme') ?> </h1>
                    </div>
                  ...
                  <form id='MyFormData' method="POST" enctype="multipart/form-data">
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <select class="form-control" name="INSTITUTION_ID" id="INSTITUTION_ID">
                              ...
                              {
                                ?>
                                <option value="<?=$values->INSTITUTION_ID ?>"><?=$values->DESCRIPTION_INSTITUTION?></option>
                                <?php
                              }
                              ?>
                            </select>
                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="CODE_PROGRAMME" name="CODE_PROGRAMME">
                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="INTITULE_PROGRAMME" name="INTITULE_PROGRAMME">
                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="OBJECTIF_DU_PROGRAMME" name="OBJECTIF_DU_PROGRAMME">
                    ...
                    <div class="card-footer">
                      <div style="float:right;margin-bottom:5%">
                        <button type='button' class="btn btn-primary" id="SAVEUN" onclick="save_educ()"><i class="fa fa-sign-in" aria-hidden="true"></i> <?= lang('messages_lang.bouton_enregistrer') ?> </button>
                      </div>
                    </div>
                  </form>
                </div>
...
<script type="text/javascript">
  function save_educ()
  {
    ...
    if(statut == 2)
    {
      url="<?= base_url('ihm/Programme/insert') ?>";
      $.post(url,
      {
