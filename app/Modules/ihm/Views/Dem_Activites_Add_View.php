       ...
       <div style="box-shadow: rgba(100, 100, 111, 0.25) 0px 7px 29px 0px" class="card">
         ...
         <div class="col-12 d-flex">
          ...
          <div class="col-3" style="float: right;">
            <a href="<?=base_url('ihm/Liste_Activites')?>" style="float: right;margin-right: 90px;margin: 5px" class="btn btn-primary"><span class="fa fa-list pull-right"></span>&nbsp;<?=lang('messages_lang.list_action')?></a>   
          </div>
        </div>
        <!-- <br> -->
        <div class="card-body">
         ...
         <form id="my_form" action="<?= base_url('ihm/Liste_Activites/insert') ?>" method="POST">
          <div class="card-body">
          ...
          <div class="col-4">
            ...
            <select class="form-control form-select bg-light select2" id="CODE_NOMENCLATURE_BUDGETAIRE" name="CODE_NOMENCLATURE_BUDGETAIRE" placeholder="Sélectionnez l'action" autocomplete="off" aria-label=".form-select-lg example"  >
              ...
              foreach($code_Buget as $key)
              {
                ...
                {
                  echo "<option value='".$key->CODE_NOMENCLATURE_BUDGETAIRE_ID."'  selected>".$key->CODE_NOMENCLATURE_BUDGETAIRE."</option>";
                }
                else
                {
                  echo "<option value='".$key->CODE_NOMENCLATURE_BUDGETAIRE_ID."' >".$key->CODE_NOMENCLATURE_BUDGETAIRE."</option>";
                }
              }
              ?>
              <?php endif ?>
...
<script type="text/javascript">
 ...
 else
 {
   ...
   $.post('<?=base_url('ihm/Liste_Activites/create_get_code')?>',
   {
...
<script type="text/javascript">
  ...
  function create_get_action(){
    ...
    $.ajax({
      url : "<?=base_url('ihm/Liste_Activites/create_get_action')?>",
      type : "POST",
      dataType: "JSON",
      cache:false,
      data:{
...
<script type="text/javascript">
  ...
  <script type="text/javascript">
    function get_groupes()
    {
      ...
      $.post('<?=base_url('ihm/Liste_Activites/get_groupes')?>',
      {
    ...
    function get_classes()
    {
      ...
      $.post('<?=base_url('ihm/Liste_Activites/get_classes')?>',
      {
        GROUPE_ID:GROUPE_ID
      },
      function(data)
