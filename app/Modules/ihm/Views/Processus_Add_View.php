                ...
                <div style="box-shadow: rgba(100, 100, 111, 0.25) 0px 7px 29px 0px" class="card">
                  <div class="col-md-12 d-flex">
                    <div class="col-md-9" style="float: left;">
                      <h4 style="margin-left: 1%;margin-top:10px"><?= lang('messages_lang.labelle_et_ajout_proc')?></h4>
                    </div>
                  ...
                  <div class=" container " style="width:100%">
                    ...
                    <form enctype='multipart/form-data' id="MyFormData" action="<?=base_url('ihm/Processus/insert')?>" method="post" >
                      <div class="container">
                          ...
                          <div class="col-md-12 mt-3 ml-2"style="margin-bottom:50px" >
                            <div class="row">
                              ...
                              <div class="col-md-6" >
                                  ...
                                  <textarea class="form-control" id="PROCESS_NOM" name="PROCESS_NOM"  ><?=set_value('PROCESS_NOM')?></textarea>
                              ...
                              <div class="col-md-6">
                                  ...
                                  <input type="text" class="form-control" id="TABLE" name="TABLE"  value="<?=set_value('TABLE')?>">
                                  <?php if (isset($validation)) : ?>
...
<script type="text/javascript">
  function save()
  {
    ...
    if(PROCESS_NOM == '')
    {
      $('#error_PROCESS_NOM').html('<?= lang('messages_lang.error_sms')?>!');
      status = 1;
    ...
    if(TABLE == '')
    {
      $('#error_TABLE').html('<?= lang('messages_lang.error_sms')?>!');
      status = 1;
    ...
    {
      $('#error_LINK').show();
      $('#error_LINK').html('<?= lang('messages_lang.error_sms')?>!');
      status = 1;
