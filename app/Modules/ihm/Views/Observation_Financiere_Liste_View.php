                 ...
                 <div class="row col-md-12">
                  <div class="col-md-9" style="float: left;">
                    <h1 class="header-title text-black">
                      <?= lang('messages_lang.liste_observation_transfere_financier') ?>
                    </h1>
                  </div>
                  <div class="col-md-3" style="float: right;">
                    <a href="Observation_Financiere/ajout" style="float: right;margin: 40px" class="btn btn-primary"><i class="fa fa-plus" aria-hidden="true"></i> <?= lang('messages_lang.nouvelle_action') ?> </a>
                  </div>
                </div>
              </div>
                    ...
                    <table id="mytable" class=" table table-striped table-bordered">
                      <thead>
                        <tr class="text-uppercase">
                          <th>#</th>
                          <th><?= lang('messages_lang.th_description_fin') ?></th>
...
<script>
  ...
  $(document).ready(function()
  {
    ...
    $("#mytable").DataTable(
    {
      ...
      "ajax":
      {
        url:"<?= base_url('ihm/Observation_Financiere/listing')?>",
        type:"POST", 
      },
