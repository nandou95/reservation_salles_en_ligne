              ...
              <div style="box-shadow: rgba(100, 100, 111, 0.25) 0px 7px 29px 0px;padding: 13px !important" class="card">
                <div class="car-body">
                  <div class="row col-md-12">
                    ...
                    <div class="col-md-6">
                      <a class="btn btn-primary" href="<?=base_url('ihm/Information_sup/new') ?>" style="float: right;"><i class="fa fa-plus"></i> <?= lang('messages_lang.nouvelle_action')?></a>
                    </div>
                  </div>
                      ...
                      <table id="mytable" class=" table table-striped table-bordered">
                        <thead>
                          <tr>
                            ...
                            <th><center><?= lang('messages_lang.labelle_et_typeInfo')?></center></th>
...
<script type="text/javascript">
  $(document).ready(function ()
  {
    ...
    $("#mytable").DataTable(
    {
      ...
      "oreder":[[ 0, 'desc' ]],
      "ajax":{
        url:"<?= base_url('ihm/Information_sup/listing')?>",
        type:"POST"
      },
