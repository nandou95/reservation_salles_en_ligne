  ...
  //function qui appelle le view de la liste 
	...
	public function listing()
	{
		...
		foreach($fetch_cov_frais as $info)
		{
			...
			$post[]="<a href='".base_url("ihm/Execution/detail/".md5($info->EXECUTION_BUDGETAIRE_ID))."' class='btn btn-info btn-sm'><i class='fa fa-list'></i></a>";
    ...
    ptba.COUT_UNITAIRE,
    ptba.BUDGET_T1,
    ptba.BUDGET_UTILISE_T1,
    ptba.BUDGET_RESTANT_T1,
    ptba.BUDGET_T2,
    ptba.BUDGET_UTILISE_T2,
    ptba.BUDGET_RESTANT_T2,
    ptba.BUDGET_T3,
    ptba.BUDGET_UTILISE_T3,
    ptba.BUDGET_RESTANT_T3,
    ptba.BUDGET_T4,
    ptba.BUDGET_UTILISE_T4,
    ptba.BUDGET_RESTANT_T4,
    ptba.BUDGET_ANNUEL,
...
WHERE md5(exec.EXECUTION_BUDGETAIRE_ID)="'.$id.'" ORDER BY EXECUTION_BUDGETAIRE_ID ASC';
