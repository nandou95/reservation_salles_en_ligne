                        ...
                        <div class="col-md-12 mt-2" style="margin-bottom:50px">
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-4">
                              ...
                              <input type="text" class="form-control" onkeypress="return false" name="titre" id="titre" value="<?=$info['NUMERO_TITRE_DECAISSEMNT']?>" readonly>
                              <br>
                            </div>
                            ...
                            <div class="col-md-4">
                              ...
                              <input type="date" class="form-control" onkeypress="return false" name="DATE_VALIDE_TITRE" value="<?= set_value('DATE_VALIDE_TITRE')?>" id="DATE_VALIDE_TITRE" max="<?= date('Y-m-d')?>">
                            ...
                            <div class="col-md-4">
                              <label for=""><?= lang('messages_lang.label_date_tra') ?> ( Comptabilité)<font color="red">*</font></label>
                              <input type="date" class="form-control" onkeypress="return false" name="DATE_TRANSMISSION" value="<?= set_value('DATE_TRANSMISSION')?>" id="DATE_TRANSMISSION" max="<?= date('Y-m-d')?>">
