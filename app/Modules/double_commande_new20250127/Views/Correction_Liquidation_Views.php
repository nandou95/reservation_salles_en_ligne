          ...
          <div class="card-body">
            ...
            <div class="col-9" style="float: left;">
              <h1 class="header-title text-dark">
                <!-- Correction de la demande de liquidation -->
          ...
          <input hidden="" type="date" name="DATE_DEBUT_CONTRAT" id="DATE_DEBUT_CONTRAT" value="<?=$info['DATE_DEBUT_CONTRAT']?>">
            ...
            <div class="col-6">
              ...
              <select onchange="getTypeLiquidationMontant()" class="form-control" name="ID_TYPE_LIQUIDATION" id="ID_TYPE_LIQUIDATION">
                ...
                {
                  if ($key->ID_TYPE_LIQUIDATION==$info["ID_TYPE_LIQUIDATION"]) {
                  ?>  
                  <option selected value="<?=$key->ID_TYPE_LIQUIDATION?>"><?=$key->DESCRIPTION_LIQUIDATION?></option>
                  <?php
                  }else{
                  ?>
...
<script type="text/javascript">
  ...
  function getTypeLiquidationMontant()
  {
    ...
    {
      // var MONTANT_RACCROCHE_JURIDIQUE = parseInt(MONTANT_RACCROCHE_JURIDIQUE.replace(/[^0-9.]/g,''),10);
      var MONTANT_RACCROCHE_JURIDIQUE = parseInt(MONTANT_RACCROCHE_JURIDIQUE.replace(/[^0-9]/g,''),10);
