  ...
  <div class='modal-dialog  modal-lg' style="max-width: 60%">
    <div class='modal-content'>
      ...
      <div class='modal-footer'>
        <button id="btn_delete" style="display: block;"  onclick="deleteFile();hideButton()" class='btn btn-primary btn-md' data-dismiss='modal'><i class="fa fa-pencil"></i> <?=lang('messages_lang.labelle_mod')?> <span id="loading_delete"></span></button>
