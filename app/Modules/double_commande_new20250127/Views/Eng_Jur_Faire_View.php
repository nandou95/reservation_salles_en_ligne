                ...
                <div class="card-body">
                  <div style="margin-left: 15px;" class="row">
                    <h1 class="header-title text-dark">
                      <?=lang('messages_lang.titre_jur_faire')?>
                    </h1>
                  </div>
                  <div style="margin-left: 15px;" class="row">
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                      <label for="Nom" class="form-label"><?=lang('messages_lang.Lab_jur_etape')?></label>
                      <select onchange="liste()" class="form-control" name="ETAPE_ID" id="ETAPE_ID">
                        <option value="">-<?=lang('messages_lang.selection_message')?>-</option>
                        <?php
                        foreach($step as $key)
                        {
                          if($key->ETAPE_DOUBLE_COMMANDE_ID==set_value('ETAPE_ID'))
                          {
...
<script type="text/javascript">
  function liste() 
  {
    ...
    $("#mytable").DataTable({
      ...
      "serverSide": true,
      "ajax": {
        url: "<?= base_url('double_commande_new/Menu_Engagement_Juridique/listing')?>",
        type: "POST",
        data: {
