                    ...
                    <div class="row">
                      <div class="col-9" style="float: left;">
                        <h1 class="header-title text-dark">
                          <!-- Introduction sur la demande de liquidation -->
                      ...
                      <div class="row" style="margin :  5px">
                        ...
                        <div class="col-6">
                          ...
                          <select onchange="getTypeLiquidationMontant()" class="form-control" name="ID_TYPE_LIQUIDATION" id="ID_TYPE_LIQUIDATION">
                            ...
                            {
                              ?>
                              <option value="<?=$key->ID_TYPE_LIQUIDATION?>"><?=$key->DESCRIPTION_LIQUIDATION?></option>
                              <?php
                            }
                            ?>
                          </select>
                          <font  color="red" id="error_ID_TYPE_LIQUIDATION"></font>
                        </div>
                        ...
                        <div id="DIV_DATE_LIQUIDATION" class="col-6">
                          ...
                          <input type="date" onkeypress="return false" onblur="this.type='date'" onchange="get_min_trans(this.value)" max="<?=date('Y-m-d')?>" name="DATE_LIQUIDATION" id="DATE_LIQUIDATION" class="form-control" >
                        ...
                        <input value="<?=$info['COUR_DEVISE']?>" autocomplete="off" type="hidden" name="COUT_DEVISE" id="COUT_DEVISE" >
  ...
  <div class='modal-dialog  modal-lg' style="max-width: 60%">
    <div class='modal-content'>
      ...
      <div class='modal-footer'>
        <button id="edi" onclick="deleteFile();hideButton()" class='btn btn-primary btn-md' data-dismiss='modal'><i class="fa fa-pencil"></i> <?=lang('messages_lang.labelle_mod')?> <span id="loading_delete"></span></button>
