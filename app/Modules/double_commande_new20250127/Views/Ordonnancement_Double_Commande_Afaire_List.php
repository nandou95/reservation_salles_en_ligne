                ...
                <div class="col-md-12">
                  <div class="row">
                    <div class="col-md-4">
                      ...
                      <select autofocus onchange="getSousTutel();listing_ordon_Afaire()" class="form-control select2" id="INSTITUTION_ID" name="INSTITUTION_ID">
                      ...
                      <div class="col-md-4">
                        ...
                        <select onchange="listing_ordon_Afaire()" class="form-control" name="SOUS_TUTEL_ID" id="SOUS_TUTEL_ID">
                          <option value="">--<?=lang('messages_lang.selection_message')?>--</option>
                        </select>
                      </div>
                    </div>
...
<script type="text/javascript">
  ...
  {
    listing_ordon_Afaire();
  });
</script>

<script>
  function listing_ordon_Afaire()
  {
    ...
    $("#mytable").DataTable(
    {
      ...
      "ajax":
      {
        url:"<?= base_url('double_commande_new/Ordonnancement_Double_Commande/listing_ordon_Afaire')?>",
        type:"POST", 
        data:
        {
