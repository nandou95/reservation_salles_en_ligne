        ...
        <form enctype='multipart/form-data' id="my_form" action="<?= base_url('double_commande_new/Liquidation/update_partielle') ?>" method="POST">
          ...
          <input hidden="" type="date" name="DATE_DEBUT_CONTRAT" id="DATE_DEBUT_CONTRAT" value="<?=$info['DATE_DEBUT_CONTRAT']?>">
            ...
            <div id="div_creance" class="col-6">
                ...
                <input value="<?=!empty($get_monnaie)?$get_monnaie:''?>" onkeyup="getSubstring(1);SetMaxLength(3);getCalculMontant()" autocomplete="off" type="text" name="MONTANT_CREANCE" id="MONTANT_CREANCE" class="form-control" >
          ...
          <div id="div_devise1" class="col-6">
              ...
              <input value="<?=!empty($get_monnaie) ? $get_monnaie : ''?>" onkeyup="getSubstring(3);SetMaxLength(4);getCalculMontant()" autocomplete="off" type="text" name="MONTANT_DEVISE" id="MONTANT_DEVISE" class="form-control">
              <input value="<?=!empty($get_monnaie)?$get_monnaie:''?>" type="hidden" id="liqui_devise" class="form-control" >
          ...
          <input value="<?=!empty($info['COUR_DEVISE'])?$info['COUR_DEVISE']:''?>" autocomplete="off" type="hidden" name="COUT_DEVISE" id="COUT_DEVISE" class="form-control" >
          ...
          <div class="col-6">
              ...
              <select class="form-control" name="TAUX_TVA_ID" id="TAUX_TVA_ID">
                ...
                foreach ($get_taux_tva as $key) {
                  if ($key->TAUX_TVA_ID==$info['TAUX_TVA_ID']) {
                  ?>
                  <option selected value="<?=$key->TAUX_TVA_ID?>"><?=$key->DESCRIPTION_TAUX_TVA?></option>
                  <?php
                  }else{
                  ?>
...
<script type="text/javascript">
  ...
  function getSubstring(id)
  {
    ...
    var liqui_devise = $('#liqui_devise').val();
...
<script type="text/javascript">
  ...
  function getCalculMontant(argument) {
    ...
    { 
      ...
      // var MONTANT_DEVISE = parseInt(MONTANT_DEVISE)+parseInt(MONTANT_DEVISE_LIQUIDATION);

      var MONTANT_DEVISE_RESTANT = parseInt(MONTANT_DEVISE_ENGAGEMENT_JURIDIQUE)-parseInt(MONTANT_DEVISE_LIQUIDATION);
      
      var MONTANT_devise_liquide = parseInt(liqui_devise)+parseInt(MONTANT_DEVISE_RESTANT);
    ...
    else
    {
      ...
      // var MONTANT_CREANCE = parseInt(MONTANT_CREANCE)+parseInt(MONTANT_RACCROCHE_LIQUIDATION);

      var MONTANT_CREANCE_RESTANT = parseInt(MONTANT_RACCROCHE_JURIDIQUE)-parseInt(MONTANT_RACCROCHE_LIQUIDATION);

      var MONTANT_RESTANT_liquide = parseInt(liqui_montant)+parseInt(MONTANT_CREANCE_RESTANT);

       // alert(MONTANT_CREANCE)
