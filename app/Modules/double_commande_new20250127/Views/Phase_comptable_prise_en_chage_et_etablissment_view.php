                                            ...
                                            <!-- fin -->
                                             ...
                                             <form
                                                ...
                                                <input type="hidden" name="id_detail"
                                                     value="<?= $id['EXECUTION_BUDGETAIRE_DETAIL_ID'] ?>">
                                                 <input type="hidden" name="id"
                                                     value="<?= $id['EXECUTION_BUDGETAIRE_ID'] ?>">
                                                 <input type="hidden" name="ETAPE_ID" class="form-control"
                                                     value="<?= $id['ETAPE_DOUBLE_COMMANDE_ID']?>">
                                                ...
                                                <div class="col-md-12 container " style="border-radius:10px">
                                                    <div class="row mt-3">
                                                        ...
                                                        <div class="col-md-6"><br>
                                                            ...
                                                            <input type="text" name="NOM_PERSONNE_RETRAT" id="NOM_PERSONNE_RETRAT" class="form-control" value="">
                                                            <font color="red" id="NOM_PERSONNE_RETRAT_error"></font>
                                                        </div>
                                                        ...
                                                        <div class="col-md-6"><br>
                                                            ...
                                                            onkeypress="return false"  max="<?= date('Y-m-d')?>"  min="<?= date('Y-m-d')?>" id="date_transmission_id" class="form-control">
...
function check_caractere1()
{
    ...
    function save_dossier()
    {
        ...
        var NOM_PERSONNE_RETRAT=$('#NOM_PERSONNE_RETRAT').val();
        var DEVISE_TYPE_ID_RETRAIT=$('#DEVISE_TYPE_ID_RETRAIT').val();

        var paiment_id= $('#paiment_id').val();
        var number_decaissement_id= $('#number_decaissement_id').val();
        // if (NOM_PERSONNE_RETRAT == "")
        // {
        //     statut = false;
        //     $("#NOM_PERSONNE_RETRAT_error").html("<?= lang('messages_lang.validation_message')?>");
        // }
        ...
        if (statut == true) 
        {
            ...
            if (NOM_PERSONNE_RETRAT!='') 
            {
                $("#NOM_modal").html(NOM_PERSONNE_RETRAT);
            }else{
                $("#NOM_modal").html("-");
            }
