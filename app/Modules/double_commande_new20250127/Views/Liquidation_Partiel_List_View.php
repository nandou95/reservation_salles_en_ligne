                ...
                <div class="card-header">
                  <div class="col-12 d-flex">
                    <div class="col-12 d-flex">
                      ...
                      $get_liquid_partielle1="btn active";
                      ?>
                ...
                <div class="car-body">
                  <div class="col-12" style="float: left;">
                    <h1 class="header-title text-dark">
                      <?=lang('messages_lang.liste_liquid_part')?>
                    </h1>
                  </div>
                  ...
                  <div class="col-md-12">
                    <div class="row">
                      <div class="col-md-4">
                        ...
                        <select autofocus onchange="getSousTutel();listing_liquid_partiel()" class="form-control select2" id="INSTITUTION_ID" name="INSTITUTION_ID">
                        ...
                        <div class="col-md-4">
                          ...
                          <select onchange="listing_liquid_partiel()" class="form-control" name="SOUS_TUTEL_ID" id="SOUS_TUTEL_ID">
                            <option value=""><?=lang('messages_lang.selection_message') ?></option>
                          </select>
                        </div>
                      </div>
                        ...
                        <table id="mytable" class=" table table-striped table-bordered">
                          <thead>
                            <tr>
                              ...
                              <th class="text-uppercase" style="white-space: nowrap;" ><center> <?= lang("messages_lang.menu_taux_change") ?></center></th>
                              <th><center><?=lang('messages_lang.col_eng_budg')?></center></th>
                              <th><center><?=lang('messages_lang.col_eng_jur')?></center></th>
                              <th><center><?= lang('messages_lang.liquidation_decaissement') ?></center></th>
                            </tr>
                          </thead>
                          <tbody>
                          </tbody>
  ...
  <script>
    function listing_liquid_partiel()
    {
      ...
      $("#mytable").DataTable(
      {
        ...
        "ajax":
        {
          url:"<?= base_url('double_commande_new/Liquidation/listing_liquid_partiel')?>",
          type:"POST", 
          data:
          {
