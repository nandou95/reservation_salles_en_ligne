                  ...
                  <div class="car-body">
                    <div class="row">
                      <form enctype='multipart/form-data' id="MyFormData" action="<?=base_url('double_commande_new/Transfert_Meme_Activite/send_data/')?>" method="post" >
                        ...
                        <div class="col-12"><br>
                          <button onclick="send_data()" id="send_button" type="button" class="btn btn-primary btn-block"><?= lang('messages_lang.bouton_confirmer') ?> <span id="loading_btn"></span></button>
                        </div>
                      </form>
                    </div>
                  </div>
  ...
  <div class='modal-dialog  modal-lg' style="max-width: 60%">
    <div class='modal-content'>
      ...
      <div class='modal-footer'>
        <button onclick="deleteFile()" id="modif" class='btn btn-primary btn-md' data-dismiss='modal'><i class="fa fa-pencil"></i> <?= lang('messages_lang.bouton_modifier') ?></button>
        <button onclick="send_data2();hideButton()" id="sav" type="button" class="btn btn-primary"><i class="fa fa-paper-plane"></i> <?= lang('messages_lang.bouton_confirmer') ?></button>
      </div>
    </div>
  </div>
</div>
...
<script>
  function hideButton()
  {
    var element = document.getElementById("modif");
    element.style.display = "none";

    var elementmod = document.getElementById("sav");
