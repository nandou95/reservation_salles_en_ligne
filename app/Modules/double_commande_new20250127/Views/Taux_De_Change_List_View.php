                ...
                <div class="card-header">
                  <div class="row col-md-12">
                   ...
                   <div class="col-md-6" style="float: right;">
                    ...
                    <a href="<?=base_url('double_commande_new/Taux_De_Change/add')?>" style="float: right;margin: 4px;" class="btn btn-primary"><span class="fa fa-plus pull-right"></span> <?= lang('messages_lang.labelle_et_nouveau') ?></a>
                  </div>
                </div>
              </div>
...
<script>
  ...
  function liste_bon()
  {
    ...
    $("#mytable").DataTable({
      ...
      "serverSide": true,
      "ajax": {
        url:"<?= base_url()?>/double_commande_new/Taux_De_Change/listing",
        type: "POST",
        data: 
        {},
        beforeSend: function() {}
