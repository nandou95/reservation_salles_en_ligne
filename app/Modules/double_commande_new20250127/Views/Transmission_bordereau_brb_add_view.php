                  ...
                  <div style="border:1px solid #ddd;border-radius:5px;margin: 5px">
                    <div class="row" style="margin :  5px">
                      ...
                      <div class="col-md-6"><br>
                        ...
                        <input type="date" class="form-control" name="DATE_RECEPTION" id="DATE_RECEPTION" min=<?= $retVal = (!empty($date_transmission['DATE_TRANSMISSION'])) ? $date_transmission['DATE_TRANSMISSION'] : date("Y-m-d") ; ?> max="<?= date("Y-m-d") ?>" onkeypress="return false" onblur="this.type='date'" onchange="get_min_trans(this.value)">
                      ...
                      <div class="col-6"><br>
                        ...
                        <input autocomplete="off" type="text" name="NUM_BORDEREAU_TRANSMISSION" id="NUM_BORDEREAU_TRANSMISSION" class="form-control" oninput="checkbord()">
                      ...
                      <div class="col-6"><br>
                        ...
                        <select class="form-control select2" multiple name="EXECUTION_BUDGETAIRE_DETAIL_ID[]" id="EXECUTION_BUDGETAIRE_DETAIL_ID">
                          ...
                          foreach ($exec as $key) {
                          ?>
                            <option value="<?= $key->EXECUTION_BUDGETAIRE_DETAIL_ID ?>"><?= $key->NUMERO_DOCUMENT ?></option>
                          <?php
                          }
                          ?>
                        </select>
                      ...
                      <div class="col-md-6"> <br>
                        ...
                        <input type="date" name="DATE_TRANSMISSION" onkeypress="return false" max="<?= date('Y-m-d') ?>" id="DATE_TRANSMISSION" class="form-control">
  ...
  <div class='modal-dialog  modal-lg' style="max-width: 60%">
    <div class='modal-content'>
      ...
      <div class='modal-footer'>
        <button id="mod" class='btn btn-primary btn-md' data-dismiss='modal'><i class="fa fa-pencil"></i><?= lang('messages_lang.bouton_modifier') ?></button>
...
<script type="text/javascript">
  function send_data() {
    ...
    form.append("EXECUTION_BUDGETAIRE_DETAIL_ID", EXECUTION_BUDGETAIRE_DETAIL_ID);
...
<script>
  function checkbord()
  {
    ...
    form.append("ID_ORIGINE_DESTINATION",ID_ORIGINE_DESTINATION);
    $.ajax({
      url: "<?=base_url('/double_commande_new/Transmission_borderau_brb/checkbord')?>",
      type: "POST",
      dataType: "JSON",
      data: form,
      processData: false,
