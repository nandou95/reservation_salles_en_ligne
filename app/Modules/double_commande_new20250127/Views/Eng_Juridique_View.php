                            ...
                            <div class="col-md-12 mt-3 ml-2"style="margin-bottom:50px" >
                              <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="date" class="form-control" id="DATE_HEURE_JURIDIQUE" name="DATE_HEURE_JURIDIQUE" value="<?=set_value('DATE_HEURE_JURIDIQUE')?>" min="<?=date('Y-m-d', strtotime($date_trans['DATE_TRANSMISSION']))?>" max="<?=date('Y-m-d')?>" onkeypress="return false" onblur="this.type='date'" >
                                    <?php if (isset($validation)) : ?>
                                ...
                                <?php if($details['MARCHE_PUBLIQUE'] == 1): ?>
                                  <div class="col-md-6">
                                      ...
                                      <input type="date" class="form-control" id="DATE_DEBUT" name="DATE_DEBUT"  value="<?=set_value('DATE_DEBUT')?>" min="<?=date('Y-m-d', strtotime($debut))?>" onkeypress="return false" onblur="this.type='date'" onchange="get_min_fin(this.value)">
                                      <?php if (isset($validation)) : ?>
                                  ...
                                  <div class="col-md-6">
                                      ...
                                      <input type="date" class="form-control" id="DATE_FIN" name="DATE_FIN"  value="<?=set_value('DATE_FIN')?>" onkeypress="return false" onblur="this.type='date'">
                                      <?php if (isset($validation)) : ?>
