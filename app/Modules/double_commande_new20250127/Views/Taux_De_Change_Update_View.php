            ...
            <div class="col-12">
              ...
              <div class="card-body">
                <div class="table-responsive" style="width: 100%;">
                  <div class="card-body">
                    <form action="<?=base_url('double_commande_new/Taux_De_Change/update') ?>" method="POST" id="MyFormData">

                      <input type="hidden" name="DEVISE_TYPE_ID" id="DEVISE_TYPE_ID" value="<?=$taux['DEVISE_TYPE_ID']?>">
                      <div class="row col-md-12">
                        <div class="col-md-6">
                          <label><?= lang('messages_lang.labelle_devise') ?></label>
                          <input type="text" name="DEVISE" id="DEVISE" class="form-control" maxlength="50" value="<?=$devise['DESC_DEVISE_TYPE']?>">
                          <font color="red" id="error_devise" ></font>
                          <?= $validation->getError('DEVISE'); ?>
                        </div>
                        <div class="col-md-6">
                          <label><?= lang('messages_lang.label_droit_taux') ?></label>
                          <input type="text" name="TAUX" id="TAUX" class="form-control" value="<?=$taux['TAUX']?>">
