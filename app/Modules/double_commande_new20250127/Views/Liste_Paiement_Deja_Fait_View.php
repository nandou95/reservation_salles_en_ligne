...
<script type="text/javascript">
  function liste() {
    ...
    $("#mytable").DataTable({
      ...
      "serverSide": true,
      "ajax": {
        url: "<?= base_url('double_commande_new/Liste_Paiement_Deja_Fait/listing') ?>",
        type: "POST",
        data: {
...
<script>
  function sous_titre() {
    ...
    if (INSTITUTION_ID == '') {
      ...
      $.ajax({
        url: "<?= base_url() ?>/double_commande_new/Liste_Paiement_Deja_Fait/get_sous_titre/" + INSTITUTION_ID,
        type: "GET",
        dataType: "JSON",
