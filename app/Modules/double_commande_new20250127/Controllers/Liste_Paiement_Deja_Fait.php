...
class Liste_Paiement_Deja_Fait extends BaseController
{
  ...
  public function listing()
  {
    ...
    $order_column = array('NUMERO_BON_ENGAGEMENT', 'NUMERO_TITRE_DECAISSEMNT', 'pap_activites.DESC_PAP_ACTIVITE', 'ligne_budg.CODE_NOMENCLATURE_BUDGETAIRE', 'exec.ENG_BUDGETAIRE', 1, 'exec.ENG_JURIDIQUE', 1, 'exec_detail.MONTANT_LIQUIDATION', 1, 'exec_detail.MONTANT_ORDONNANCEMENT', 1);
    ...
    $search = !empty($_POST['search']['value']) ?  (" AND (NUMERO_BON_ENGAGEMENT LIKE '%$var_search%' OR pap_activites.DESC_PAP_ACTIVITE LIKE '%$var_search%' OR NUMERO_TITRE_DECAISSEMNT LIKE '%$var_search%' OR exec.ENG_BUDGETAIRE LIKE '%$var_search%')") : '';
