...
class User_profil extends BaseController
{
	...
	public function getDetail($PROFIL_ID='')
	{
		...
		<th>'.lang("messages_lang.labelle_affect").'</th>
		...
		<td>'.$this->check_droit($profil['AFFECTATION']).'</td>
