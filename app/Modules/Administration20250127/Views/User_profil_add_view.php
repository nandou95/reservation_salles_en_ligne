                    ...
                    <form name="myform" id="myform" action="<?=base_url('Administration/User_profil/insert')?>" method="POST" enctype="multipart/form-data">
                      <div class="card-body">
                        ...
                        <div class="row" id="div_double_commande">
                          ...
                          <div class="col-md-4">
                            <input type="checkbox" value="1" name="IS_CONFIRMATION_ENGAGEMENT_BUDGETAIRE_CED"><span style="margin-left:5px;"></span><?=lang('messages_lang.conf_cd_eng')?>
                          </div>
                          <div class="col-md-4">
                          ...
                          <div class="col-md-4">
                            <input type="checkbox" value="1" name="IS_CONFIRMATION_ENGAGEMENT_JURIDIQUE"><span style="margin-left:5px;"></span><?=lang('messages_lang.conf_jur')?>
                          </div>
                          <div class="col-md-4">
                          ...
                          <div class="col-md-4">
                            <input type="checkbox" value="1" name="IS_CONFIRMATION_ENGAGEMENT_LIQUIDATION"><span style="margin-left:5px;"></span><?=lang('messages_lang.conf_liq')?>
                          </div>
                          <div class="col-md-4">
                          ...
                          <div class="col-md-4">
                            <input type="checkbox" value="1" name="IS_ORDONNANCEMENT_TRANSMISSION_BORDEREAU"><span style="margin-left:5px;"></span><?=lang('messages_lang.ordo_trans_bord')?>
                          </div>
                          <div class="col-md-4">
                            <input type="checkbox" value="1" name="IS_TRANSMISSION_SERVICE_PRISE_COMPTE"><span style="margin-left:5px;"></span><?=lang('messages_lang.trans_sp')?>
                          </div>
                          <div class="col-md-4">
                          ...
                          <div class="col-md-4">
                            <input type="checkbox" value="1" name="DOUBLE_COMMANDE_VALIDE_TD"><span style="margin-left:5px;"></span><?=lang('messages_lang.valid_td')?>
                          </div>
                          <div class="col-md-4">
                          ...
                          <div class="col-md-4">
                            <input type="checkbox" value="1" name="AFFECTATION"><span style="margin-left:5px;"></span><?=lang('messages_lang.labelle_affect')?>
                          </div>
                          <div class="col-md-4">
