...
<body>
          ...
          <div class="row">
            <div class="col-12">
              <div style="box-shadow: rgba(100, 100, 111, 0.25) 0px 7px 29px 0px" class="card">
                <div class="card-header">
                  <div class="col-md-12 d-flex">
                    <div class="col-md-9" style="float: left;">
                      <h1 class="header-title text-black"><?=lang('messages_lang.modif_user')?></h1>
                    </div>
                ...
                <div class="card-body">
                  <form action="<?= base_url('Administration/Gestion_Utilisateurs/update') ?>" id="Myform" method="POST" enctype="multipart/form-data">
                    <input type="hidden" name="USER_ID" id="USER_ID" value="<?=$users['USER_ID']?>">
                    <input type="hidden" name="PROF_ID" id="PROF_ID" value="<?=$users['PROFIL_ID']?>">
                    <!-- table qui affiche la liste -->
                    <input type="hidden" name="TABLE_CART" id="TABLE_CART" value="<?=$table_to_delete?>">
                    <!-- table qui affiche la liste -->
                    <br>
                              ...
                              <div class="row">
                                ...
                                <div class="col-md-6">
                                  <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="NOM" name="NOM" value="<?=$users['NOM']?>" onpaste="return false" autocomplete="off">
                                ...
                                <div class="col-md-6">
                                  <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="PRENOM" name="PRENOM" value="<?=$users['PRENOM']?>" onpaste="return false" autocomplete="off">
                                    <?php if (isset($validation)) : ?>
                                ...
                                <div class="col-md-6">
                                  <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="TELEPHONE1" id="TELEPHONE1" value="<?=$users['TELEPHONE1']?>" onpaste="return false" autocomplete="off">
                                    <?php if (isset($validation)) : ?>
                                ...
                                <div class="col-md-6">
                                  <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="TELEPHONE2" id="TELEPHONE2" value="<?=$users['TELEPHONE2']?>" onpaste="return false" autocomplete="off">
                                ...
                                <div class="col-md-6">
                                  <div class="form-group">
                                    ...
                                    <select class="form-control" name="PROFIL_ID" id="PROFIL_ID" onchange="get_prof_niv()">
                                      ...
                                      { 
                                        ...
                                        {
                                          if($value->PROFIL_ID==$users['PROFIL_ID'])
                                          {
                                            ?>
                                            <option value="<?=$value->PROFIL_ID ?>" selected><?=$value->PROFIL_DESCR?></option>
                                            <?php  
                          ...
                          <div class="table-responsive container " style="margin-top:50px">
                            <div class="card-body">
                              ...
                              <div class="row">
                                ...
                                <div class="col-md-6">
                                  <div class="form-group">
                                    <label><?=lang('messages_lang.labelle_inst_min')?><span style="color: red;">*</span></label>
                                    <select class="form-control" name="INSTITUTION_ID" id="INSTITUTION_ID" value="<?=set_value('INSTITUTION_ID')?>" onchange="get_tutel()">
                                      <option value="">--<?=lang('messages_lang.labelle_selecte')?>--</option>
                                ...
                                <div class="col-md-6" id="est_st" style="display: none;">
                                  <div class="form-group">
                                    ...
                                    <span id="error_IS_SOUS_TUTEL" class="text-danger"></span>
                                  </div>
                                </div>
                                ...
                                <br>
                                <br>
                                <div class="col-md-12 table table-responsive" id="CART_FILE"><?=$myCart?></div>
                                <br>
                                <br>
  ...
  <script type="text/javascript">
    function save_tab1()
    {
      ...
      $('#error_NOM,#error_PRENOM,#error_TELEPHONE1,#error_PROFIL_ID').html('');
      ...
      if(statut== 2)
      {
        $.ajax(
        {
          url: '<?=base_url()?>/Administration/Gestion_Utilisateurs/get_prof_niv',
          type: "POST",
          dataType: "JSON",
          data:
          {
  ...
  //fonction inserer dans la table tempo
    function addToCart()
    {
      ...
      if (PROFIL_ID=='') 
      {
        $('#error_PROFIL_ID').text("<?=lang('messages_lang.message_champs_obligatoire')?>");
        return false;
      }else{
      ...
      if(IS_SOUS_TUTEL == '')
      {
        $('#error_SOUS_IS_SOUS_TUTEL').text("<?=lang('messages_lang.message_champs_obligatoire')?>");
        return false;
      } else {
        $('#error_SOUS_IS_SOUS_TUTEL').text('');
      }
      ...
      if (statut == true) {
        $.ajax({
          url: '<?=base_url()?>/Administration/Gestion_Utilisateurs/update_affectation',
          type: "POST",
          dataType: "JSON",
          data: {
            USER_ID:USER_ID,
          ...
          success: function(data) {
            $('#loading_cart').html("");
        //window.location.href = '/Administration/Gestion_Utilisateurs/getOne/'+USER_ID;
            $('#loading_cart').html("");
            $('#CART_FILE').html(data.cart);
            CART_FILE.innerHTML=data.cart;
            $('#SHOW_FOOTER').show();
            $('#SAVE').show();
            $('#TABLE_CART').val(data.TABLE_CART);
          }
        });
      }
    }

  //Fonction pour supprimer dans la table user affectation
    function remove_cart()
    {
      var USER_ID=$('#USER_ID').val();
      var id=$('#del_id').val();
      var rowid=$('#rowid'+id).val();
      var TABLE_CART=$('#TABLE_CART').val();
      var fonction="";
      if(TABLE_CART=='user_affectaion')
      {
        fonction="delete_affectation";
      }
      else
      {
        fonction="delete";
      ...
      $.post("<?=base_url()?>/Administration/Gestion_Utilisateurs/"+fonction,
      {
        USER_ID:USER_ID,
        rowid:rowid,
        id:id
