...
/**Eric SINDAYIGAYA
  *Fone: (+257)62 040 300
  *Email: sinda.eric@mediabox.bi
  *Date: 07 Fev,2024
  *Titre: Listes des plannifications
**/
...
class Demandes_Plannification extends BaseController
{
  protected $session;
  protected $ModelPs;
  ...
  function index()
  {
    ...
    $bindparams = $this->getBindParms('`PROCESS_ID`,`NOM_PROCESS`','proc_process','PROCESS_ID >8 AND STATUT=1','`PROCESS_ID` ASC');
    ...
    return view('App\Modules\process\Views\Demande_List_Plannification_View',$data);
  } 
  ...
  { 
    ...
    foreach($fetch_cov_frais as $info)
    {
      ...
      $post[]="<a title='Détail' class='btn btn-primary btn-md' href='".base_url("".$info->LINK."".md5($info->ID_DEMANDE))."'><i class='fa fa-list'></i></a>";
      $data[]=$post;  
    }
