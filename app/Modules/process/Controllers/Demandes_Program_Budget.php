...
/**Eric SINDAYIGAYA
  ...
  *Date: 07 Fev,2024
  *Titre: Listes des programmations budgetaires
**/
...
class Demandes_Program_Budget extends BaseController
{
  protected $session;
  protected $ModelPs;
  ...
  function index()
  {
    ...
    $bindparams = $this->getBindParms('`PROCESS_ID`,`NOM_PROCESS`', 'proc_process', 'PROCESS_ID=11 AND STATUT=1', '`PROCESS_ID` ASC');
    ...
    return view('App\Modules\process\Views\Demande_List_Programmation_Budgetaire_View',$data);
  } 
