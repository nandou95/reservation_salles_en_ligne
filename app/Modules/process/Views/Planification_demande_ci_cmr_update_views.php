            ...
            <div class="col-md-12">
              <div style="box-shadow: rgba(100, 100, 111, 0.25) 0px 7px 29px 0px" class="card">
                ...
                <div class="card-body" style="overflow-x:auto;">
                  <form method="post" action="<?=base_url('process/Planification_Strategique_Sectorielle/update_form_cl_cmr_costab/')?>" id="MyFormData" class="js-formSubmit" enctype="multipart/form-data">
                    <br>
                    <ul class="nav nav-tabs" role="tablist">
                      ...
                      <li class="nav-item">
                        <a class="nav-link" id="tab2" data-toggle="tab" href="#"> COSTAB </a>
                      </li>
                    </ul>
                    <!-- Tab panes -->
                    <div class="tab-content">
                      ...
                      <div style="display: block;" id="cl_cmr" class="tab-pane active"><br>
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-md-6">
                            <label for=""><?=lang('messages_lang.label_pil')?><font color="red">*</font></label>
                            <select onchange="getObjectif()" name="ID_PILIER" class="form-control" id="ID_PILIER">
                              <option value=""><?=lang('messages_lang.label_selecte')?></option>
                          ...
                          <div class="col-md-6">
                            ...
                            <select onchange="getIndicateur()" name="ID_OBJECT_STRATEGIQUE" class="form-control" id="ID_OBJECT_STRATEGIQUE">
                              <option value=""><?=lang('messages_lang.label_selecte')?></option>
                            </select>
                          ...
                          <div class="col-md-6">
                            ...
                            <select name="ID_PLANS_INDICATEUR" class="form-control" id="ID_PLANS_INDICATEUR">
                              <option value=""><?=lang('messages_lang.label_selecte')?></option>
                          ...
                          <div class="col-md-6">
                            <label for=""><?=lang('messages_lang.label_precision')?><font color="red">*</font></label>
                          ...
                          <div class="col-md-12">
                            <button type="button" onclick="update_save_cl_cmr()" id="action_btn_cl_cmr" class="btn btn-primary btn-block mt-4" style="float: right;"><?=lang('messages_lang.bouton_enregistrer')?><span id="loading_cl_cmr"></span></button>
                          </div>
                        </div>
                      ...
                      <div id="costab" class="tab-pane" style="display: none;">
                        <div class="row">
                          ...
                          <div class="col-md-12">
                            <label class="form-label"><?=lang('messages_lang.labelle_institution')?> <span style="color: red">*</span></label>
                            <select class="form-control" id="INSTITUTION_ID2" name="INSTITUTION_ID2">
                              <option value=""><?=lang('messages_lang.label_selecte')?></option>
                              <?php foreach ($institution as $keyinstitution) { ?>
                                <option value="<?=$keyinstitution->INSTITUTION_ID?>">
                                  <?=$keyinstitution->DESCRIPTION_INSTITUTION?></option>
                          ...
                          <div class="col-md-4"> 
                            <!-- <div class="form-group"> -->
                              ...
                              <select class="form-control" name="ID_ENJEUX" id="ID_ENJEUX" onchange="getPilier();">
                          ...
                          <div class="col-md-4">
                            <!-- <div class="form-group"> -->
                              <label><?=lang('messages_lang.label_pil')?> <span style="color: red;">*</span></label>
                              <select onchange="getObjectif2()" class="form-control" name="ID_PILIER_TR" id="ID_PILIER_TR">
                                <option value="" selected disabled><?=lang('messages_lang.label_selecte')?></option>
                                <?php foreach ($piliers as $pilier) : ?>
                                  <option value="<?= $pilier->ID_PILIER ?>">
                                    <?= $pilier->DESCR_PILIER ?>
                          ...
                          <div class="col-md-4">
                            <!-- <div class="form-group"> --> 
                              ...
                              <select class="form-control" name="ID_AXE_INTERVENTION_PND" id="ID_AXE_INTERVENTION_PND">
                                <option value="" selected disabled><?=lang('messages_lang.label_selecte')?></option>
                          ...
                          <div class="col-md-4">
                            <!-- <div class="form-group"> -->
                              ...
                              <select class="form-control" name="ID_OBJECTIF" id="ID_OBJECTIF">
                                <option value="" selected disabled><?=lang('messages_lang.label_selecte')?></option>
                              </select>
                          ...
                          <div class="col-md-4">
                            <!-- <div class="form-group"> -->
                              <label><?=lang('messages_lang.label_prog')?> <span style="color: red;">*</span></label>
                          ...
                          <div class="col-md-12">
                            <button type="button" onclick="update_save_costab()" id="action_btn_costab" class="btn btn-primary btn-block mt-4" style="float: right;"><?=lang('messages_lang.bouton_enregistrer')?><span id="loading_costab"></span></button>
                          </div>
                        ...
                        <div class="col-md-12" id="myTableData2">
                          ...
                          <br>
                          <div class="col-md-6">
                            <button type="button" style="float: left;" onclick="preced()" class="prev_button btn btn-primary"> <?=lang('messages_lang.btn_precedent')?> </button>
                          </div>
...
<script type="text/javascript">
  ...
  function getObjectif() {
    ...
    if (ID_PILIER != '') {
      $.ajax({
        url: `/process/Planification_Strategique_Sectorielle/getObjectif/${ID_PILIER}`,
        type: "GET",
        dataType: "JSON",
  ...
  function getIndicateur() {
    ...
    if (ID_OBJECT_STRATEGIQUE != '') {
      $.ajax({
        url: `/process/Planification_Strategique_Sectorielle/getIndicateur/${ID_OBJECT_STRATEGIQUE}`,
        type: "GET",
        dataType: "JSON",
        success: function(data) {
  ...
  function getObjectif2() {
    ...
    if (ID_PILIER_TR != '') {
      $.ajax({
        url: `/process/Planification_Strategique_Sectorielle/getObjectif/${ID_PILIER_TR}`,
        type: "GET",
        dataType: "JSON",
        success: function(data) {
...
function verify1()
{
   ...
   if ($("#INPUT_DATA").val()<1) {
      ...
      {
        $('#erINSTITUTION_ID').text('<?=lang('messages_lang.message_champs_obligatoire')?>');
        return false;
      }else{
      ...
      if ($("#ID_PILIER").val()=='') 
      {
        $('#erID_PILIER').text('<?=lang('messages_lang.message_champs_obligatoire')?>');
        return false;
      }else{
        $('#erID_PILIER').text('');
      }
      ...
      {
        $('#erID_OBJECT_STRATEGIQUE').text('<?=lang('messages_lang.message_champs_obligatoire')?>');
        return false;
      }else{
      ...
      {
        $('#erID_PLANS_INDICATEUR').text('<?=lang('messages_lang.message_champs_obligatoire')?>');
        return false;
      }else{
     ...
     if ($("#PRECISIONS").val()=='') 
      {
        $('#erPRECISIONS').text('<?=lang('messages_lang.message_champs_obligatoire')?>');
        return false;
      }else{
        $('#erPRECISIONS').text('');
      }
      ...
      if ($("#REFERENCE").val()=='') 
      {
        $('#erREFERENCE').text('<?=lang('messages_lang.message_champs_obligatoire')?>');
        return false;
      }else{
          $('#erREFERENCE').text('');
      }
      ...
      if ($("#CIBLE").val()=='') 
      {
        $('#erCIBLE').text('<?=lang('messages_lang.message_champs_obligatoire')?>');
        return false;
      }else{
        $('#erCIBLE').text('');
      }
...
function verify2() {
    ...
    if ($("#INPUT_DATA2").val()<1) {
      ...
      {
        $('#erINSTITUTION_ID2').text('<?=lang('messages_lang.message_champs_obligatoire')?>');
        return false;
      }else{
      ...
      if ($("#ID_ENJEUX").val()=='') 
      {
        $('#erID_ENJEUX').text('<?=lang('messages_lang.message_champs_obligatoire')?>');
        return false;
      }else{
        $('#erID_ENJEUX').text('');
      }
      ...
      if ($("#ID_PILIER_TR").val()=='') 
      {
        $('#erID_PILIER_TR').text('<?=lang('messages_lang.message_champs_obligatoire')?>');
        return false;
      }else{
        $('#erID_PILIER_TR').text('');
      }
      ...
      {
        $('#erID_AXE_INTERVENTION_PND').text('<?=lang('messages_lang.message_champs_obligatoire')?>');
        return false;
      }else{
      ...
      if ($("#ID_OBJECTIF").val()=='') 
      {
        $('#erID_OBJECTIF').text('<?=lang('messages_lang.message_champs_obligatoire')?>');
        return false;
      }else{
        $('#erID_OBJECTIF').text('');
      }
      ...
      if($("#PROGRAMME_ID").val()=='')
      {
        $('#erPROGRAMME_ID').text('<?=lang('messages_lang.message_champs_obligatoire')?>');
        return false;
      }else{
        $('#erPROGRAMME_ID').text('');
      }
      ...
      {
        $('#erID_PLANS_PROJET').text('<?=lang('messages_lang.message_champs_obligatoire')?>');
        return false;
      }else{
     ...
     if ($("#BUDGET_ANNEE_1").val()=='') 
      {
        $('#erBUDGET_ANNEE_1').text('<?=lang('messages_lang.message_champs_obligatoire')?>');
        return false;
      }else{
      ...
      {
        $('#erBUDGET_ANNEE_2').text('<?=lang('messages_lang.message_champs_obligatoire')?>');
        return false;
      }else{
      ...
      {
        $('#erBUDGET_ANNEE_3').text('<?=lang('messages_lang.message_champs_obligatoire')?>');
        return false;
      }else{
      ...
      {
        $('#erBUDGET_ANNEE_4').text('<?=lang('messages_lang.message_champs_obligatoire')?>');
        return false;
      }else{
      ...
      {
        $('#erBUDGET_ANNEE_5').text('<?=lang('messages_lang.message_champs_obligatoire')?>');
        return false;
      }else{
...
<script type="text/javascript">
 ...
 <script>
  ...
  function update_save_cl_cmr()
  {
    ...
    if ($('#action_btn_cl_cmr').text() == '<?=lang('messages_lang.bouton_enregistrer')?>')
    {
      var SOURCE = 1;// Add
    } else {
      var SOURCE = 2;// update
    ...
    url = '<?=base_url('process/Planification_Strategique_Sectorielle/update_save_cl_cmr')?>';
        ...
        success:function(data)
        {
          if (data.status)
          {
            setTimeout(()=>{
              ...
              if (SOURCE==1) 
              {
                $('#action_btn_cl_cmr').html('<b><?=lang('messages_lang.message_success')?> <i class="fa fa-check"></i></b>');
              }
              else
              {
...
function supprimer_cl_cmr(id)
{
    ...
    $.ajax({
      url : "<?=base_url('process/Planification_Strategique_Sectorielle/supprimer_cl_cmr')?>",
      type: "POST",
      dataType: "JSON",
      data:{
        id:id
...
function editercl_cmr(id)
{
    ...
    $.ajax({
        url : "<?=base_url('process/Planification_Strategique_Sectorielle/editercl_cmr')?>",
        type: "POST",
        dataType: "JSON",
        data:{
          id:id
...
function liste_cl_cmr()
{
    ...
    var ID_CL_CMR_COSTAB_CATEGORIE=$('#ID_CL_CMR_COSTAB_CATEGORIE').val();
      ...
      $.ajax(
      { 
        url:"<?=base_url('process/Planification_Strategique_Sectorielle/liste_cl_cmr')?>",
        type:"POST",
        dataType:"JSON",
        cache:false,
        data:{
 ...
 <script>
  ...
  function update_save_costab()
  {
    ...
    if ($('#action_btn_costab').text() == '<?=lang('messages_lang.bouton_enregistrer')?>')
    {
      var SOURCE = 1;// Add
    } else {
      var SOURCE = 2;// update
    ...
    url = '<?=base_url('process/Planification_Strategique_Sectorielle/update_save_costab')?>';
        ...
        success:function(data)
        {
          ...
          if (data.status)
          {
            setTimeout(()=>{
              ...
              if (SOURCE==1) 
              {
                $('#action_btn_costab').html('<b><?=lang('messages_lang.message_success')?> <i class="fa fa-check"></i></b>');
              }
              else
              {
           ...
           setTimeout(()=>{
              liste_costab()
              window.location.href="<?= base_url('process/Planification_Strategique_Sectorielle/index')?>/"+ACTION_ID+'/'+ID_DEMANDE2+'/'+getForm;
            },5000);
          }
        }
    });
...
{
    $.ajax({
      url : "<?=base_url('process/Planification_Strategique_Sectorielle/supprimer_costab')?>",
      type: "POST",
      dataType: "JSON",
      data:{
        id:id
...
function editercostab(id)
{
    ...
    $.ajax({
        url : "<?=base_url('process/Planification_Strategique_Sectorielle/editercostab')?>",
        type: "POST",
        dataType: "JSON",
        data:{
          id:id
...
function liste_costab()
{
    ...
    $.ajax(
    { 
      url:"<?=base_url('process/Planification_Strategique_Sectorielle/liste_costab')?>",
      type:"POST",
      dataType:"JSON",
      cache:false,
      data:{
