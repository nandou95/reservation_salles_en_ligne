      ...
      <div class="col-12">
       <div style="box-shadow: rgba(100, 100, 111, 0.25) 0px 7px 29px 0px" class="card">
        ...
        <div class="col-12 d-flex">
          ...
          <div class="col-9" style="float: left;">
            <h1 class="header-title text-dark">
              <?=lang('messages_lang.labelleheader')?>
            </h1>
          </div>
        ...
        <div class="card-body">
         ...
         <form id="my_form" action="<?= base_url('process/tempo_save') ?>" method="POST">
            <div class="card-body">
            ...
            <div class="row">
              <div class="col-6">
                <div class="form-group">
                  ...
                  <select  class="  form-control sous_tutel" name="SOUS_TUTEL_ID" id="SOUS_TUTEL_ID" onchange="get_programs();">
            ...
            <div class="form-row col-12">
              ...
              <div class="form-group col-4">
                ...
                <?php
                  ...
                  {
                    if($key->ARTICLE_ID==$set_action_id)
                    {
              ...
              <div class="form-group col-4">
                ...
                <input autocomplete="off" type="text" name="CODE_NOMENCLATURE_BUDGETAIRE" id="CODE_NOMENCLATURE_BUDGETAIRE" class="form-control" >
                <?php if (isset($validation)) : ?>
              ...
              <div class="form-group col-4">
                ...
                <input  autocomplete="off" type="text" name="CODES_PROGRAMMATIQUE" id="CODES_PROGRAMMATIQUE" class="form-control" >
            ...
            <div class="row col-12">
              <div class="col-4">
                <div class="form-group">
                  ...
                  <textarea  name="ACTIVITES" id="ACTIVITES" class="form-control" rows="2"></textarea>
                  <?php if (isset($validation)) : ?>
              ...
              <div class="col-4">
                <div class="form-group">
                  ...
                  <textarea type="text" name="RESULTATS_ATTENDUS" id="RESULTATS_ATTENDUS" class="form-control" rows="2"></textarea>
                  <?php if (isset($validation)) : ?>
               ...
               <div class="col-4">
                <div class="form-group">
                  ...
                  <textarea name="INTITULE_LIGNE" id="INTITULE_LIGNE" class="form-control" rows="2"></textarea>
                  <?php if (isset($validation)) : ?>
        ...
        <div class="row" style="margin :  5px">
          ...
          <div class="col-6">
            <div class="form-group">
              <label><?=lang('messages_lang.labelle_Chapitre')?><span style="color: red;">*</span></label>
                ...
                <?php if (isset($validation)) : ?>
                <?php
                  foreach($chapitres as $key)
                  {
                    if($key->CHAPITRE_ID==$set_action_id)
                    {
                      echo "<option value='".$key->CHAPITRE_ID."'  selected>".str_replace("\\", "", $key->LIBELLE_CHAPITRE)."</option>";
                    }
                    else
                    {
                      echo "<option value='".$key->CHAPITRE_ID."' >".str_replace("\\", "", $key->LIBELLE_CHAPITRE)."</option>";
                    }
                  }
                  ?>
                <?php endif ?>
          ...
          <div class="col-6">
            <div class="form-group">
              ...
              <input  autocomplete="off" type="text" name="ARTICLE_ECONOMIQUE" id="CODE_ARTICLES123" class="form-control" readonly>
          ...
          <div class="col-6">
            <div class="form-group">
              ...
              <input autocomplete="off" type="text" name="NATURE_ECONOMIQUE" id="code_natire" class="form-control" readonly>
              <?php if (isset($validation)) : ?>
    ...
    <div class="row" style="margin :  5px">
      <div class="col-12">
        ...
        <div class="form-group">
          ...
          <select class=" form-control form-select bg-light" onchange="code_groupe()" name="INTITULE_DIVISION" id="INTITULE_DIVISION" autocomplete="off" aria-label=".form-select-lg example">
                <option value=""><?=lang('messages_lang.labelle_selecte')?> </option>
                <?php if (isset($validation)) : ?>
                <?php
                  foreach($fonctionnelle_division as $key)
                  {
                    if($key->DIVISION_ID==$set_action_id)
                    {
      ...
      <div class="col-4">
        <div class="form-group">
          ...
          <select class=" form-control form-select bg-light" onchange="code_classe()" name="INTITULE_GROUPE" id="INTITULE_GROUPE" autocomplete="off" aria-label=".form-select-lg example">
                <option value=""><?=lang('messages_lang.labelle_selecte')?> </option>
      ...
      <div class="col-4">
        <div class="form-group">
          ...
          <input autocomplete="off" type="text" name="CODE_DIVISION" id="CODE_DIVISION" class="form-control">
      ...
      <div class="col-4">
        <div class="form-group">
          ...
          <input autocomplete="off" type="text" name="CODE_GROUPE" id="CODE_GROUPE" class="form-control"> 
      ...
      <div class="col-4">
        <div class="form-group">
          ...
          <input  autocomplete="off" type="text" name="CODE_CLASSE" id="CODE_CLASSE" class="form-control">
          <?php if (isset($validation)) : ?>
    ...
    <div class="row" style="margin :  5px">
      ...
      <div class="col-6">
        <div class="form-group">
          ...
          <input  autocomplete="off" type="text" name="COUT_UNITAIRE_BIF" id="COUT_UNITAIRE_BIF" class="form-control">
          <?php if (isset($validation)) : ?>
      ...
      <div class="col-3">
        <div class="form-group">
          ...
          <input autocomplete="off" type="text" onkeyup="getSubstring(1)" name="QT1" id="QT1" class="form-control" >
          <?php if (isset($validation)) : ?>
      ...
      <div class="col-3">
        <div class="form-group">
          ...
          <input autocomplete="off" type="text" name="QT2" onkeyup="getSubstring(2)" id="QT2"  class="form-control">
          <?php if (isset($validation)) : ?>
      ...
      <div class="col-3">
        <div class="form-group">
          ...
          <input autocomplete="off" type="text" onkeyup="getSubstring(3)" name="QT3" id="QT3" class="form-control">
          <?php if (isset($validation)) : ?>
      ...
      <div class="col-3">
        <div class="form-group">
          ...
          <input autocomplete="off" type="text" name="QT4" onkeyup="getSubstring(4)"id="QT4"  class="form-control">
          <?php if (isset($validation)) : ?>
  ...
  <div style="border:1px solid #ddd;border-radius:5px;margin: 5px;background-color:#fff">
    ...
    <div class="col-12">
      <div class="form-group">
        ...
        <select onchange="get_code_int();" class=" form-control" name="INTITULE_DES_GRANDES_MASSES" id="masse_grands">
        <option value="">--<?=lang('messages_lang.labelle_selecte')?>--</option>
        <?php
        foreach($masse_classe as $value){ ?>

        <option value="<?php echo $value->GRANDE_MASSE_ID?>"><?php  echo  $value->DESCRIPTION_GRANDE_MASSE ?></option>
       <?php } ?>
      </select>
...
<div class="col-6">
  <div class="form-group">
   ...
   <input  type="text" name="GRANDE_MASSE_BP" id="GRANDE_MASSE_BP" class="form-control" >
   <?php if (isset($validation)) : ?>
...
<input  type="hidden" name="GRANDE_MASSE_BM" id="GRANDE_MASSE_BM" class="form-control" >
<input type="hidden" name="GRANDE_MASSE_BM1" id="GRANDE_MASSE_BM1" class="form-control">
...
<input type="hidden" value="<?=$Id_demande_Row['ID_DEMANDE']?>" name="ID_DEMANDE_NEW">
<input type="hidden" id="CODE_ARTICLES">
<input type="hidden" id="ID_DIVISIONS">

<input type="hidden" id="ID_SOUS_LITTERAS">
<input type="hidden" id="ID_SOUS_LITTERAS_ALL">
<input type="hidden" id="ID_SOUS_TUTEL_ALL">
<div class="col-12">
  <button style="float: right;" id="btnSave" type="button" onclick="insert()" class="btn btn-primary float-end envoi"><i class="fa fa-sign-in" aria-hidden="true"></i>&nbsp;Ajouter</button>
...
<?php if($data_tempo!=null){?>
  ...
  <a style="float: right;" class="btn btn-primary float-end envoi" href="<?=base_url('process/confirmations')?>"><i class="fa fa-sign-in" aria-hidden="true"></i>&nbsp;<?=lang('messages_lang.bouton_enregistrer')?></a>
</div>
...
<div class="modal fade" id="mydelete">
      ...
      <div style="float:right; margin-right:115px;margin-top:-75px;">
			...
			<button class="btn btn-secondary" class="close" data-dismiss="modal"><?= lang('messages_lang.label_non')?></button>
...
$(function(){
  ...
  // get code paragraphe
  // fonction pour generation code Budgetaire
  $(function(){
...
//  alert(id);
 $.post('<?=base_url('process/supprimer')?>',
 {
  ...
  function SetMaxLength (id) {
    ...
    var INTITULE_LIGNE = $('#INTITULE_LIGNE').val().length; 
    ...
    if (id==1) {
      ...
      $('#getNumberINTITULE_LIGNE').text("");
      if (INTITULE_LIGNE!=0) {
        $('#getNumberINTITULE_LIGNE').text(""+INTITULE_LIGNE+"/2000");
      }
    }else if (id==8) {
...
<script type="text/javascript">
  ...
  $("#ACTIVITES, #RESULTATS_ATTENDUS, #UNITE, #QT1, #QT2, #QT3, #QT4, #COUT_UNITAIRE_BIF,INTITULE_LIGNE").on('input', function()
  {
    var maxLength;
    ...
    if (this.id === "ACTIVITES") {
      ...
      maxLength = 50;
    } else  if (this.id === "INTITULE_LIGNE") {
      maxLength = 2000;
...
<script type="text/javascript">
  ...
  {  
    ...
    var INTITULE_LIGNE  = $('#INTITULE_LIGNE').val();
    ...
    if(INTITULE_LIGNE == '')
    {
      $('#error_INTITULE_LIGNE').html('<?= lang('messages_lang.message_champs_obligatoire')?>');
      statut = 1;
    }
