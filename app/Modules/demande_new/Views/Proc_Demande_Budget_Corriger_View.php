      ...
      <div class="main">
        ...
        <main class="content">
          <div class="container-fluid">
              ...
              <div class="col-12">
                <div style="box-shadow: rgba(100, 100, 111, 0.25) 0px 7px 29px 0px" class="card">
                  <div style="float: right;">
                    <a href="<?php echo base_url('demande_new/Proc_Demande_Budget_Corriger/')?>" style="float: right;margin-right: 20px;margin-top:5px" class="btn btn-primary"><i class="fa fa-list" aria-hidden="true"></i><?=lang('messages_lang.bouton_liste')?></a>
                  </div>
                  <div class="car-body">
                    <?php
                    ...
                    <div class=" container " style="width:90%">
                      <form enctype='multipart/form-data' id="MyFormData" action="<?=base_url('demande_new/Proc_Demande_Budget_Corriger/saveinfo_activite/')?>" method="post" >
                        <div class="container">
                          <div class="row">
                           <?php
                        ...
                        <div class="row">
                          <div class="col-md-3"><i class="fa fa-file-text"></i>&nbsp;&nbsp;<?=lang('messages_lang.Libel')?></div>
                          ...
                          <div class="col-md-7 mt-3 ml-2"style="margin-bottom:50px" >
                            <div class="row">
                              <div class="col-md-6">
                                ...
                                <?php $transfert_activite=array('0'=>'Non','1'=>'Oui'); ?>
                              ...
                              <div class="col-md-6" id="div_tranche">
                                <div class="form-group">
                                  ...
                                  <select name="TRANCHE_ID" id="TRANCHE_ID" onchange="get_mont_transfert();valid_transfert()" class=" select2 form-control">
                                    <option value=""><?=lang('messages_lang.lab_select')?></option>
                                    <?php foreach($tranches as $key_tranche):?>
                                      <option value="<?= $key_tranche->TRANCHE_ID?>"><?= $key_tranche->DESCRIPTION_TRANCHE?></option>
                                    <?php endforeach ?>
                                      </select>
                                ...
                                <div class="col-md-6" id="num_montant_transfert">
                                  <div class="form-group">
                                    <label for=""><?=lang('messages_lang.montant_transferer')?><font color="red">*</font></label>
                                    <input type="number" onkeyup="valid_transfert()" min="0" class="form-control" name="MONTANT_TRANSFERT" id="MONTANT_TRANSFERT" value="0">
                                ...
                                <div class="col-md-6">
                                  <div class="form-group">
                                    <label class="form-label"><?=lang('messages_lang.etat_execution')?> <font color="red">*</font></label>
                                ...
                                <div class="col-md-6" id="num_bon_eng">
                                  <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" onclick="valid_transfert()" name="numero_bon" id="numero_bon_id" minlength="5" maxlength="20">
                                ...
                                <div class="col-md-6" id="mont_decaiss">
                                  <div class="form-group">
                                    <label for=""><?=lang('messages_lang.decaissement_decaissement')?> <font color="red">*</font></label>
                              ...
                              <div class="col-md-6">
                                <div class="form-group" hidden>
                                  <label class="form-label"><?=lang('messages_lang.label_droit_institutions')?>  <font color="red">*</font></label>
                            ...
                            <div class="col-md-4 mt-2" style="margin-bottom:50px;margin-left:-42px">
                              <div class="row">
                                ...
                                <div class="col-md-12">
                                  ...
                                  <label for=""><?=lang('messages_lang.labelle_tranche')?> </label>
                                ...
                                <div class="col-md-12" id="div_trnsf">
                                  ...
                                  <input type="number" class="form-control"  id="new_montant_vote_id" name="new_montant_vote" readonly>
                      ...
                      <div class="shadow" style="width:100%;">
                        <?php if(!empty($info_tableau)):?>
                          ...
                          <form id="MyFormDatatable" action="<?=base_url('demande_new/Proc_Demande_Budget_Corriger/enregister/')?>" method="post">
                            ...
                            <input type="hidden" name="ligne_budg" id="ligne_budg" value="<?=$restant_par_ligne; ?>">
                            <div class="table-responsive">
                              <table class="table table-striped" id="info" >
                                <thead>
                                  ...
                                  <th><?=lang('messages_lang.Lab_jur_instit')?></th>
                                  <th><?=lang('messages_lang.labelle_programme')?></th>
                                    ...
                                    <tr>
                                      ...
                                      <div>
                                        <?php if($info->MARCHE_PUBLIQUE){?>
                                          <td><?=lang('messages_lang.label_oui')?></td>
                                        <?php }else{ ?>
                                          <td><?=lang('messages_lang.label_non')?></td>
                                        <?php } ?>
                                      </div>

                                      <td><a  href="<?php echo base_url('demande_new/Proc_Demande_Budget_Corriger/modifier/'.$info->EXECUTION_ID_TEMPO.'/'.$id )?>" class="btn btn-primary" tooltip="Modifier"><i class="fa fa-edit "></i></a></td>

                                      <td><a  href="<?php echo base_url('demande_new/Proc_Demande_Budget_Corriger/deleteData/'.$info->EXECUTION_ID_TEMPO.'/'.$id )?>" class="btn btn-danger" style="color:red;"><i class="fa fa-close "></i></a></td>
                                    </tr>
                                ...
                                <div class="col-12 mt-4"style="margin-bottom:100px" id="btn_save1">
                                  <a onclick="save()" style="float: right;margin: 4px;background:#061e69;color:white" class="btn btn-primary"><i class="fa fa-sign-in" aria-hidden="true"></i><?=lang('messages_lang.enregistre_action')?> </a>

                                </div>
                              </form>
                              <div class="col-12 mt-4" style="margin-bottom:100px" id="btn_save_depas">
                                <a style="float: right;margin: 4px;background:#061e69;color:white" onclick="modal()" class="btn btn-primary"><i class="fa fa-sign-in" aria-hidden="true"></i> <?=lang('messages_lang.enregistre_action')?></a>
            ...
            <div class="modal fade" id="confirm" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
              <div class="modal-dialog">
                <div class="modal-content">
                  <div class="modal-body"><?=lang('messages_lang.montant_prevu')?>
                </div>
                <div class="modal-footer">
                  <button type="button" class="btn btn-secondary" onclick="fermer_modal()" data-bs-dismiss="modal"><?=lang('messages_lang.action_corriger_pip')?></button>
                  <button type="button" style="float: right;margin: 4px;background:#061e69;color:white" class="btn btn-primary" onclick="save()"><?=lang('messages_lang.continue')?></button>
                </div>
              </div>
            </div>
          </div>
        ...
        <script>
          function bon_engagement(id)
          {
            $.ajax(
            {
              url:"<?=base_url()?>/demande_new/Proc_Demande_Budget_Corriger/get_path_bon/"+id,
              type:"GET",
              dataType:"JSON",
        ...
        <script type="text/javascript">
          function get_preuve(id)
          {
            $.ajax(
            {
              url:"<?=base_url()?>/demande_new/Proc_Demande_Budget_Corriger/get_path_preuve/"+id,
              type:"GET",
              dataType:"JSON",
              success: function(data)
              {  
...
<script>
  function valid_transfert()
  {
    ...
    {
      statut = false;
      $('#error_mont_transfert').html("<?=lang('messages_lang.titre_decaissement')?>");
    }else
    {
...
<script>
  $(document).ready(function ()
  {
    ...
    var ligne_budg=$('#ligne_budg').val();

    if (parseInt(ligne_budg) < 0)
    {
      $('#btn_save1').hide();
      $('#btn_save_depas').show();
    }else
...
<script>
  ...
  {
    var statut = true;
    var check_satut=valid_transfert();
    ...
    if(new_montant_vote_id=='')
    {
      new_montant_vote_id=0;
    }
    ...
    if (IS_TRANSFERT_ACTIVITE==1)
    {
      ...
      {
        statut1 = false;
        $('#new_montant_error').html("<?=lang('messages_lang.limite_montant_transferer')?>")
    ...
    if(IS_TRANSFERT_ACTIVITE=='')
    {
      $('#error_is_transfert').html('<?=lang('messages_lang.error_sms')?>');
      statut = false;
    }else
    {
      $('#error_is_transfert').html('');
    }
    ...
    if (IS_TRANSFERT_ACTIVITE==1)
    {
      if(MONTANT_TRANSFERT=='')
      {
        $('#error_montant_transfert').html('<?=lang('messages_lang.error_sms')?>');
        statut = false;
      }else
      {
        $('#error_montant_transfert').html('');
      }
      if(TRANCHE_ID=='')
      {
        $('#error_tranche').html('<?=lang('messages_lang.error_sms')?>');
        statut = false;
      }else
      {
        $('#error_tranche').html('');
...
<script>
  ...
  function valide_montant()
  {
    ...
    if (IS_TRANSFERT_ACTIVITE==1)
    {
      ...
      {
        statut = false;
        $('#new_montant_error').html("<?=lang('messages_lang.montant_superieur')?>")
      }
      else
      {
        $('#new_montant_error').html("")
    ...
    else
    {
      ...
      {
        statut = false;
        $('#montant_error_mont_paie').html("<?=lang('messages_lang.depassement_mont_paiement')?>")
      }
    ...
    else
    {
      ...
      {
        statut = false;
        $('#montant_error_mont_decais').html("<?=lang('messages_lang.depassement_mont_decaissement')?>")
      }
