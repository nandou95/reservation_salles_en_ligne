            ...
            <div class="col-12">
             ...
             <div style="box-shadow: rgba(100, 100, 111, 0.25) 0px 7px 29px 0px;padding: 13px !important" class="card">
              <div class="car-body">
                ...
                <b style="font-size:20px" class="header-title text-black"><?=lang('messages_lang.exec_a_raccrocher') ?></b><br><br>
                
                  <!-- 
                  <?php 
                    foreach ($institutions_user as $value)
                    {?>
                      <b style="font-size:13px"><i class="fa fa-language"></i> <?= $value->CODE_INSTITUTION?> , &nbsp; <i class="fa fa-tag"></i> <?= $value->DESCRIPTION_INSTITUTION?></b><br>
                  <?php } ?>
                  <br> -->
                  <div class="col-md-12">
                    <div class="row">
...
<script>
  function liste()
  {
    ...
    $("#mytable").DataTable(
    {
      ...
      "ajax":
      {
        url:"<?= base_url('demande_new/Raccrochage_Deuxieme_Trim/listing')?>",
        type:"POST", 
        data:
        {
...
<script type="text/javascript">
  function show_modal(id) {
    $.ajax({
      url: "<?= base_url() ?>/demande_new/Raccrochage_Deuxieme_Trim/libelleCall/" + id,
      type: "POST",
      dataType: "JSON",
      success: function(data) {
