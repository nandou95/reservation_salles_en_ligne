              ...
              <div class="col-12">
                <div style="box-shadow: rgba(100, 100, 111, 0.25) 0px 7px 29px 0px" class="card">
                  <div style="float: right;">
                    <a href="<?php echo base_url('demande_new/Proc_Demande_Budget_Corriger/')?>" style="float: right;margin-right: 20px;margin-top:5px" class="btn btn-primary"><i class="fa fa-list" aria-hidden="true"></i> <?=lang('messages_lang.link_list') ?></a>
                  </div>
                  <div class="car-body">
                    <?php
                    ...
                    <div class=" container " style="width:90%">
                      <form enctype='multipart/form-data' id="MyFormData" action="<?=base_url('demande_new/Raccrochage_Deuxieme_Trim/modifier_activite/')?>" method="post" >
                        <div class="container">
                          <div class="row">
                            <?php
                              ...
                              <div class="row">
                                ...
                                <div class="col-md-6" id="num_bon_eng">
                                  <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="numero_bon" id="numero_bon_id" value="<?=$info_modif['NUMERO_BON_ENGAGEMENT'] ?>" minlength="5" maxlength="20">
                                ...
                                <div class="col-md-6" id="titre_decaiss">
                                  <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="numero_decaiss" id="numero_decaiss_id" value="<?=$info_modif['NUMERO_TITRE_DECAISSEMNT']?>" minlength="5" maxlength="20" >
                                ...
                                <div class="col-md-6">
                                  <div class="form-group">
                                    ...
                                    <input type="file" class="form-control" id="doc_raccroche"  onchange="Valid_preuve(1)"  name="doc_raccroche">
                                ...
                                <div class="col-md-6">
                                  <div class="form-group">
                                    ...
                                    <input type="file" class="form-control"  onchange="Valid_preuve(2)" id="PREUVE" name="PREUVE">
                          ...
                          <div class="col-md-12 mt-5 " >
                            <div class="form-group " >
                              <a onclick="savetemp()" id="btn_save"  class="btn" style="float:right;background:#061e69;color:white"><?=lang('messages_lang.bouton_modifier') ?></a>
                            </div>
                          </div>
                        </div>
                      </form><br><br>
...
<script>
  ...
  function valide_montant()
  {
    ...
    }else
    {
      ...
      {
        statut = false;
        $('#montant_error_mont').html("<?=lang('messages_lang.msg_mont_eng') ?>");
        $('#btn_save').hide();
