              ...
              <div class="table-responsive container ">
                <div class="table-responsive" style="width: 100%;">
                  <table id="mytable" class=" table table-striped table-bordered">
                    <thead>
                      <tr>
                        <th><center><?=lang('messages_lang.code_prog')?></center></th>
                        <th><center><?=lang('messages_lang.col_obj_eng')?></center></th>
                        <th><center><?=lang('messages_lang.activ_racc')?></center></th>
...
<script>
  function liste()
  {
    ...
    $("#mytable").DataTable(
    {
      ...
      "ajax":
      {
        url:"<?= base_url('demande_new/Execution_deja_raccroche/listing')?>",
        type:"POST", 
        data:
        {
...
<script>
  function get_detail_activite(id)
  {
   ...
   table2=$("#mytable2").DataTable(
   {
    ...
    "oreder":[[ 0, 'desc' ]],
    "ajax":{
      url:"<?= base_url('')?>/demande_new/Execution_deja_raccroche/liste_activites/"+id,
      type:"POST",
...
<script type="text/javascript">
  function show_modal(id)
  {
    $.ajax(
    {
      url:"<?=base_url()?>/demande_new/Execution_deja_raccroche/libelleCall/"+id,
      type:"POST",
      dataType:"JSON",
...
<script>
  function get_sous_tutelle()
  {
    ...
    else
    {
      $.ajax(
      {
        url:"<?=base_url()?>/demande_new/Execution_deja_raccroche/get_sous_tutelle/"+CODE_INSTITUTION,
        type:"GET",
        dataType:"JSON",
        success: function(data)
        {
