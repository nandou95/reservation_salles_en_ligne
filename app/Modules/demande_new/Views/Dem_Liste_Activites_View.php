              ...
              <div style="box-shadow: rgba(100, 100, 111, 0.25) 0px 7px 29px 0px" class="card">
               ...
               <div class="col-12 d-flex">
                ...
                <!-- <div class="col-3" style="float: right;">
                  <a href="<?=base_url('demande_new/Dem_Liste_Activites/create')?>" style="float: right;margin-right: 90px;margin: 10px" class="btn btn-primary"><span class="fa fa-plus pull-right"></span><?=lang('messages_lang.labelle_et_nouveau')?></a>   
                </div> -->
              </div>
              <br>
...
<script type="text/javascript">
  function liste() 
  {
    ...
    $("#mytable").DataTable({
      ...
      "serverSide": true,
      "ajax": {
        url: "<?= base_url('demande_new/Dem_Liste_Activites/listing')?>",
        type: "POST",
        data: {
...
<script type="text/javascript">
  ...
  function get_prog()
  {
    ...
    $.post('<?=base_url('demande_new/Dem_Liste_Activites/get_prog')?>',
    {
      INSTITUTION_ID:INSTITUTION_ID
    },
    function(data)
  ...
  function get_action()
  {
    ...
    $.post('<?=base_url('demande_new/Dem_Liste_Activites/get_action')?>',
    {
      CODE_PROGRAMME:CODE_PROGRAMME
    },
    function(data)
