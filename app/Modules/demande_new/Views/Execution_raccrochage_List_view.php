            ...
            <div class="col-12">
                ...
                <div class="card-header">
                  <div class="col-12 d-flex">
                    <div class="col-12 d-flex">
                      <?php
                      $racrochet = "btn";
                      $deja_racrochet = "btn active";
                      $pas_qte_phys = "btn";
                      $qte_phys = "btn";
                      ?>
                      <?php include  'includes/Menu_Ligne_Budget_includes_Deuxieme_trime.php'; ?>
                    </div>
                  </div>
                </div>
              ...
              <div style="box-shadow: rgba(100, 100, 111, 0.25) 0px 7px 29px 0px;padding: 13px !important" class="card">
                <div class="car-body">
                  ...
                  ?>
                  <b style="font-size:20px" class="header-title text-black"><?=lang('messages_lang.title_deja_racc')?></b><br><br>

                  <div class="col-md-12">
                    <div class="row">
                      <div class="col-md-4">
                        <label><?=lang('messages_lang.labelle_institution')?></label>
                    ...
                    <div class="table-responsive" style="width: 100%;">
                      <table id="mytable" class=" table table-striped table-bordered">
                        <thead>
                          <tr>
                            <th>
                              <center><?=lang('messages_lang.titre_code_budg')?></center>
                            </th>
                            <th>
                              <center><?=lang('messages_lang.col_obj_eng')?></center>
                            </th>
                            <th>
                              <center><?=lang('messages_lang.activ_racc')?></center>
                            </th>
                            <th>
                              <center><?=lang('messages_lang.titre_credit_vote')?></center>
                            </th>
                            <th>
                              <center><?=lang('messages_lang.titre_transfert_cred')?></center>
                            </th>
                            <th>
                              <center><?=lang('messages_lang.titre_cred_apres_trans')?> </center>
                            </th>
                            <th>
                              <center><?=lang('messages_lang.col_eng_budg')?></center>
                            </th>
                            <th>
                              <center><?=lang('messages_lang.col_eng_jur')?></center>
                            </th>
                            <th>
                              <center><?=lang('messages_lang.col_liquid')?></center>
                            </th>
                            <th>
                              <center><?=lang('messages_lang.titre_ordon')?></center>
                            </th>
                            <th>
                              <center><?=lang('messages_lang.titre_paiement')?></center>
                            </th>
                            <th>
                              <center><?=lang('messages_lang.th_decaissement')?></center>
                            </th>
                          </tr>
                        </thead>
                        <tbody>
...
<script>
  function liste() {
    ...
    $("#mytable").DataTable({
      ...
      "ajax": {
        url: "<?= base_url('demande_new/execution_raccroche/listing') ?>",
        type: "POST",
        data: {
...
<script>
  function get_detail_activite(id) {
    ...
    table2 = $("#mytable2").DataTable({
      ...
      "ajax": {
        url: "<?= base_url('') ?>/demande_new/execution_raccroche/liste_activites/" + id,
        type: "POST",
...
<script type="text/javascript">
  function show_modal(id) {
    $.ajax({
      url: "<?= base_url() ?>/demande_new/execution_raccroche/libelleCall/" + id,
      type: "POST",
      dataType: "JSON",
  ...
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
      <div class="modal-header">
        <b style="font-size:20px" class="modal-title header-title text-black" id="exampleModalLabel"><?= lang('messages_lang.titr_list_dej_racc')?></b>
      </div>
      <div class="modal-body">
          ...
          <table id='mytable2' class="table table-bordered table-striped table-hover table-condensed " style="width: 100%;">
            <thead>
              <tr>
                ...
                <th><?= lang('messages_lang.th_imputation')?></th>
...
<script>
  function get_sous_tutelle() {
    ...
    if (CODE_INSTITUTION == '') {
      ...
      $.ajax({
        url: "<?= base_url() ?>/demande_new/execution_raccroche/get_sous_tutelle/" + CODE_INSTITUTION,
        type: "GET",
        dataType: "JSON",
        success: function(data) {
