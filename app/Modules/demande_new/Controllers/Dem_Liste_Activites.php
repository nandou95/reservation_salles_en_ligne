...
class Dem_Liste_Activites extends BaseController
{
  ...
  public function index($value='')
  {
    ...
    if(!empty($user_id))
    {
      ...
      if($profil == 1)
      {
        ...
        $data['profil'] = $profil;
        return view('App\Modules\demande_new\Views\Dem_Liste_Activites_View',$data);
      }
      else
      {
        //Sélectionner les institutions
  ...
  public function listing()
  {
    ...
    foreach ($fetch_actions as $row)
    {
      ...
      $action .="<li>
        <a href='".base_url('demande_new/Dem_Detail_Activite/'.$row->PTBA_ID)."'>
          <label>&nbsp;&nbsp;Détails</label>
        </a>
      </li>
      </ul>
  ...
  public function create()
  {
    ...
    return view('App\Modules\demande_new\Views\Dem_Activites_Add_View',$data);
  }
  ...
  public function insert()
  {
    ...
    if($this->validation->withRequest($this->request)->run())
    {
      ...
      return redirect('demande_new/Dem_Liste_Activites');
    }
    else
    {
      $data=$this->urichk();
  ...
  public function create_get_code()
  {
    ...
    //Le code budgetaire
    $getcodeBudget = "SELECT CODE_NOMENCLATURE_BUDGETAIRE FROM inst_institutions_ligne_budgetaire WHERE CODE_NOMENCLATURE_BUDGETAIRE LIKE '".$CODEBUDGET."%'";   
