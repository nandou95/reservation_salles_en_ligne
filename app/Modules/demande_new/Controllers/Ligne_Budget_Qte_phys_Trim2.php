...
/**
* 
* develope par Eric SINDAYIGAYA
*sinda.eric@mediabox.bi
*WhatsApp 62 04 03 00
*Téléphone 62 04 03 00
*liste ligne budgetaire du deuxieme trimestre qui ont des quantites physique 
*Le 11/01/2024
* 
**/
...
class Ligne_Budget_Qte_phys_Trim2 extends BaseController
{
  protected $session;
  protected $ModelPs;
  ...
  public function index()
  {
    ...
    return view('App\Modules\demande_new\Views\Ligne_Budget_Qte_phys_Trim2_View',$data);
  }
