                  ...
                  <div class="card-body" style="">
                    ...
                    <div class="col-md-12">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-4">
                          <a href="<?=base_url('ptba/Liste_Ptba') ?>" style="float: right;margin: 4px;" class="btn btn-primary"><span class="fa fa-list pull-right"></span> <?=lang('messages_lang.liste_bouton')?></a>
                        </div>
                      </div>
                    </div>
                  </div>
