                  ...
                  <div class="card-body" style="">
                    <div class="col-md-12">
                        <div class="row">
                          ...
                          <div class="col-md-4">
                            <a href="<?=base_url('ptba/Ptba_Action') ?>" style="float: right;margin: 4px;" class="btn btn-primary"><span class="fa fa-list pull-right"></span> <?= lang('messages_lang.link_list') ?> </a>
                          </div>
                        </div>
                    </div>
                  </div>
                  ...
                  <div class="card-body">
                    ...
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                      <li class="nav-item" role="presentation">
                        <a onclick="show_nav(1)" class="nav-link active" id="tab_activite-tab" data-bs-toggle="tab" data-bs-target="#tab_activite"  role="tab" aria-controls="tab_activite" aria-selected="false"> <i class="fa fa-history" aria-hidden="true"></i>&nbsp;&nbsp;<?=$total_activ?>&nbsp;&nbsp;<?= lang('messages_lang.labelle_activites')?>&nbsp;&nbsp;</a>
                      </li>
                    </ul>
   ...
   <script>
     function liste_activite() {
       ...
       $("#table_activite").DataTable({
        ...
        "serverSide": true,
        "ajax": {
          url:"<?= base_url()?>/ptba/Detail_Action/liste_activite/"+id,
          type: "POST",
          data: {},
          beforeSend: function() {}
        },
