...
<body>
              ...
              <div style="box-shadow: rgba(100, 100, 111, 0.25) 0px 7px 29px 0px;padding: 13px !important" class="card">
                ...
                <div class="card-header">
                  <div class="row col-md-12">
                    <div class="col-md-8">
                      <h1 class="header-title text-black"><?=lang('messages_lang.title_list_ptba')?>                      
                      </h1>
                    </div>
                  </div>
                </div>
  ...
  <script>
    ...
    function liste()
    {
      ...
      $("#mytable").DataTable({
        ...
        "order":[],
        "ajax":{
          url:"<?= base_url('ptba/Liste_Ptba/listing')?>",
          type:"POST", 
          data:
          {
  ...
  function get_prog() {
    ...
    $.post('<?=base_url('ptba/Liste_Ptba/get_prog')?>', {
        INSTITUTION_ID: INSTITUTION_ID
    }, function(data) {
        $('#CODE_PROGRAMME').html(data.html);
        CODE_PROGRAMME.InnerHtml=data.html;
        liste(); // Appeler la fonction liste() sans paramètre
    });
}
  ...
  function get_action()
  {
    ...
    $.post('<?=base_url('ptba/Liste_Ptba/get_action')?>',
    {
      CODE_PROGRAMME:CODE_PROGRAMME
    },
    function(data)
