              ...
              <div style="box-shadow: rgba(100, 100, 111, 0.25) 0px 7px 29px 0px" class="card">
                <div class="card-header">
                  <div class="row col-md-12">
                    ...
                    <div class="col-md-3" style="float: right;">
                      <a href="<?php echo base_url('double_commande_new/Reception_TD_Non_Valide') ?>" style="float: right;margin-right: 20px" class="btn btn-primary"><i class="fa fa-list" aria-hidden="true"></i> <?= lang('messages_lang.list_transmission_du_bordereau') ?> </a>
                    </div>
               ...
               <br>
                ...
                <div class="card-body">
                  ...
                  <form id="my_form" action="<?= base_url('double_commande_new/Reception_Brb_MinFin/save_rec') ?>" method="POST" enctype="multipart/form-data">
