              ...
              <div style="box-shadow: rgba(100, 100, 111, 0.25) 0px 7px 29px 0px" class="card">
                <div class="card-header">
                  <div class="row col-md-12">
                    <div class="col-md-6">
                      <h1 class="header-title text-black">Correction par CED</h1>
                    </div>
                ...
                <div class="car-body">
                  <form id='MyFormData' action="<?=base_url('double_commande_new/Ordonnancement_Vers_Ced/save_corrige_ced') ?>" method="POST">
                    <!-- inputs hidden -->
                      ...
                      <div class="row">
                        <div class="col-md-4">
                          <div class="form-group">
                            ...
                            <input type="date" name="DATE_RECEPTION" id="DATE_RECEPTION" min="<?=date('Y-m-d', strtotime($histo['DATE_TRANSMISSION']))?>" class="form-control" max="<?=date('Y-m-d')?>" onchange="get_date_min_trans()">
                        ...
                        <div class="col-md-4">
                          <div class="form-group">
                            ...
                            <input type="date" name="DATE_TRANSMISSION" id="DATE_TRANSMISSION" class="form-control" max="<?=date('Y-m-d')?>">
                        ...
                        <div class="col-md-4">
                          <div class="form-group">
                            <label><?= lang('messages_lang.labelle_observartion') ?> <span style="color: red;">*</span></label>
                            <textarea name="OBSERVATION" id="OBSERVATION" class="form-control">
                            </textarea>
                            <span id="error_OBSERVATION" class="text-danger"></span>
                            <?php if (isset($validation)) : ?>
                              <?= $validation->getError('OBSERVATION'); ?>
                            <?php endif ?>
                          </div>
                        </div>                       
                      </div>
...
<script type="text/javascript">
  function save()
  {
    ...
    if (OBSERVATION=='') {
      $('#error_OBSERVATION').html('<?= lang('messages_lang.validation_message')?>');
      statut=1;
    }
          ...
          <div class="table-responsive  mt-3">
            <table class="table m-b-0 m-t-20">
              <tbody>
                ...
                <tr>
                  <td><i class="fa fa-list"></i> &nbsp;<strong><?= lang('messages_lang.labelle_observartion')?></strong></td>
