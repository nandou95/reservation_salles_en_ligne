                ...
                <div class="card-body">
                  ...
                  <div class="card-body" style="margin-top: -20px">
                    <div style="float: right;">
                      <a href="<?php echo base_url('double_commande_new/Reception_BRB/liste_vue') ?>" style="float: right;margin-right: 20px;margin-top:5px" class="btn btn-primary"><i class="fa fa-list" aria-hidden="true"></i><?= lang('messages_lang.link_list') ?></a>
                    </div>
                    <div>
                      ...
                      <form action="<?= base_url("double_commande_new/Reception_borderau_brb/insertion_histo") ?>" method="post" id="push_bon">
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-6">
                            ...
                            <input type="date" class="form-control" name="DATE_RECEPTION" id="DATE_RECEPTION" min="<?= $date_transmission['DATE_TRANSMISSION'] ?>" max="<?= date("Y-m-d") ?>" value="<?=date('Y-m-d')?>">
