              ...
              <div class="col-12">
                <div style="box-shadow: rgba(100, 100, 111, 0.25) 0px 7px 29px 0px" class="card">               
                  <div class="card-body">
                    ...
                    <!-- fin -->
                    <form enctype='multipart/form-data' id="my_form" action="<?= base_url('double_commande_new/Liquidation/add') ?>" method="POST">
                      <div style="border:1px solid #ddd;border-radius:5px;margin: 5px">
                        <div class="row" style="margin :  5px">
                          ...
                          <div class="col-6">
                            ...
                            <input type="date" class="form-control" id="DATE_RECEPTION" name="DATE_RECEPTION" min="<?=date('Y-m-d', strtotime($date_trans['DATE_TRANSMISSION']))?>" max="<?=date('Y-m-d')?>" onkeypress="return false" onblur="this.type='date'" onchange="get_min_transRecept(this.value)" value="<?= date('Y-m-d') ?>">
                            <?php if (isset($validation)) : ?>
                          ...
                          <div id="DIV_TITRE_CREANCE" class="col-6">
                            ...
                            <input onkeyup="SetMaxLength(1)" autocomplete="off" type="text" name="TITRE_CREANCE" id="TITRE_CREANCE" class="form-control" value="<?=set_value("TITRE_CREANCE")?>">                          
                            <?php if (isset($validation)) : ?>
                          ...
                          <div id="DIV_DATE_CREANCE" class="col-6">
                            ...
                            <input type="date" max="<?=date('Y-m-d')?>" name="DATE_CREANCE" id="DATE_CREANCE" class="form-control" value="<?= date('Y-m-d') ?>">
                            <?php if (isset($validation)) : ?>
                          ...
                          <div id="div_creance" class="col-6 mt-2">
                            ...
                            <div hidden id="div_taches" class="p-2" style="border: #ccc solid 1px;">
                              ...
                              <?php
                                ...
                                foreach ($infoTaches as $infoTache) 
                                {
                                  ...
                                  echo '<input onkeyup="calculate(this)" placeholder="Entrez le montant de la tache" type="text" name="MONTANT_'.$infoTache->EBET_ID.'" id="MONTANT_'.$infoTache->EBET_ID.'" class="form-control">';
                            ...
                            <input readonly onkeyup="getSubstring(1);SetMaxLength(3);getCalculMontant()" autocomplete="off" type="text" name="MONTANT_CREANCE" id="MONTANT_CREANCE" class="form-control" value="<?=set_value("MONTANT_CREANCE")?>">
                            <?php if (isset($validation)) : ?>
                          ...
                          <div id="DIV_DATE_LIQUIDATION" class="col-6">
                            ...
                            <input type="date" onkeypress="return false" onblur="this.type='date'" onchange="get_min_trans(this.value)" max="<?=date('Y-m-d')?>" name="DATE_LIQUIDATION" id="DATE_LIQUIDATION" class="form-control" value="<?= date('Y-m-d') ?>">
                            <?php if (isset($validation)) : ?>
                          ...
                          <div id="div_devise1" class="col-6 mt-2">
                            <div hidden id="div_taches_devise" class="p-2" style="border: #ccc solid 1px;">
                              <label><?=lang('messages_lang.label_montant_tache')?> en <?=$info['DESC_DEVISE_TYPE']?></label>
                              <?php
                                $i=1;
                                foreach ($infoTaches as $infoTache) 
                                {
                                  echo '<label>'.$i++.'. '.$infoTache->DESC_TACHE.'</label>';
                                  echo '<input onkeyup="calculate_devise(this)" placeholder="Entrez le montant de la tache" type="text" name="MONTANT_DEVISE_'.$infoTache->EBET_ID.'" id="MONTANT_DEVISE_'.$infoTache->EBET_ID.'" class="form-control">';
                            ...
                            <input readonly onkeyup="getSubstring(3);SetMaxLength(4);getCalculMontant();formatInputValue(this);" autocomplete="off" type="text" name="MONTANT_DEVISE" id="MONTANT_DEVISE" class="form-control" value="<?= date('Y-m-d') ?>">
                            <?php if (isset($validation)) : ?>
                          ...
                          <div id="div_devise2" class="col-6">
                            ...
                            <input type="text" onkeyup="getCalculMontant()" oninput="formatInputValue(this);" name="COUT_DEVISE" id="COUT_DEVISE" class="form-control" value="<?=(isset($validation))?set_value("COUT_DEVISE"):$cour_devise?>">
                            <?php if (isset($validation)) : ?>
                          ...
                          <div class="col-md-6" id="date_dev"  hidden="true">
                            ...
                            <input type="date" max="<?= date('Y-m-d')?>"  class="form-control" onkeypress="return false" name="DATE_COUT_DEVISE" id="DATE_COUT_DEVISE" value="<?= date('Y-m-d') ?>">
                            <?php if (isset($validation)) : ?>
                          ...
                          <div id="div_devise3" class="col-6">
                            <label><?=lang('messages_lang.label_montant_titre_creance')?><span style="color: red;">*</span></label>
                            <input autocomplete="off" type="text" name="LIQUIDATION" id="LIQUIDATION" class="form-control" value="<?=set_value("LIQUIDATION")?>">
                            <?php if (isset($validation)) : ?>
                          ...
                          <div class="col-6">
                            ...
                            <select class="form-control" name="TAUX_TVA_ID" id="TAUX_TVA_ID">
                              ...
                              foreach ($get_taux_tva as $key)
                              {
                                ...
                                {
                                  echo '<option value="'.$key->TAUX_TVA_ID.'" selected>'.$key->DESCRIPTION_TAUX_TVA.'</option>';
                                }
                                else
                                {
                          ...
                          <div class="col-6">
                            ...
                            <select class="form-control" name="EXONERATION" id="EXONERATION">
                              ...
                              <?php
                                ...
                                {
                                  echo '<option value="1" selected>'.lang('messages_lang.label_oui').'</option>
                          ...
                          <div class="col-6">
                            <label><?=lang('messages_lang.label_date_trans_conf')?><span style="color: red;">*</span></label>
                            <input onkeypress="return false" onblur="this.type='date'" type="date" max="<?=date('Y-m-d')?>" name="DATE_TRANSMISSION" id="DATE_TRANSMISSION" value="<?= date('Y-m-d') ?>" class="form-control">
                            <?php if (isset($validation)) : ?>    
                          ...
                          <div class="col-6">
                            ...
                            <select class="form-control select2" multiple name="TYPE_ANALYSE_ID[]" id="TYPE_ANALYSE_ID">
                              ...
                              {
                                if($key->TYPE_ANALYSE_ID==set_value("TYPE_ANALYSE_ID[]"))
                                {
                                  echo '<option value="'.$key->TYPE_ANALYSE_ID.'" selected>'.$key->DESC_TYPE_ANALYSE.'</option>';
                                }
                                else
                                {
                                  echo '<option value="'.$key->TYPE_ANALYSE_ID.'">'.$key->DESC_TYPE_ANALYSE.'</option>';
                                }
                              }
                              ?>
                            </select>
                          ...
                          if ($info['MARCHE_PUBLIQUE']==1)
                          {
                            ...
                            if($TYPE_MONTANT_ID!=1)
                              ...
                              <?php if (isset($validation)) : ?>
                                <font color="red" id="error_DATE_LIVRAISON_CONTRAT"><?=$validation->getError('TITRE_CREANCE');?></font><br>
                              <?php endif ?> 
                          ...
                          {?>
                            ...
                            <div class="col-md-12" id="intro_note_div">
                              ...
                              <textarea class="form-control" name="intro_note" id="intro_note"><?=set_value("intro_note")?></textarea>
                              <?php if (isset($validation)) : ?>
                                <font color="red" id="error_intro_note"><?=$validation->getError('intro_note');?></font>
                              <?php endif ?> 
                            </div>
                            <?php
                          }
                      ...
                      <div class="col-12">
                        <button id="disabled_btn" style="float: right;" id="btnSave" type="button" onclick="send_data()" class="btn btn-primary float-end envoi"><i class="fa fa-sign-in" aria-hidden="true"></i>&nbsp;<?=lang('messages_lang.bouton_enregistrer')?> <span id="loading_btn"></span></button>
                      </div>
                    </form>
                  </div>                               
                </div>
  ...
  <div class='modal-dialog  modal-lg' style="max-width: 60%">
    <div class='modal-content'>
      ...
      <div class='modal-footer'>
        <button id="edi" onclick="deleteFile();" class='btn btn-primary btn-md' data-dismiss='modal'><i class="fa fa-pencil"></i> <?=lang('messages_lang.labelle_mod')?> <span id="loading_delete"></span></button>
        <button id="conf" onclick="send_data2();hideButton()" type="button" class="btn btn-info"><i class="fa fa-check"></i> <?=lang('messages_lang.labelle_conf')?></button>
      </div>
    </div>
  </div>
</div>
  ...
  function getTypeLiquidationMontant()
  {
    ...
    if(TYPE_MONTANT_ID==1)
    {
      ...
      if(ID_TYPE_LIQUIDATION==2)
      {
        ...
        document.getElementById('div_taches').hidden = true;
        <?php
        foreach ($infoTaches as $infoTache) 
        {
          $id = $infoTache->EBET_ID;
          echo '$("#MONTANT_'.$infoTache->EBET_ID.'").val("");';
          // echo ('console.log("test"+'.$id.')');
        }
        ?>
        // console.log($('#infoTaches').val());
      }
      else
      {
        $('#MONTANT_CREANCE').val('');
        document.getElementById('div_taches').hidden = false;
    ...
    else
    {
      ...
      var INT_MONTANT_DEVISE_ENGAGEMENT_JURIDIQUE = MONTANT_DEVISE_ENGAGEMENT_JURIDIQUE.replace(/[^0-9.]/g, "");
      ...
      if (ID_TYPE_LIQUIDATION==2)
      {
        ...
        document.getElementById('div_taches').hidden = true;
        document.getElementById('div_taches_devise').hidden = true;
        <?php
        foreach ($infoTaches as $infoTache) 
        {
          $id = $infoTache->EBET_ID;
          echo '$("#MONTANT_DEVISE_'.$infoTache->EBET_ID.'").val("");';
          // echo ('console.log("test"+'.$id.')');
        }
        ?>
      }
      else
      {
        ...
        $('#LIQUIDATION').val('');
        document.getElementById('div_taches').hidden = true;
        document.getElementById('div_taches_devise').hidden = false;
  ...
  function getCalculMontant(argument)
  {
    ...
    { 
      ...
      if(MARCHE_PUBLIQUE==1)
      {
        ...
        if(parseFloat(MONTANT_DEVISE)>parseFloat(MONTANT_DEVISE_ENGAGEMENT_JURIDIQUE))
        {
    ...
    else
    {
      ...
      if(MARCHE_PUBLIQUE==1)
      {
        var MONTANT_ENLEVE=$('#MONTANT_ENLEVE').val()
...
<script type="text/javascript">
  function get_min_transRecept()
  {
    ...
    $("#DATE_LIQUIDATION").prop('min',$("#DATE_RECEPTION").val());
  }
</script>
...
<script type="text/javascript">
  function send_data()
  {
    ...
    form.append("intro_note",intro_note);
...
<script>
  function calculate(ref)
  {
    ...
    taches.map((tache)=> {
      ...
      if(liquidTache > parseFloat(tache.TACHE_JURIDIQUE))
      {
        //set le montant au total possible et afficher l'erreur
        $('#MONTANT_'+tache.EBET_ID).val(parseFloat(tache.TACHE_JURIDIQUE));
        liquidTache = parseFloat($('#MONTANT_'+tache.EBET_ID).val())

        $('#error_MONTANT_'+tache.EBET_ID).text('<?=lang('messages_lang.mount_sup_tache')?>: '+tache.TACHE_JURIDIQUE);
      }
      else{
  ...
  function calculate_devise(ref)
  {
    ...
    taches.map((tache)=> {
      ...
      if(liquidTache > parseFloat(tache.TACHE_JURIDIQUE_DEVISE))
      {
        //set le montant au total possible et afficher l'erreur
        $('#MONTANT_DEVISE_'+tache.EBET_ID).val(parseFloat(tache.TACHE_JURIDIQUE_DEVISE));
        liquidTache = parseFloat($('#MONTANT_DEVISE_'+tache.EBET_ID).val())

        $('#error_MONTANT_DEVISE_'+tache.EBET_ID).text('<?=lang('messages_lang.mount_sup_tache')?>: '+tache.TACHE_JURIDIQUE_DEVISE);
      }
      else{
