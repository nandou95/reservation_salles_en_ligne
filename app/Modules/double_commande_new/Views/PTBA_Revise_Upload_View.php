        ...
        <div class="col-12">
          <div style="box-shadow: rgba(100, 100, 111, 0.25) 0px 7px 29px 0px" class="card">
            ...
            <div class="card-body">
              ...
              <form id="my_form" action="<?= base_url('double_commande_new/PTBA_Revise_Upload/save_upload') ?>" method="POST" enctype="multipart/form-data">
                <div class="card-body">
                  <div style="border:1px solid #ddd;border-radius:5px;margin: 5px">
                    <div class="row" style="margin :  5px">
                      <div class="col-6">
                        <div class="form-group">
                          <label>Fichier Excel PTBA Révisé<span style="color: red;">*</span></label>
