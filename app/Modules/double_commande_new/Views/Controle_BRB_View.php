               ...
               <div class="col-12 d-flex">
                ...
                <div class="col-9" style="float: left;">
                  <h1 class="header-title text-dark">
                    <?= lang('messages_lang.controle_brb_titre') ?><br>
                  </h1>
                </div>
...
<script type="text/javascript">
  ...
  function exporter_excel() {
    ...
    document.getElementById("btnexportexcel").href = "<?=base_url('double_commande_new/Controles_Decaissement/exporter_excel_controle_brb')?>/"+INSTITUTION_ID+"/"+SOUS_TUTEL_ID+"/"+DATE_DEBUT+"/"+DATE_FIN;
  }
</script >
...
<script type="text/javascript">
  function liste() 
  {
    ...
    $("#mytable").DataTable({
      ...
      "serverSide": true,
      "ajax": {
        url: "<?= base_url('double_commande_new/Controles_Decaissement/controle_brb_listing')?>",
        type: "POST",
        data: {
