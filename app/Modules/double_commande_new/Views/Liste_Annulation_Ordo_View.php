...
<script type="text/javascript">
  function liste() {
    ...
    $("#mytable").DataTable({
      ...
      "serverSide": true,
      "ajax": {
        url: "<?= base_url('double_commande_new/Liste_Annulation/listing_annulation_ordo') ?>",
        type: "POST",
        data: {
          ...
          <table id='mytable3' class="table table-bordered table-striped table-hover table-condensed " style="width: 100%;">
            <thead>
              <tr class="text-uppercase" >
                ...
                <th class="text-uppercase"><?=lang('messages_lang.col_obj_eng')?></th>
