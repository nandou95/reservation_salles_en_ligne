                ...
                <div style="box-shadow: rgba(100, 100, 111, 0.25) 0px 7px 29px 0px" class="card">
                  <div class="card-header">
                    <div class="row col-md-12">
                      <div class="col-md-9">
                        <h3><?= lang('messages_lang.controle_besd') ?></h3>
                      </div>
                      <div class="col-md-3">
                  ...
                  <div class=" container " style="width:100%">
                    ...
                    <form enctype='multipart/form-data' id="MyFormData" action="<?=base_url('double_commande_new/Controles_Decaissement/save_besd/')?>" method="post" >
                      <div class="container">
