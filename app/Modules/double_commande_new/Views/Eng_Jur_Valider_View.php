              ...
              <div style="box-shadow: rgba(100, 100, 111, 0.25) 0px 7px 29px 0px" class="card">
                <div class="card-header">
                  <div class="col-12 d-flex">
                    ...
                    $get_jurid_Avalider1="btn active";
                ...
                <div class="card-body">
                  <div style="margin-left: 15px;" class="row">
                    <h1 class="header-title text-dark"><?=lang('messages_lang.titre_jur_valider')?></h1>
                  </div>
...
<script type="text/javascript">
  function liste() 
  {
    ...
    $("#mytable").DataTable(
    {
      ...
      "ajax":
      {
        url: "<?= base_url('double_commande_new/Menu_Engagement_Juridique/listing_jur_valider')?>",
        type: "POST",
        data:
        {
