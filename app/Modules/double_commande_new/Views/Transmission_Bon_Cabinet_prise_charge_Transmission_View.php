            ...
            <div class="col-12">
              <div style="box-shadow: rgba(100, 100, 111, 0.25) 0px 7px 29px 0px" class="card">
                <div class="card-header">
                  <div class="row col-md-12">
                    ...
                    <div class="col-md-3" style="float: right;">
                      <a href="<?php echo base_url('double_commande_new/Transmission_Bon_Cabinet_prise_charge') ?>" style="float: right;margin-right: 20px" class="btn btn-primary"><i class="fa fa-list" aria-hidden="true"></i> <?= lang('messages_lang.list_transmission_du_bordereau') ?> </a>
                    </div>
                  </div>
                </div>
                <hr>
                ...
                <div class="card-body">
                  ...
                  <form id="my_form" action="<?= base_url('double_commande_new/Transmission_Bon_Cabinet_prise_charge/save') ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row col-md-12">
                          ...
                          <div class="col-md-6">
                            ...
                            <div class="">
                              ...
                              <input type="date" class="form-control" id="DATE_RECEPTION" value="<?= date('Y-m-d') ?>" name="DATE_RECEPTION" min="<?= date('Y-m-d') ?>" max="<?= date('Y-m-d') ?>" onkeypress="return false" onchange="get_date_min_trans()">
