...
<script type="text/javascript">
  ...
  function exporter_excel() {
    ...
    document.getElementById("btnexportexcel").href = "<?=base_url('double_commande_new/Liste_Paiement/exporter_Excel_sign_td_dgfp')?>/"+INSTITUTION_ID+"/"+SOUS_TUTEL_ID+"/"+DATE_DEBUT+"/"+DATE_FIN;
  }
</script>
...
<script type="text/javascript">
  function liste() {
    ...
    $("#mytable").DataTable({
      ...
      "serverSide": true,
      "ajax": {
        url: "<?= base_url('double_commande_new/Liste_Paiement/listing_sign_dgfp') ?>",
        type: "POST",
        data: {
