...
<script type="text/javascript">
  function exporter_excel() {
    ...
    document.getElementById("btnexportexcel").href = "<?=base_url('double_commande_new/Menu_Engagement_Budgetaire/exporter_Excel_deja_fait')?>/"+INSTITUTION_ID+"/"+SOUS_TUTEL_ID+"/"+DATE_DEBUT+"/"+DATE_FIN+"/"+ANNEE_BUDGETAIRE_ID;
  }
