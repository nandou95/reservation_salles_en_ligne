            ...
            <div class="col-12">
              ...
              <div style="box-shadow: rgba(100, 100, 111, 0.25) 0px 7px 29px 0px" class="card">
                ...
                <div>
                  ...
                  <h1 class="header-title text-dark"><?=lang("messages_lang.label_trans_obr")?></h1>
                </div>

                <div style="margin-right: 20px; float: right;">
                    <a href="<?= base_url("double_commande_new/Avant_OBR/add") ?>" class='btn btn-primary' style="float: right;"> <?= lang("messages_lang.Transmission_TD") ?></h1> </a>
                  </div>
...
<script type="text/javascript">
  ...
  function liste() {
    ...
    $("#mytable").DataTable({
      ...
      "serverSide": true,
      "ajax": {
        url: "<?= base_url('double_commande_new/Liste_Avant_OBR/listing') ?>",
        type: "POST",
