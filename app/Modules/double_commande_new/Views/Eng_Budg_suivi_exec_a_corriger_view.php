            ...
            <div class="card-body">
              <div class="col-12" style="float: left;">
                ...
                <h1 class="header-title text-dark">
                  Liste des engagements budgétaires en attente de correction<br><br>
                </h1>
              </div>
              <div class="row">
                <div class="col-md-3">
...
<script type="text/javascript">
  function liste() 
  {
    ...
    $("#mytable").DataTable({
      ...
      "serverSide": true,
      "ajax": {
        url: "<?= base_url('double_commande_new/Suivi_Execution/listing_engag_budj_corriger')?>",
        type: "POST",
        data: {
...
<script type="text/javascript">
  ...
  if (DATE_FIN == '' || DATE_FIN == null) {DATE_FIN = 0}
     document.getElementById("btnexportexcel").href = "<?=base_url('double_commande_new/Suivi_Execution/exporter_Excel_Eng_Budg_Corr')?>/"+INSTITUTION_ID+"/"+SOUS_TUTEL_ID+"/"+DATE_DEBUT+"/"+DATE_FIN;
  }
