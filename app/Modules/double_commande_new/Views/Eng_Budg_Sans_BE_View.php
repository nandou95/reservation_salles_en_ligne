          ...
          <div class="row">
            <div class="col-12">
              <div style="box-shadow: rgba(100, 100, 111, 0.25) 0px 7px 29px 0px" class="card">
                ...
                <div class="card-body">
                  <div class="row">
                    <h1 class="header-title text-dark"><?=lang('messages_lang.list_sans_bon')?></h1>
                  </div>
                  <div class="row">
                    <div class="col-md-3">
...
<script type="text/javascript">
  function liste() 
  {
    ...
    $("#mytable").DataTable({
      ...
      "serverSide": true,
      "ajax": {
        url: "<?= base_url('double_commande_new/Menu_Engagement_Budgetaire/listing_sans_be')?>",
        type: "POST",
        data: {
...
<script type="text/javascript">
  ...
  function rejeter(EXECUTION_BUDGETAIRE_ID,EXECUTION_BUDGETAIRE_TITRE_DECAISSEMENT_ID)
  {
    $('#rejet').modal('show');
    $('#EXECUTION_BUDGETAIRE_ID').val(EXECUTION_BUDGETAIRE_ID)
    $('#EXECUTION_BUDGETAIRE_TITRE_DECAISSEMENT_ID').val(EXECUTION_BUDGETAIRE_TITRE_DECAISSEMENT_ID)
  }
  ...
  function annuler_sans_bon()
  {
    ...
    window.location.href="<?= base_url('double_commande_new/Menu_Engagement_Budgetaire/annuler_sans_bon')?>"+"/"+EXECUTION_BUDGETAIRE_ID+"/"+EXECUTION_BUDGETAIRE_TITRE_DECAISSEMENT_ID;
  }
</script>

<div class="modal fade" id="rejet" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="static">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body overflow-auto" style="max-height: 400px">
        <input type="hidden" name="EXECUTION_BUDGETAIRE_ID" id="EXECUTION_BUDGETAIRE_ID">
        <input type="hidden" name="EXECUTION_BUDGETAIRE_TITRE_DECAISSEMENT_ID" id="EXECUTION_BUDGETAIRE_TITRE_DECAISSEMENT_ID">
        <center style="color: red;">Voulez-vous vraiment rejeter cet engagement?</center>
      </div>
      <div class="modal-footer">
        <button type="button" id="mode1" class="btn btn-primary" data-dismiss="modal"> <i class="fa fa-edit" aria-hidden="true"></i> <?= lang('messages_lang.annuler_modal') ?></button>
        <a onclick="annuler_sans_bon();hideButton()" id="corr" style="float: right;" class="btn btn-info"><i class="fa fa-check"></i> <?= lang('messages_lang.label_confir') ?></a>
      </div>
    </div>
  </div>
</div>
