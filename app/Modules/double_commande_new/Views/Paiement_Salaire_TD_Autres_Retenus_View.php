              ...
              <div style="box-shadow: rgba(100, 100, 111, 0.25) 0px 7px 29px 0px" class="card">
                <div class="card-header">
                  <div class="col-12 d-flex">
                    ...
                    $class_td_Autres_Retenus = "btn active";             
                    ?>
...
<script type="text/javascript">
  ...
  function exporter_excel() {
    ...
    document.getElementById("btnexportexcel").href = "<?=base_url('double_commande_new/Paiement_Salaire_Liste/exporter_Excel_td_autre_retenu')?>/"+'/'+TYPE_SALAIRE_ID+'/'+CATEGORIE_SALAIRE_ID+'/'+MOIS_ID+'/'+DATE_DEBUT+'/'+DATE_FIN;
  }
</script>
<script type="text/javascript">
  function liste() {
    ...
    $("#mytable").DataTable({
      ...
      "serverSide": true,
      "ajax": {
        url: "<?= base_url('double_commande_new/Paiement_Salaire_Liste/listing_td_Autre_Retenu') ?>",
        type: "POST",
        data: {
          TYPE_SALAIRE_ID,
