            ...
            <div class="col-12">
              <div style="box-shadow: rgba(100, 100, 111, 0.25) 0px 7px 29px 0px" class="card">
                <div class="card-header">
                  <div class="col-12 d-flex">
                    ...
                    $get_liquid_deja_fait1="btn active"; 
              ...
              <div style="box-shadow:rgba(100, 100, 111, 0.25) 0px 7px 29px 0px;padding: 13px !important" class="card">
                <div class="car-body">
                  ...
                  <b style="font-size:20px" class="header-title text-black"><?=lang('messages_lang.liste_liquid_dejfait')?></b><br><br>

                  <div class="col-md-12">
                    <div class="row">
                      <div class="col-md-3">
                        <label><?=lang('messages_lang.Lab_jur_instit')?></label>
                        <select autofocus onchange="getSousTutel();listing_liquid_deja_fait();vider()" class="form-control select2" id="INSTITUTION_ID" name="INSTITUTION_ID">
                      ...
                      <div class="col-md-3">
                        ...
                        <select onchange="listing_liquid_deja_fait()" class="form-control" name="SOUS_TUTEL_ID" id="SOUS_TUTEL_ID">
                          <option value=""><?=lang('messages_lang.selection_message') ?></option>
                        </select>
                      </div>
                      <div class="col-md-3">
                        <label class="form-label"><?=lang('messages_lang.date_debut_du')?>:</label>
                        <input type="date" name="DATE_DEBUT" id="DATE_DEBUT" onchange=";get_date();listing_liquid_deja_fait()" max="<?=date('Y-m-d')?>" class="form-control">
                      </div>
                      <div class="col-md-3">
                        <label class="form-label"><?=lang('messages_lang.date_fin_au')?>:</label>
                        <input type="date" name="DATE_FIN" id="DATE_FIN" onchange="listing_liquid_deja_fait()" max="<?=date('Y-m-d')?>" class="form-control" disabled>
                      </div>
                    </div>
                  </div>
          ...
          if (DATE_DEBUT == '' || DATE_DEBUT == null) {DATE_DEBUT = 0}
            if (DATE_FIN == '' || DATE_FIN == null) {DATE_FIN = 0}
              ...
              if (INSTITUTION_ID!==0) {
                ...
                document.getElementById("btnexportexcel").href = "<?=base_url('double_commande_new/Liquidation_Double_Commande/exporter_Excel_deja_fait')?>/"+INSTITUTION_ID+"/"+SOUS_TUTEL_ID+"/"+DATE_DEBUT+"/"+DATE_FIN;
              }else{
  ...
  <script>
    function listing_liquid_deja_fait()
    {
      ...
      $("#mytable").DataTable(
      {
        ...
        "ajax":
        {
          url:"<?= base_url('double_commande_new/Liquidation_Double_Commande/listing_liquid_deja_fait')?>",
          type:"POST", 
          data:
          {
