                ...
                <div class="card-body">
                  ...
                  <div class="card-body" style="margin-top: -20px">
                    ...
                    <div style="float: right;">
                      <a href="<?php echo base_url('double_commande_new/Paiement_Salaire_Liste/vue_sign_dgfp') ?>" style="float: right;margin-right: 20px;margin-top:5px" class="btn btn-primary"><i class="fa fa-list" aria-hidden="true"></i>
                        <?= lang('messages_lang.labelle_list') ?></a>
                      </div>
                      <div>
                        <font style="font-size:18px,color: #333">
                          <h4> <?= lang('messages_lang.labelle_phasec') ?>: 
                            <?= $id['DESC_ETAPE_DOUBLE_COMMANDE'] ?>
                          </h4>
                          </font>
                        </div>
                        <hr>
                        <form action="<?= base_url('double_commande_new/Phase_Comptable_Salaire/save_signature_titre_dgfp') ?>" id="MyFormData" method="post">
                          ...
                          <input type="hidden" name="paiement" id="paiment_id" value="<?= $id['MONTANT_PAIEMENT'] ?>">
                          <div class="col-md-12 container " style="border-radius:10px">
                            ...
                            <div class="row mt-3">
                              ...
                              <input type="date" name="date_reception" min="<?= date('Y-m-d', strtotime($date_trans['DATE_TRANSMISSION'])) ?>" max="<?= date('Y-m-d') ?>" onkeypress="return false" onblur="this.type='date'" onchange="get_min_trans(this.value)" value="<?=date('Y-m-d')?>" id="date_reception_id" class="form-control">
                            ...
                            <div class="col-md-6" id="show_date_sign" style="display:none;">
                              <label for=""> <?= lang('messages_lang.labelle_d_signature') ?><font color="red">*</font>
                              </label>
                              <input type="date" name="date_signature_titre" onkeypress="return false" min="<?= date('Y-m-d') ?>" max="<?= date('Y-m-d') ?>" id="date_signature_id" class="form-control" value="<?=date('Y-m-d')?>">
                            ...
                            <input type="date" name="date_transmission" max="<?= date('Y-m-d') ?>" onkeypress="return false" min="<?= date('Y-m-d') ?>" id="date_transmission_id" class="form-control" value="<?=date('Y-m-d')?>">
