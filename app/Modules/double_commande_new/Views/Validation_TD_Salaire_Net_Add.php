              ...
              <div class="col-12">
                <div style="box-shadow: rgba(100, 100, 111, 0.25) 0px 7px 29px 0px" class="card">
                  <div style="float: right;">
                    <a href="<?php echo base_url('double_commande_new/Paiement_Salaire_Liste/vue_valide_td_net')?>" style="float: right;margin-right: 20px;margin-top:5px" class="btn btn-primary"><i class="fa fa-list" aria-hidden="true"></i> <?= lang('messages_lang.liste_btn') ?></a>
                  </div>
                  <div class="car-body">
                    <h4 style="margin-left:4%;margin-top:10px"> <?=$etape_titre?></h4>
                    <br>
                    <div class=" container " style="width:90%">
                      <form enctype='multipart/form-data' name="titre_val" id="titre_val" action="<?=base_url('double_commande_new/Validation_TD_Salaire/save_valid_titre_net/')?>" method="post">
                        <div class="container">
                          <?php
                          ...
                          <div class="row" style="border:1px solid #ddd;border-radius:5px">
                            <div class="col-md-12 mt-2" style="margin-bottom:50px">
                              <div class="row">
                                ...
                                <input type="hidden" name="EXECUTION_BUDGETAIRE_TITRE_DECAISSEMENT_ID" id="EXECUTION_BUDGETAIRE_TITRE_DECAISSEMENT_ID" value="<?=$info['TITRE_ID']?>">
                                <div class="col-md-4">
                                  <label for=""><?= lang('messages_lang.label_date_rec') ?> ( <?= $retVal = ($info['PAIEMENT'] > 100000000) ? 'Ministre des finances' : 'DG finances publiques' ;?>)<font color="red">*</font></label>
                                ...
                                <div class="col-md-4">
                                  ...
                                  <input type="text" class="form-control" onkeypress="return false" name="ord" id="ord" value="<?= number_format($info['ORDONNANCEMENT'],2,',',' ')?>" readonly>
                                  <br>
                                </div>
                                <div class="col-md-4">
                                  <label for=""><?= lang('messages_lang.labelle_paiement') ?></label>
                                  <input type="text" class="form-control" onkeypress="return false" name="paie" id="paie" value="<?= number_format($info['PAIEMENT'],2,',',' ')?>" readonly>
                                  <br>
                                </div>
                                <div class="col-md-4">
                                  ...
                                  <table id="mytable" class=" table table-bordered table-striped">
                                    ...
                                    <tbody>
                                      <?php
                                        ...
                                        <td><center>'.$info['MOTIF_REFUS'].'</center></td>
                                        </tr>';
                                      ?>
                                    </tbody>
                                  </table>
      ...
      <div class="modal-body">
        <div class="table-responsive  mt-3">
          <table class="table m-b-0 m-t-20">
            <tbody>
              <tr>
                <td><i class="fa fa-calendar"></i> &nbsp;<strong><?= lang('messages_lang.label_date_rec') ?> ( <?= $retVal = ($info['PAIEMENT'] > 100000000) ? 'Ministre de la finance' : 'DG finances publiques' ;?>)</strong></td>
