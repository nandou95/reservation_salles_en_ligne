                ...
                <div style="box-shadow: rgba(100, 100, 111, 0.25) 0px 7px 29px 0px" class="card">
                  <div class="card-header">
                    <div class="row col-md-12">
                      ...
                      <div class="col-md-3">
                        <a href="<?php echo base_url('double_commande_new/Menu_Engagement_Juridique/eng_jur_valider')?>" style="float: right;margin-right: 20px;margin-top:5px" class="btn btn-primary"><i class="fa fa-list" aria-hidden="true"></i><?=lang('messages_lang.liste_bouton')?></a>
                      </div>
                    </div>
                  </div>
                  <div class="card-body">
                  ...
                  <div class=" container " style="width:100%">
                    ...
                    <form enctype='multipart/form-data' id="MyFormData" action="<?=base_url('double_commande_new/Phase_Administrative/update_etape5/')?>" method="post" >
                      <div class="container">
                        ...
                        <div class="row" style="border:1px solid #ddd;border-radius:5px">
                          <div class="col-md-12 mt-3 ml-2"style="margin-bottom:50px" >
                            <div class="row">
                              ...
                              <div class="col-md-6">
                                <br>
                                <label for=""><?=lang('messages_lang.label_date_recep_conf')?><span style="color: red;">*</span></label>
                            ...
                            <div class="col-md-6">
                              <br>
                              <label for=""><?=lang('messages_lang.label_date_trans_conf')?>(GDC)<span style="color: red;">*</span></label>
...
<script type="text/javascript">
  function save()
  {
    ...
    $('#error_OPERATION,#error_MOTIF_REJET,#error_DATE_TRANSMISSION,#error_DATE_RECEPTION,#error_ETAPE_RETOUR_CORRECTION_ID, #error_COMMENTAIRE').html('');
    ...
    if(OPERATION == '')
    {
      ...
      if(OPERATION == 1)
      {
        ...
        {
          $('#error_ETAPE_RETOUR_CORRECTION_ID').html("<?=lang('messages_lang.champ_obligatoire')?>");
          status = 1;
        }
      ...
      if(OPERATION == 3)
      {
        ...
        if(COMMENTAIRE == '')
        {
          $('#error_COMMENTAIRE').html("<?=lang('messages_lang.champ_obligatoire')?>");
          status = 1;
        }
      }
...
<script type="text/javascript">
  ...
  function save_newMotif()
  {
    ...
    {
      $.ajax({
        url: "<?=base_url('')?>/double_commande_new/Phase_Administrative/save_newMotif",
        type: "POST",
        dataType: "JSON",
        data: {
