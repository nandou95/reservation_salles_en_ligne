              ...
              <div class="col-12" style="float: left;">
               <br>
                <h1 class="header-title text-dark">
                  <?=lang('messages_lang.label_etat_av')?><br><br> 
                </h1>
              </div>
              <div class="row">
                <div class="col-md-3">
                ...
                <div class="col-md-3">
                    ...
                    <label for="Nom" class="form-label"><?=lang('messages_lang.table_st')?><b id="loading_sout"></b></label>
...
<script type="text/javascript">
  ...
  function exporter_excel() 
  {
    ...
    document.getElementById("btnexportexcel").href = "<?=base_url('double_commande_new/Etat_avancement/exporter_Excel')?>/"+INSTITUTION_ID+'/'+SOUS_TUTEL_ID+'/'+DATE_DEBUT+'/'+DATE_FIN;
  }
</script >
...
<script>
  function sous_titre()
  {
    ...
    else
    {
      $.ajax(
      {
        url:"<?=base_url()?>/double_commande_new/Etat_avancement/get_sous_titre/"+INSTITUTION_ID,
        type:"GET",
        dataType:"JSON",
        beforeSend:function()
        {
          $('#loading_sout').html("<i class='fa fa-spinner fa-pulse fa-1x fa-fw'></i>");
        },
  ...
  function get_task(id)
  {
    ...
    table=$("#mytable3").DataTable({
      ...
      "oreder":[],
      "ajax":{
        url:"<?= base_url('/double_commande_new/Etat_avancement/detail_task')?>",
        type:"POST",
        data: {
          task_id:id
        }
