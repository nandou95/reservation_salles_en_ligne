              ...
              <div style="box-shadow: rgba(100, 100, 111, 0.25) 0px 7px 29px 0px" class="card">
               ...
               <br>
                ...
                <div class="card-body">
                  ...
                  <form id="my_form" action="<?= base_url('double_commande_new/Etape_Double_Commande/save') ?>" method="POST">

                    <div class="row col-md-12">
                      <div class="col-md-6">
                        <br>
                        <label for=""><?=lang('messages_lang.labelle_et_description_m')?><span style="color: red;">*</span></label>
                        <input type="text" class="form-control" id="DESC_ETAPE_DOUBLE_COMMANDE" name="DESC_ETAPE_DOUBLE_COMMANDE" value="<?=set_value('DESC_ETAPE_DOUBLE_COMMANDE')?>" autofocus>
                      ...
                      <div class="col-md-6">
                        ...
                        <select class="form-control" name="MOUVEMENT_DEPENSE_ID" id="MOUVEMENT_DEPENSE_ID">
                          ...
                          <?php  foreach ($mouvement as $keys) { ?>
                            <?php if($keys->MOUVEMENT_DEPENSE_ID ==set_value('MOUVEMENT_DEPENSE_ID')) { ?>
                      ...
                      <div class="col-md-6">
                        ...
                        <select class="form-control" name="NIVEAU_ETAPE_ID" id="NIVEAU_ETAPE_ID">
                          <option value=""><?= lang('messages_lang.labelle_selecte') ?></option>
                          <option value="1"><?= lang('messages_lang.select_a_faire') ?></option>
                          <option value="2"><?= lang('messages_lang.select_deja_fait') ?></option>
                          <option value="3"><?= lang('messages_lang.select_a_corriger') ?></option>
                          <option value="4"><?= lang('messages_lang.select_transmission') ?></option>
                          <option value="5"><?= lang('messages_lang.select_reception') ?></option>
                          
                            </select>
                            <span id="error_NIVEAU_ETAPE_ID" class="text-danger"></span>
                            <?php if (isset($validation)) : ?>
                              <?= $validation->getError('NIVEAU_ETAPE_ID'); ?>
                            <?php endif ?>
                          </div>
                      </div>
                    </form>
