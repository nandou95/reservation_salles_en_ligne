          ...
          <div class="row">
            <div class="col-12">
              ...
              <div style="box-shadow: rgba(100, 100, 111, 0.25) 0px 7px 29px 0px" class="card">
                ...
                <div class="col-md-12">
                  <h3 class="text-dark">
                  <?= lang('messages_lang.label_titre_min') ?>
                  </h3>
                </div>
                ...
                <div class="ml-3 mt-2" style ="max-width: 15%;">
...
<script type="text/javascript">
  ...
  function exporter_excel() 
  {
    ...
    document.getElementById("btnexportexcel").href = "<?=base_url('double_commande_new/Liste_Paiement/exporter_Excel_sign_td_ministre')?>/"+INSTITUTION_ID+"/"+SOUS_TUTEL_ID+"/"+DATE_DEBUT+"/"+DATE_FIN;
  }
</script>
...
<script type="text/javascript">
  function liste() {
    ...
    $("#mytable").DataTable({
      ...
      "serverSide": true,
      "ajax": {
        url: "<?= base_url('double_commande_new/Liste_Paiement/listing_sign_ministre') ?>",
        type: "POST",
        data: {
...
<script type="text/javascript">
  function get_task(id)
  {
    ...
    table=$("#mytable3").DataTable({
      ...
      "oreder":[],
      "ajax":{
        url:"<?= base_url('/double_commande_new/Liste_Paiement/detail_task_pay')?>",
        type:"POST",
        data: {
          task_id:task_id
        }
