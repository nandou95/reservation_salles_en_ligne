                        ...
                        <div class="row" style="margin :  5px">
                          ...
                          <div id="div_creance" class="col-6 mt-2">
                            <div id="div_taches" class="p-2" style="border: #ccc solid 1px;">
                              <label><?=lang('messages_lang.label_montant_tache')?> en <?=$info['DESC_DEVISE_TYPE']?></label><br>
                              <?php
                                $i=1;
                          ...
                          <div id="DIV_DATE_LIQUIDATION" class="col-6">
                            ...
                            <input type="date" onkeypress="return false" onblur="this.type='date'" onchange="get_min_trans(this.value)" min="<?=date('Y-m-d',strtotime((!empty($info['DATE_ENG_BUDGETAIRE'])) ? $info['DATE_ENG_JURIDIQUE'] : ''))?>" max="<?=date('Y-m-d')?>" name="DATE_LIQUIDATION" id="DATE_LIQUIDATION" class="form-control" value="<?= date('Y-m-d') ?>">
                          ...
                          <div id="div_devise1" class="col-6 mt-2">
                            ...
                            <input readonly onkeyup="getSubstring(3);SetMaxLength(4);getCalculMontant()" autocomplete="off" type="text" name="MONTANT_DEVISE" id="MONTANT_DEVISE" class="form-control" value="<?=set_value("MONTANT_DEVISE")?>">
                          ...
                          <div id="div_devise2" class="col-6">
                            ...
                            <input type="text" onkeyup="getCalculMontant()" oninput="formatInputValue(this);" name="COUT_DEVISE" id="COUT_DEVISE" class="form-control" value="<?=set_value("COUT_DEVISE")?>">
                            ...
                            <select class="form-control" name="EXONERATION" id="EXONERATION">
                              ...
                              <?php
                                if(set_value("EXONERATION")==1)
                                {
                                  ...
                                  echo '<option value="0">'.lang('messages_lang.label_non').'</option>';
                                }
                                elseif(set_value("EXONERATION")==0)
                                {
                                  echo '<option value="1">'.lang('messages_lang.label_oui').'</option>';
                                  echo '<option value="0" selected>'.lang('messages_lang.label_non').'</option>';
                                }
                                else
                                {
                                  echo '<option value="1">'.lang('messages_lang.label_oui').'</option>';
                          ...
                          <div class="col-6">
                            ...
                            <input onkeypress="return false" onblur="this.type='date'" type="date" max="<?=date('Y-m-d')?>" name="DATE_TRANSMISSION" id="DATE_TRANSMISSION" class="form-control" value="<?= date('Y-m-d') ?>">
                          ...
                          if ($info['MARCHE_PUBLIQUE']==1)
                          {
                            ...
                            <div class="col-6">
                              ...
                              <input type="date" onchange="getNbrJrs()" min="<?=date('Y-m-d',strtotime((!empty($info['DATE_DEBUT_CONTRAT'])) ? $info['DATE_DEBUT_CONTRAT'] : ''))?>" name="DATE_LIVRAISON_CONTRAT" id="DATE_LIVRAISON_CONTRAT" class="form-control" value="<?= date('Y-m-d') ?>">
  ...
  function send_data_partielle()
  {
    ...
    if (TYPE_MONTANT_ID != 1)
    {
      ...
      if(MARCHE_PUBLIQUE==1)
      {
        ...
        var MONTANT_DEVISE_RESTANT = parseInt(MONTANT_ENLEVE_DEVISE) - parseInt(MONTANT_DEVISE_LIQUIDATION);
      }
    ...
    form.append("BUDGETAIRE_TYPE_DOCUMENT_ID",BUDGETAIRE_TYPE_DOCUMENT_ID);
...
<script type="text/javascript">
  ...
  function getCalculMontant(argument)
  {
    ...
    var MONTANT_DEVISE_ENGAGEMENT_JURIDIQUE = $('#MONTANT_DEVISE_ENGAGEMENT_JURIDIQUE').val();
    var MONTANT_DEVISE = $('#MONTANT_DEVISE').val();
    MONTANT_DEVISE = MONTANT_DEVISE.replace(/[^0-9.]/g, '');
    var COUT_DEVISE = $('#COUT_DEVISE').val();
    ...
    if (TYPE_MONTANT_ID != 1)
    {
      // MONTANT_DEVISE = parseFloat(MONTANT_DEVISE) + parseFloat(MONTANT_DEVISE_LIQUIDATION);

      var MONTANT_DEVISE_RESTANT = parseFloat(MONTANT_DEVISE_ENGAGEMENT_JURIDIQUE) - parseFloat(MONTANT_DEVISE_LIQUIDATION);
      if(MARCHE_PUBLIQUE==1)
      {
        var MONTANT_ENLEVE_DEVISE=$('#MONTANT_ENLEVE_DEVISE').val();
        MONTANT_DEVISE_RESTANT = parseFloat(MONTANT_ENLEVE_DEVISE) - parseFloat(MONTANT_DEVISE_LIQUIDATION);
      }
      ...
      else
      {
        ...
        var value = LIQUIDATION.toLocaleString('en-US', { useGrouping: true });
  ...
  <div class="modal-dialog modal-lg" style="max-width: 60%">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button id="mod" onclick="deleteFile();" class="btn btn-primary btn-md" data-dismiss="modal">
