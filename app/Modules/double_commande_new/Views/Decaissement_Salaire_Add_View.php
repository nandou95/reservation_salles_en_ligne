          ...
          <div class="row">
            <div class="col-12">
              <div style="box-shadow: rgba(100, 100, 111, 0.25) 0px 7px 29px 0px" class="card">
                <div class="card-header">
                  <div class="row col-md-12">
                    ...
                    <div class="col-md-2" style="float: right;">
                      <a href="<?=base_url('double_commande_new/Decaissement_Salaire_Liste/vue_decaiss_faire')?>" style="float: right;margin: 4px" class="btn btn-primary"><i class="fa fa-list text-light" aria-hidden="true"></i><?= lang('messages_lang.link_list')?></a>
                    </div>
                  </div>
                </div><hr>
                <?php
                ...
                ?>
                <div class="car-body">
                  <form id='MyFormData' enctype='multipart/form-data' action="<?=base_url('double_commande_new/Decaissement_Salaire/save_dec_salaire') ?>" method="POST">
                    <input type="hidden" name="etape" id="etape" value="<?=$etape['ETAPE_DOUBLE_COMMANDE_ID']?>">
                    <input type="hidden" name="EXECUTION_BUDGETAIRE_TITRE_DECAISSEMENT_ID" id="EXECUTION_BUDGETAIRE_TITRE_DECAISSEMENT_ID" value="<?=$etape['EXECUTION_BUDGETAIRE_TITRE_DECAISSEMENT_ID']?>">
                    <div class="card-body">
                      <div class="row">
