                          ...
                          <form action="<?= base_url("double_commande_new/reception_titre_decaissement/store") ?>" method="post" id="push_bon">
                            ...
                            <div class="row">
                              <div class="col-md-6">
                                  ...
                                  <input type="date" class="form-control" name="DATE_RECEPTION" id="DATE_RECEPTION" min="<?=date('Y-m-d', strtotime($hist['DATE_TRANSMISSION']))?>" max="<?=Date('Y-m-d')?>" onchange="get_date_min_trans()" value="<?=date('Y-m-d')?>" onkeypress="return false" onblur="this.type='date'">
                            ...
                            <div class="row">
                              ...
                              <div class="col-6" style="display: none;">
                                ...
                                <select class="form-control select2" multiple name="titre_decaissement[]" id="titre_decaissement">
                                  ...
                                  foreach ($titre_decaissement as $row) { ?>
                                    <option value="<?= $row->EXECUTION_BUDGETAIRE_TITRE_DECAISSEMENT_ID?>" selected><?= $row->NUMERO_DOCUMENT ?></option>
                                  <?php
                                  }
                                  ?>
                                </select>
                              ...
                              <div class="col-md-6">
                                  ...
                                  <input type="date" class="form-control" name="DATE_TRANSMISSION" id="DATE_TRANSMISSION" min="<?= date('Y-m-d') ?>"  max="<?=Date('Y-m-d')?>" value="<?=date('Y-m-d')?>" onkeypress="return false" onblur="this.type='date'">
