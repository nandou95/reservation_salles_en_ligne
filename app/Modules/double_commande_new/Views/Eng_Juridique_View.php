                ...
                <div style="box-shadow: rgba(100, 100, 111, 0.25) 0px 7px 29px 0px" class="card">
                  <div class="card-header">
                    <div class="row col-md-12">
                      ...
                      <div class="col-md-3">
                        <a href="<?php echo base_url('double_commande_new/Menu_Engagement_Juridique')?>" style="float: right;margin-right: 20px;margin-top:5px" class="btn btn-primary"><i class="fa fa-list" aria-hidden="true"></i><?=lang('messages_lang.liste_bouton')?></a>
                      </div>
                    </div>
                  </div>
                  <div class="card-body">
                    ...
                    <div class=" container " style="width:100%">
                      ...
                      <form enctype='multipart/form-data' id="MyFormData" action="<?=base_url('double_commande_new/Phase_Administrative/update_etape4/')?>" method="post" >
                        <div class="container">
                          <div class="row" style="border:1px solid #ddd;border-radius:5px">
                            <div class="col-md-12 mt-3 ml-2"style="margin-bottom:50px" >
                              <div class="row">
                                ...
                                <input type="hidden" name="BUDGETAIRE_TYPE_DOCUMENT_ID" id="BUDGETAIRE_TYPE_DOCUMENT_ID" value="<?=$details['BUDGETAIRE_TYPE_DOCUMENT_ID']?>">
                                ...
                                <div class="col-md-6" id="mont_devise" style="display: none;">
                                    ...
                                    <input type="hidden" name="MONTANT_DEVISE_ENGAGEMENT_BUDGETAIRE" id="MONTANT_DEVISE_ENGAGEMENT_BUDGETAIRE" value="<?=$details['MONTANT_RACCROCHE_DEVISE']?>">
                                     ...
                                     <input type="text"  class="form-control" id="MONTANT_EN_usd" value="<?=number_format($details['MONTANT_RACCROCHE_DEVISE'],3,',',' ')?>" readonly>

                                    <input type="hidden" name="MONTANT_EN_DEVISE" value="<?=$details['MONTANT_RACCROCHE_DEVISE']?>" >
                                    <?php if (isset($validation)) : ?>
                                ...
                                <div class="col-md-6" id="mont_en_bif" style="display: none;">
                                    ...
                                    <input type="text"  class="form-control" id="MONTANT_EN_fbu" value="<?=number_format($details['MONTANT_RACCROCHE'],3,',',' ')?>" readonly>

                                    <input type="hidden"  name="MONTANT_EN_BIF" value="<?=$details['MONTANT_RACCROCHE']?>" >
                                    <?php if (isset($validation)) : ?>
                                ...
                                <div class="col-md-6">
                                  ...
                                  <input type="date" class="form-control" id="DATE_HEURE_JURIDIQUE" name="DATE_HEURE_JURIDIQUE" value="<?= date('Y-m-d') ?>" min="<?=date('Y-m-d', strtotime($date_trans['DATE_TRANSMISSION']))?>" max="<?=date('Y-m-d')?>" onkeypress="return false" onblur="this.type='date'" >
                                  <?php if (isset($validation)) : ?>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="TYPE_BENEFICIARE" id="TYPE_BENEFICIARE" class="form-control" onchange="get_benef(this.value)">
                                      ...
                                      foreach($type_benef as $key) { 
                                        ...
                                        if ($key->TYPE_BENEFICIAIRE_ID==set_value('TYPE_BENEFICIARE')) { 
                                ...
                                <div class="col-md-6" id="prest_select" style="display:none;">
                                  <br>
                                  <label class="form-label" id="prest_label"></label>
                                  <select name="FOURNISSEUR_ACQUEREUR" id="FOURNISSEUR_ACQUEREUR" class="form-control select2" onchange="get_presta(this.value)">
                                    ...
                                    <?php if (isset($validation)) : ?>
                                      ...
                                      foreach($fourn_acq as $key) { 
                                        if ($key->PRESTATAIRE_ID==$PRESTATAIRE_ID) { 
                                ...
                                <div class="col-md-6">
                                  ...
                                  <select name="MODEL" id="MODEL" class="form-control" onchange="get_doc()">
                                    <option value=""><?=lang('messages_lang.selection_message')?></option>
                                    <?php 
                                    foreach($get_modele as $key) { 
                                      if ($key->MODELE_ID==set_value('MODEL')) { 
                                ...
                                <div class="col-md-6" >
                                  ...
                                  <input type="text" class="form-control" name="REFERENCE" id="REFERENCE" value="<?=set_value('REFERENCE')?>">
                                  <?php if (isset($validation)) : ?>
                                ...
                                <div class="col-md-6">
                                  <br>
                                  <label id="model_paiement"><span style="color: red;">*</span></label>
                                  <input type="file" class="form-control " id="PATH_MODELE_PAIEMENT" name="PATH_MODELE_PAIEMENT" placeholder="...." accept=".pdf" onchange="valid_doc(this)" value="<?=set_value('PATH_MODELE_PAIEMENT')?>">
                                  <?php if (isset($validation)) : ?>
                                    <font color="red" id="error_PATH_MODELE_PAIEMENT"><?=$file_error?></font>
                                  <?php endif ?>   
                                </div>
                                <?php if($details['MARCHE_PUBLIQUE'] == 1): ?>
                                  <!-- <div class="col-md-6">
                                    <br>
                                    <label><?//=lang('messages_lang.label_contrat')?><span style="color: red;">*</span></label>
                                    <input type="file" class="form-control " id="PATH_CONTRAT" name="PATH_CONTRAT" placeholder="...." accept=".pdf" onchange="valid_doc(this)" value="<?//=set_value('PATH_CONTRAT')?>">
                                    <?php //if (isset($validation)) : ?>
                                  ...
                                  <div class="col-md-6">
                                    ...
                                    <input type="date" class="form-control" id="DATE_DEBUT" name="DATE_DEBUT"  value="<?= date('Y-m-d') ?>" min="<?=date('Y-m-d', strtotime($debut))?>" onkeypress="return false" onblur="this.type='date'" onchange="get_min_fin(this.value)">
                                    <?php if (isset($validation)) : ?>
                                  ...
                                  <div class="col-md-6">
                                    ...
                                    <input type="date" class="form-control" id="DATE_FIN" name="DATE_FIN"  value="<?= date('Y-m-d') ?>" onkeypress="return false" onblur="this.type='date'">
                                    <?php if (isset($validation)) : ?>
                                      <font color="red" id="error_DATE_FIN"><?= $validation->getError('DATE_FIN'); ?></font>
                                    <?php endif ?>                                    
                                  </div>

                                  <div class="col-md-6" id="docu_avis">
                                    <br>
                                    <label for=""> <?= lang('messages_lang.label_avis') ?><font color="red">*</font></label>
                                    <input type="file" accept=".pdf" class="form-control" name="path_avis" id="path_avis" value="<?=set_value("path_avis")?>" onchange="valid_doc(this)">
                                  ...
                                  <div class="col-md-6" id="docu_pv">
                                    <br>
                                    <label for=""><?= lang('messages_lang.label_pv') ?><font color="red">*</font></label>
                                    <input type="file" accept=".pdf" class="form-control" name="path_pv" id="path_pv" value="<?=set_value("path_pv")?>" id="path_pv" onchange="valid_doc(this)">
                                  ...
                                  <div class="col-md-6" id="docu_ppm">
                                    <br>
                                    <label for=""><?= lang('messages_lang.label_ppm') ?></label>
                                    <input type="file" accept=".pdf" class="form-control" name="PATH_PPM" id="PATH_PPM" value="<?=set_value("PATH_PPM")?>" id="PATH_PPM" onchange="valid_doc(this)">
  ...
  <script>
    ...
    $(document).ready(function ()
    {
      ...
      if(MONNAIE == 1)
      {
        $('#MONTANT_EN_BIF').prop('readonly', false);
        $('#mont_en_bif').show();
    ...
    else 
    {
      ...
      if (input.files.length > 0) 
      {
        for (const i = 0; i <= input.files.length - 1; i++) 
        {
          ...
          if (file > 10*1024)
          {
            $('#error_'+id).text('<?= lang('messages_lang.fichier_volumineux_transmission_du_bordereau') ?>');
            input.value = '';
          }
          else
          {
...
<script type="text/javascript">
  function save()
  {
    ...
    var value_en_bif = $('#MONTANT_EN_fbu').val();
    var MONTANT_EN_BIF = value_en_bif.replace(/\s/g, '');

    var value_en_devise = $('#MONTANT_EN_usd').val();
    ...
    var PATH_BON_COMMANDE=document.getElementById('PATH_BON_COMMANDE');
    var PATH_CONTRAT_JURIDIQUE=document.getElementById('PATH_CONTRAT_JURIDIQUE');
    var PATH_LETTRE_COMMANDE=document.getElementById('PATH_LETTRE_COMMANDE');
    var BUDGETAIRE_TYPE_DOCUMENT_ID = <?= $details['BUDGETAIRE_TYPE_DOCUMENT_ID'] ?>;
    var PATH_MODELE_PAIEMENT = document.getElementById('PATH_MODELE_PAIEMENT');

    var status = 2;

    // $('#error_MONTANT_EN_BIF, #error_MONTANT_EN_DEVISE, #error_DATE_HEURE_JURIDIQUE, #error_DATE_TRANSMISSION, #error_DATE_RECEPTION, #error_TYPE_BENEFICIARE, #error_FOURNISSEUR_ACQUEREUR, #error_MODEL, #error_REFERENCE, #error_COMMENTAIRE, #error_PATH_CONTRAT,#error_DATE_DEBUT,#error_DATE_FIN,#error_path_avis,#error_path_pv,#error_PATH_PPM').html(''); 

    $('#error_MONTANT_EN_BIF, #error_MONTANT_EN_DEVISE, #error_DATE_HEURE_JURIDIQUE, #error_DATE_TRANSMISSION, #error_DATE_RECEPTION, #error_TYPE_BENEFICIARE, #error_FOURNISSEUR_ACQUEREUR, #error_MODEL, #error_REFERENCE, #error_COMMENTAIRE,#error_DATE_DEBUT,#error_DATE_FIN,#error_path_avis,#error_path_pv,#error_PATH_PPM').html(''); 

    if(PATH_MODELE_PAIEMENT.files.length === 0)
    {
      $('#error_PATH_MODELE_PAIEMENT').html("<?=lang('messages_lang.champ_obligatoire')?>");
      status=1;
    }
    ...
    if(MARCHE_PUBLIQUE == 1)
    {
      ...
      // {
      //   $('#error_PATH_CONTRAT').html("<?=lang('messages_lang.champ_obligatoire')?>");
      //   status=1;
      // }

      if(path_avis.files.length===0)
      {
        $('#error_path_avis').html("<?=lang('messages_lang.champ_obligatoire')?>")
        statut=1
      }

      if(path_pv.files.length===0)
      {
        $('#error_path_pv').html("<?=lang('messages_lang.champ_obligatoire')?>")
        statut=1
      }

      if(PATH_PPM.files.length===0)
      {
        $('#error_PATH_PPM').html("<?=lang('messages_lang.champ_obligatoire')?>")
        statut=1
      }
    ...
    if(MARCHE_PUBLIQUE == 1)
    {
      ...
      var path_avis=document.getElementById('path_avis').files[0].name;
      var path_pv=document.getElementById('path_pv').files[0].name;
      var PATH_PPM=document.getElementById('PATH_PPM').files[0].name;

      // var CONTRAT_NAME = CONTRAT_ID.files[0].name;
      $('#showing_contrat').show();
      // $('#contrat_verifie').html(CONTRAT_NAME);
      $('#PATH_PPM_verifie').html(PATH_PPM);
      $('#path_pv_verifie').html(path_pv);
      $('#path_avis_verifie').html(path_avis);

      $('#showing_date_debut').show();
      const format_date_debut = moment(DATE_DEBUT).format('DD/MM/YYYY');
    ...
    var PATH_MODELE_PAIEMENT = document.getElementById('PATH_MODELE_PAIEMENT');
    var PATH_MODELE_PAIEMENT = PATH_MODELE_PAIEMENT.files[0].name;
    $('#contrat_verifie').html(PATH_MODELE_PAIEMENT);
  ...
  function get_doc()
  {
    $('#model_paiement').html($('#MODEL option:selected').text()+'<span style="color: red;">*</span>');
  }
</script>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
          ...
          <table class="table m-b-0 m-t-20">
            <tbody>
              ...
              <tr id="showing_contrat">
                <td style="width:350px;"><i class="fa fa-file-pdf"></i>&nbsp;<strong>Document du modèle de paiement</strong></td>
      ...
      <div class="modal-footer">
        ...
        <a onclick="confirm();hideButton()" id="add1" style="float: right;" class="btn btn-info"><i class="fa fa-check"></i><?=lang('messages_lang.bouton_confirmer')?></a>
      </div>
    </div>
  </div>
</div>
