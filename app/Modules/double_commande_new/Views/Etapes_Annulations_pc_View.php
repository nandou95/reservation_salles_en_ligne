                ...
                <div style="box-shadow: rgba(100, 100, 111, 0.25) 0px 7px 29px 0px" class="card">
                  <div class="card-header">
                    <div class="row col-md-12">
                      ...
                      <div class="col-md-3">
                        <a href="<?php echo base_url('double_commande_new/Liste_Annulation/annulation_pc')?>" style="float: right;margin-right: 20px;margin-top:5px" class="btn btn-primary"><i class="fa fa-list" aria-hidden="true"></i><?=lang('messages_lang.liste_bouton')?></a>
                      </div>
                    </div>
                  </div>
                  <div class="card-body">
                  ...
                  <div class=" container " style="width:100%">
                    ...
                    <form enctype='multipart/form-data' id="MyFormData" action="<?=base_url('double_commande_new/Etapes_Annulations/save_rejeter/')?>" method="post" >
                      <div class="container">
                        <div class="row" style="border:1px solid #ddd;border-radius:5px">
                          <div class="col-md-12 mt-3 ml-2"style="margin-bottom:50px" >
                            ...
                            <div class="row">
                              <input type="hidden" name="id_exec_titr_dec" id="id_exec_titr_dec" value="<?=$details['EXECUTION_BUDGETAIRE_TITRE_DECAISSEMENT_ID']?>">
