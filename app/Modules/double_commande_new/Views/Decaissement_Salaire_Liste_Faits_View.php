          ...
          <div class="row">
            <div class="col-12">
              <div style="box-shadow: rgba(100, 100, 111, 0.25) 0px 7px 29px 0px" class="card">
                <div class="card-header">
                  <div class="col-12 d-flex">
                    <?php
                    $decaissFaire_class = "btn ";
                    $Decaiss_deja_fait_class = "btn active ";
              ...
              <div style="box-shadow: rgba(100, 100, 111, 0.25) 0px 7px 29px 0px" class="card">
                ...
                <div class="col-md-12">
                  <h3 class="text-dark">
                  <?= lang('messages_lang.decaisement_Faits') ?>
                  </h3>
                </div>
...
<script type="text/javascript">
  ...
  function exporter_excel() 
  {
    ...
    document.getElementById("btnexportexcel").href = "<?=base_url('double_commande_new/Decaissement_Salaire_Liste/exporter_Excel_decaissement_fait')?>/"+DATE_DEBUT+'/'+DATE_FIN;
  }
</script>
...
<script type="text/javascript">
  function liste() {
    ...
    $("#mytable").DataTable({
      ...
      "serverSide": true,
      "ajax": {
        url: "<?= base_url('double_commande_new/Decaissement_Salaire_Liste/listing_decaissement_deja_fait') ?>",
        type: "POST",
        data: {
