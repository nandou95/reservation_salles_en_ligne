                ...
                <div class="card-header">
                  <div class="row col-md-12">
                    ...
                    <div style="float: right;">
                        <a href="<?php echo base_url('double_commande_new/Liste_Paiement/vue_sign_ministre') ?>" style="float: right; width: 100px; margin-right: 20px;margin-top:25px" class="btn btn-primary"><i class="fa fa-list" aria-hidden="true"></i><?= lang('messages_lang.bouton_liste')?></a>
                    </div>
                    ...
                    <div class="card-body">
                      <div class="row">
                        <div class="col-md-4"><br>
                          ...
                          <input type="date" class="form-control" name="DATE_RECEPTION" value="<?=date('Y-m-d')?>" min="<?php echo date('Y-m-d',strtotime($hist['DATE_TRANSMISSION']))?>" max="<?=date('Y-m-d')?>" id="DATE_RECEPTION" onkeypress="return false" onblur="this.type='date'" onchange="get_date_min_trans()">
