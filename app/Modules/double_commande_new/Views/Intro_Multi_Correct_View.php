                ...
                <div style="box-shadow: rgba(100, 100, 111, 0.25) 0px 7px 29px 0px" class="card">
                  ...
                  <div class="car-body">
                    ...
                    <div class=" container " style="width:90%">
                      <form enctype='multipart/form-data' name="myEtape1" id="myEtape1" action="<?=base_url('double_commande_new/Introduction_Budget_Multi_Taches/etape1_correction/')?>" method="post" >
                        <div class="container">
                          ...
                          <div class="row" style="border:1px solid #ddd;border-radius:5px">
                            <div class="col-md-7 mt-3 ml-2"style="margin-bottom:50px" >
                              <div class="row">
                                <input type="hidden" name="id_exec_titr_dec" id="id_exec_titr_dec" value="<?= md5($infos['EXECUTION_BUDGETAIRE_TITRE_DECAISSEMENT_ID'])?>">
                                <input type="hidden" name="id_titr_dec" id="id_exec_titr_dec" value="<?=$infos['EXECUTION_BUDGETAIRE_TITRE_DECAISSEMENT_ID']?>">
                                <input type="hidden" name="EXECUTION_BUDGETAIRE_ID" id="EXECUTION_BUDGETAIRE_ID" value="<?= $infos['EXECUTION_BUDGETAIRE_ID']?>">
                                <input type="hidden" name="EXECUTION_BUDGETAIRE_DETAIL_ID" id="EXECUTION_BUDGETAIRE_DETAIL_ID" value="<?= $infos['EXECUTION_BUDGETAIRE_DETAIL_ID']?>">
                                <input type="hidden" name="ETAPE_DOUBLE_COMMANDE_ID" id="ETAPE_DOUBLE_COMMANDE_ID" value="<?=$infos['ETAPE_DOUBLE_COMMANDE_ID']?>">
                                  ...
                                  <div class='form-froup'>
                                    ...
                                    <select onchange="get_sousTutel();get_inst();" class="select2 form-control" name="INSTITUTION_ID" id="INSTITUTION_ID">
                                      ...
                                      <?php  foreach ($institutions as $keys) { ?>
                                        <?php if($keys->INSTITUTION_ID==$inst_exec['INSTITUTION_ID']) { ?>
                                ...
                                <div class="col-md-6">
                                  ...
                                  <input type="text" class="form-control" id="NOTE_REFERENCE" name="NOTE_REFERENCE" value="<?= !empty($infos['NOTE_REFERENCE']) ? $infos['NOTE_REFERENCE'] : '' ?>">
                              ...
                              <div class="row">
                                  ...
                                  <div class='form-froup'>
                                    ...
                                    <select class="form-control" name="TYPE_ENGAGEMENT_ID" id="TYPE_ENGAGEMENT_ID">
                                      ...
                                      <?php  foreach ($grande as $value) { ?>
                                        <?php if($value->TYPE_ENGAGEMENT_ID==$infos['TYPE_ENGAGEMENT_ID']) { ?>
                                  ...
                                  <div class="form-froup">
                                    ...
                                    <select onchange="money_devise();" name="TYPE_MONTANT_ID" id="TYPE_MONTANT_ID" class="form-control">
                                      ...
                                      foreach($get_device as $key) { 
                                        if ($key->DEVISE_TYPE_ID==$infos['DEVISE_TYPE_ID']) { 
                                ...
                                <div class="col-md-6" id="cou_chang" hidden="true">
                                  ...
                                  <input onpaste="return false;" oninput="formatInputValue(this);" onkeyup="fois();" onkeydown="moneyDevise();" type="text" class="form-control" name="engagement_cous" id="engagement_cous" value="<?=$infos['COUR_DEVISE']?>" >

                                  <font color="red" id="error_COUS_ECHANGE"></font>
                                  <?php if (isset($validation)) : ?>
                                    <?= $validation->getError('engagement_cous'); ?>
                                  <?php endif ?>
                                </div>
                                ...
                                <div class="col-md-6" id="racc_dev"  hidden="true">
                                  <div class="form-froup">
                                    ...
                                    <input type="text" class="form-control " name="ENG_BUDGETAIRE_devise" id="ENG_BUDGETAIRE_devise" readonly>
                                ...
                                <div class="col-md-6" id="date_dev"  hidden="true">
                                  ...
                                  <input type="date" max="<?= date('Y-m-d')?>"  class="form-control" onkeypress="return false" name="DATE_COUT_DEVISE" id="DATE_COUT_DEVISE" value="<?=date('Y-m-d', strtotime($infos['DATE_COUR_DEVISE']))?>">
                                ...
                                <div class="col-md-6" id="racc_bif">
                                  <div class="form-froup">
                                    <label class="form-label"><?= lang('messages_lang.label_engage') ?> <font color="red">*</font></label>
                                    <input onpaste="return false;" type="text" class="form-control " name="ENG_BUDGETAIRE" id="ENG_BUDGETAIRE" placeholder="" value="<?=set_value('ENG_BUDGETAIRE')?>" onpaste="return false;" min="0" oninput="formatInputValue(this);" onkeyup="moneyRestant();calculer()" >
                                ...
                                <div class="col-md-6">
                                  ...
                                  <textarea class="form-control" name="COMMENTAIRE" id="COMMENTAIRE"><?=$infos['COMMENTAIRE']?></textarea>
                                ...
                                <div class="col-md-6" id="id_qte" hidden="true">
                                  <div class="form-froup">
                                    ...
                                    <input onpaste="return false;" type="text" maxlength="20" class="form-control allownumericwithdecimal" name="QTE" id="QTE" placeholder="" value="<?=set_value('QTE')?>" onpaste="return false;" min="1" onkeydown="qte();" onkeyup="qte();">
                          ...
                          <div style="float: right;" class="col-md-2 mt-5 " >
                            <div class="form-group " >
                              <a onclick="saveEtape1()" id="btn_save"  class="btn btn-primary" ><b id="loading_save"></b> <?= lang('messages_lang.bouton_ajouter') ?></a>
                            </div>
                          </div>

                          <div class="table-responsive container" id="task_liste">
                          ...
                          <div style="float: right;" class="col-md-2 mt-5">
                            <div class="form-group " >
                              <a onclick="save_tasks()"  class="btn btn-primary" style="float:right"><b id="loading_save"></b> <?= lang('messages_lang.label_enre') ?></a>
                            </div>
                          </div>
                        </div>
                      </form><br><br>
...
<script type="text/javascript">
  function save_tempo()
  {
    ...
    let url="<?=base_url('double_commande_new/Introduction_Budget_Multi_Taches/save_tempo')?>";
    $.post(url,
    {
    ...
    function (data) {
      ...
      {   
        ...
        var elementmod = document.getElementById("mod");
        elementmod.style.display = "block";
...
<script type="text/javascript">
  function liste() 
  {
    ...
    $("#mytable").DataTable({
      ...
      "serverSide": true,
      "ajax": {
        url: "<?= base_url('double_commande_new/Introduction_Budget_Multi_Taches/listing_task')?>",
        type: "POST",
        data: {
          EXECUTION_BUDGETAIRE_ID:EXECUTION_BUDGETAIRE_ID,
          id_exec_titr_dec:id_exec_titr_dec
        }
      },
...
<!--******************* Modal pour supprimer dans le tempo ***********************-->
...
<!--******************* Fin Modal Suppression dans le tempo ***********************-->
