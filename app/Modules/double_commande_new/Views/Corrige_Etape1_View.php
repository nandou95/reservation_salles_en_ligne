                ...
                <div class=" container " style="width:90%">
                  <form enctype='multipart/form-data' name="myEtape1_corrige" id="myEtape1_corrige" action="<?=base_url('double_commande_new/Phase_Administrative_Budget/etape1_correction/')?>" method="post" >
                    <div class="container">
                      ...
                      <input type="hidden" name="EXECUTION_BUDGETAIRE_TITRE_DECAISSEMENT_ID" name="EXECUTION_BUDGETAIRE_TITRE_DECAISSEMENT_ID" value="<?= $get_info['EXECUTION_BUDGETAIRE_TITRE_DECAISSEMENT_ID']?>">
                      ...
                      <input type="hidden" name="BUDGETAIRE_TYPE_DOCUMENT_ID_OLD" id="BUDGETAIRE_TYPE_DOCUMENT_ID_OLD" value="<?=$get_date_eng['BUDGETAIRE_TYPE_DOCUMENT_ID']?>">
                      <input type="hidden" id="get_taux_id" value="<?=$get_date_eng['TAUX_ECHANGE_ID']?>">
                      <input type="hidden" name="TRIMESTRE_ID" id="TRIMESTRE_ID" value="<?=$get_info['TRIMESTRE_ID']?>">
                      ...
                      <div class="row" style="border:1px solid #ddd;border-radius:5px">
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-6">
                              <div class="form-froup">
                                ...
                                <select onchange="get_TacheMoneyCorrection()" class="form-control form-select bg-light select2" id="PTBA_TACHE_ID" name="PTBA_TACHE_ID" placeholder="Sélectionnez l'activité" autocomplete="off" aria-label=".form-select-lg example" >
                              ...
                              <div class="col-md-6">
                                <div class="form-froup">
                                  <label class="form-label">
                                    <?= lang('messages_lang.label_marche') ?>&nbsp;<font color="red">*</font>
                                  </label>
                                  <select onchange="saissie_ppm();get_TacheMoneyCorrection()" class="form-control" id="MARCHE_PUBLIQUE" name="MARCHE_PUBLIQUE">
                                    <option value=""><?= lang('messages_lang.label_select') ?></option>
                            ...
                            {?>
                              <div class="col-md-6">
                                <div class="form-froup">
                                  <label class="form-label"><?= lang('messages_lang.label_marche') ?>&nbsp;<font color="red">*</font>
                                  </label>
                                  <select onchange="saissie_ppm();get_TacheMoneyCorrection();" class="form-control" id="MARCHE_PUBLIQUE" name="MARCHE_PUBLIQUE">
                                    <option value=""><?= lang('messages_lang.label_select') ?></option>
                                    <?php  $marche=array(0=>'Non',1=>'Oui');?>
                            ...
                            <div class="col-md-6">
                              ...
                              <select name="BUDGETAIRE_TYPE_DOCUMENT_ID" id="BUDGETAIRE_TYPE_DOCUMENT_ID" onchange="get_intro()" class="form-control">
                                <option value=""><?= lang('messages_lang.label_select') ?></option>
                                <?php
                            ...
                            <div class="col-md-6" id="racc_bif">
                              <div class="form-froup">
                                <label class="form-label"><?= lang('messages_lang.label_engage') ?> <font color="red">*</font></label>
                                <input onpaste="return false;" value="<?=number_format($get_info['ENG_BUDGETAIRE'],0,'.',' ')?>" type="text" class="form-control " name="MONTANT_RACCROCHE" id="MONTANT_RACCROCHE" placeholder="0" value="<?=set_value('MONTANT_RACCROCHE')?>" onpaste="return false;" min="0" oninput="formatInputValue(this);" onkeydown="moneyRestant()" onkeyup="calculer();moneyRestant()" >
                            ...
                            <div class="col-md-6" id="tip_march" hidden="true">
                              <div class='form-froup'>
                                ...
                                <select class="form-control" name="ID_TYPE_MARCHE" id="ID_TYPE_MARCHE">
                                  <option value=""><?= lang('messages_lang.label_select') ?></option>
                                  <?php foreach($type_marche as $key) { 
                            ...
                            <div class="col-md-12" id="intro_note_div" hidden="true">
                              <label for=""> <?= lang('messages_lang.label_intro_note') ?> <font color="red">*</font></label>
                              <textarea class="form-control" name="intro_note" id="intro_note"><?=!empty($get_date_eng["INTRODUCTION_NOTE"])?$get_date_eng["INTRODUCTION_NOTE"]:""?></textarea>
                              <font color="red" id="error_intro_note"></font>
                            </div>
                          </div>
                          <hr class="vertical">
                        ...
                        <div style="float: right;" class="col-md-2 mt-5 " >
                          <div class="form-group " >
                            <a onclick="saveEtape1_corrige()" id="btn_save"  class="btn" style="float:right;background:#061e69;color:white"><b id="loading_save"></b> <?= lang('messages_lang.label_enre') ?></a>
                          </div>
                        </div>
                      </div>
                    </form><br><br>
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    if($('#BUDGETAIRE_TYPE_DOCUMENT_ID_OLD').val()==1)
    {
      $('#intro_note_div').attr("hidden",false);
    }
    else
    {
      $('#intro_note_div').attr("hidden",true);
    }
...
<script type="text/javascript">
  ...
  function get_TacheMoneyCorrection()
  {
    ...
    else
    {
      $.ajax(
      {
        url:"<?=base_url()?>/double_commande_new/Phase_Administrative_Budget/get_TacheMoneyCorrection/"+PTBA_TACHE_ID+"/"+TRIMESTRE_ID,
        type:"POST",
        dataType:"JSON",
        success: function(data)
        {
...
<div class='modal fade' id='otb_val'>
  <div class='modal-dialog'>
    <div class='modal-content'>
      ...
      <div class='modal-body'>
        <center>
          <embed  src="<?=base_url('uploads/double_commande_new/'.$get_date_eng['PATH_NOTE_A_LA_DCP'])?>" scrolling="auto" height="500px" width="100%" frameborder="0">
        </center>
      </div>
      <div class='modal-footer'>
        <button class='btn btn-primary btn-md' data-dismiss='modal'>
