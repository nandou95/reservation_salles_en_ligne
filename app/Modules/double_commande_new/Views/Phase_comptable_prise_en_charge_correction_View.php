                ...
                <div class="card-body">
                  ...
                  <div class="card-body" style="margin-top: -20px">
                    ...
                    <div style="float: right;">
                      <a href="<?php echo base_url('double_commande_new/Liste_Paiement/vue_correct_pc') ?>" style="float: right;margin-right: 20px;margin-top:5px" class="btn btn-primary"><i class="fa fa-list" aria-hidden="true"></i>
                  ...
                  <form action="<?= base_url('double_commande_new/Phase_comptable/save_correction_prise_en_charge') ?>" id="MyFormData" method="post" enctype="multipart/form-data">
                    ...
                    <input type="hidden" id="TYPE_ENGAGEMENT_ID" name="TYPE_ENGAGEMENT_ID" value="<?=$type_eng['TYPE_ENGAGEMENT_ID'] ?>">
                    ...
                    <div class="col-md-12 container" style="border-radius:10px">
                      ...
                      <div class="row mt-3">
                        ...
                        <div class="col-md-4">
                          <div class="">
                            <label for=""><?= lang('messages_lang.lab_d_rec') ?><font color="red">* 
                            </font>
                          </label>
                    ...
                    <div class="col-md-4">
                      <div>
                        ...
                        <input type="date" name="date_prise_en_charge" onkeypress="return false" max="<?= date('Y-m-d') ?>" min="<?= date('Y-m-d') ?>" id="date_prise_en_charge_id" class="form-control" value="<?=date('Y-m-d', strtotime($infoprise['DATE_PRISE_CHARGE']))?>">
                      ...
                      <div class="">
                        ...
                        <select name="OPERATION" id="OPERATION" class="form-control" onchange="get_rejet()">
                          ...
                          <?php foreach ($confirmation_formulaire_data as $confirmation_formulaire) : ?>
                            <?php if($confirmation_formulaire->ID_OPERATION == $operation_type){ ?>
                              <option value="<?= $confirmation_formulaire->ID_OPERATION ?>" selected> <?= $confirmation_formulaire->DESCRIPTION ?> </option>
                            <?php } else { ?>
                      ...
                      <div class="">
                        ...
                        <select name="Banquess" id="Banque_id" class="form-control select2 " onchange='getAutreBanque(this.value)'>
                          ...
                          <?php foreach ($get_banque as $banque) : ?>
                            <?php if($banque->BANQUE_ID == $infoprise['BANQUE_ID']){?>
                              <option value="<?= $banque->BANQUE_ID ?>" selected><?= $banque->NOM_BANQUE ?></option>
                            <?php } else { ?>
                              <option value="<?= $banque->BANQUE_ID ?>"><?= $banque->NOM_BANQUE ?></option>
                            <?php } ?>
                          <?php endforeach ?>
                        </select> 
                    ...
                    <div class="col-md-4" id="show_num_banque" style="display: none;">
                      <div class="">
                        ...
                        <input type="" name="num_compte" id="num_compte_id" class="form-control" value="<?=$infoprise['COMPTE_CREDIT']?>">
                      ...
                      <div class="">
                        ...
                        <select style="background-color: rgb(226, 226, 226) !important;" name="analyse[]" id="analyse_id" class="form-control select2" multiple>
                          ...
                          <?php foreach ($get_verification2 as $key) {
                            if ($key->EXECUTION_BUDGETAIRE_ID==$id['EXECUTION_BUDGETAIRE_ID']) {
                              ?>
                    ...
                    <?php if ($devise_type != 1) { ?>
                      ...
                      <div class="col-md-4" id="dates_payment_devise" style="display: none;">
                        <div class="">
                          ...
                          <input type="date" name="date_paiement_devise" id="date_paiement_devise_id" class="form-control" value="<?= date('Y-m-d') ?>" min="<?= date('Y-m-d') ?>" max="<?= date('Y-m-d') ?>" value="<?=date('Y-m-d', strtotime($infoprise['DATE_PAIEMENT']))?>">
                  ...
                  <?php if ($type_eng['TYPE_ENGAGEMENT_ID'] == 1): ?>
                    ...
                    <br>
                    <br>
                    <div class="col-md-12" id="CART_FILE"><?=$mycart?></div><br>
                  <?php endif; ?>

                </div>
              </div>
              <br><br>
              <div <?php echo ($type_eng['TYPE_ENGAGEMENT_ID'] == 1) ? 'id="SAVE" class="card-footer" style="float:right;"' : 'style="float:right;"' ?> >
        ...
        function get_rejet() {
          ...
          if (OPERATION == '') {
            ...
            if (OPERATION == 1 || OPERATION == 3) {
              ...
              if(OPERATION == 3)
              {
                $("#motif_label").html("Motif");
              }else{

                $("#motif_label").html("<?=lang('messages_lang.motif_retour_correction_phase_comptable_prise_en_charge')?>");
              }
