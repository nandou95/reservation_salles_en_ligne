...
<script type="text/javascript">
  ...
  function exporter_excel() 
  {
    ...
    document.getElementById("btnexportexcel").href = "<?=base_url('double_commande_new/Paiement_Salaire_Liste/exporter_Excel_sign_Ministre')?>/"+DATE_DEBUT+'/'+DATE_FIN;
  }
</script>
...
<script type="text/javascript">
  function liste() {
    ...
    $("#mytable").DataTable({
      ...
      "serverSide": true,
      "ajax": {
        url: "<?= base_url('double_commande_new/Paiement_Salaire_Liste/listing_sign_ministre') ?>",
        type: "POST",
        data: {
