                 ...
                 <div class="row col-md-12">
                  <div class="col-md-9" style="float: left;">
                    <h1 class="header-title text-black">
                      <?=lang('messages_lang.liste_etap_config')?>
                    </h1>
                  </div>
                  <div class="col-md-3" style="float: right;">
                    <a href="Etape_Double_Commande_Config/add" style="float: right;" class="btn btn-primary"><i class="fa fa-plus" aria-hidden="true"></i> <?=lang('messages_lang.labelle_et_nouveau')?> </a>
                  </div>
                </div>
              </div>              
              <div class="card-body">
...
<script>
  $(document).ready(function()
  {
    ...
    $("#mytable").DataTable(
    {
      ...
      "ajax":
      {
        url:"Etape_Double_Commande_Config/listing",
        type:"POST", 
      },
