            ...
            <div class="card-body">
              <div class="col-12" style="float: left;">
                ...
                <h1 class="header-title text-dark">
                  <?=lang('messages_lang.titre_suivi_titre_att_trait')?><br><br>
                </h1>
              </div>
              <div class="row">
                <div class="col-md-3">
...
<script type="text/javascript">
  function liste() 
  {
    ...
    $("#mytable").DataTable({
      ...
      "serverSide": true,
      "ajax": {
        url: "<?= base_url('double_commande_new/Suivi_Execution/listing_decais_attente_traitement')?>",
        type: "POST",
        data: {
...
<script type="text/javascript">
  ...
  if (DATE_FIN == '' || DATE_FIN == null) {DATE_FIN = 0}
     document.getElementById("btnexportexcel").href = "<?=base_url('double_commande_new/Suivi_Execution/excel_decais_attente_traitement')?>/"+INSTITUTION_ID+"/"+SOUS_TUTEL_ID+"/"+DATE_DEBUT+"/"+DATE_FIN;
  }
