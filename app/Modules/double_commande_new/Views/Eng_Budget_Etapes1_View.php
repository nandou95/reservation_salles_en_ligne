                          ...
                          <div class="row" style="border:1px solid #ddd;border-radius:5px">
                            <div class="col-md-7 mt-3 ml-2"style="margin-bottom:50px" >
                              <div class="row">
                                  ...
                                  <div class='form-froup'>
                                    ...
                                    <div class="col-md-6">
                                      <div class="form-froup">
                                        ...
                                        <select class="form-control" id="MARCHE_PUBLIQUE" onchange="get_TacheMoney();saissie_ppm()" name="MARCHE_PUBLIQUE" >
                                          <option value=""><?= lang('messages_lang.label_select') ?></option>
                                    ...
                                    <div class="col-md-6" id="racc_bif">
                                      <div class="form-froup">
                                        <label class="form-label"><?= lang('messages_lang.label_engage') ?> <font color="red">*</font></label>
                                        <input onpaste="return false;" type="text" class="form-control " name="MONTANT_RACCROCHE" id="MONTANT_RACCROCHE" placeholder="" value="<?=set_value('MONTANT_RACCROCHE')?>" onpaste="return false;" min="0" oninput="formatInputValue(this);" onkeyup="calculer();moneyRestant()" >
                                ...
                                <div class="col-md-12" id="intro_note_div" hidden="false">
                                  <label for=""> <?= lang('messages_lang.label_intro_note') ?> <font color="red">*</font></label>
                                  <textarea class="form-control" name="intro_note" id="intro_note"></textarea>
                            ...
                            <div style="float: right;" class="col-md-2 mt-5 " >
                              <div class="form-group " >
                                <a onclick="saveEtape1()" id="btn_save"  class="btn" style="float:right;background:#061e69;color:white"><b id="loading_save"></b> <?= lang('messages_lang.label_enre') ?></a>
                              </div>
                            </div>
                          </div>
                          </form><br><br>
