                              ...
                              <div class="row">
                                ...
                                <?php if($details['TYPE_MONTANT_ID'] ==1):?>
                                  <div class="col-md-6">
                                    ...
                                    <input type="date" class="form-control" id="DATE_HEURE_JURIDIQUE" name="DATE_HEURE_JURIDIQUE" onkeypress="return false" <?php if (!empty($juridique['DATE_ENGAGEMENT_JURIDIQUE'])): ?> value="<?=date('Y-m-d', strtotime($juridique['DATE_ENGAGEMENT_JURIDIQUE']))?>" <?php endif ?> value="<?= date('Y-m-d') ?>" min="<?=date('Y-m-d', strtotime($date_trans['DATE_TRANSMISSION']))?>" max="<?=date('Y-m-d')?>" onkeypress="return false" onblur="this.type='date'">
                                ...
                                <?php if($details['TYPE_MONTANT_ID'] !=1):?>
                                  <div class="col-md-6">
                                    <br>
                                    <label for="" id="date_eng"></label>
                                    <input type="date" class="form-control" id="DATE_HEURE_JURIDIQUE" name="DATE_HEURE_JURIDIQUE" onkeypress="return false" <?php if (!empty($juridique['DATE_ENGAGEMENT_JURIDIQUE'])): ?> value="<?=date('Y-m-d', strtotime($juridique['DATE_ENGAGEMENT_JURIDIQUE']))?>" <?php endif ?> value="<?= date('Y-m-d') ?>" min="<?=date('Y-m-d', strtotime($juridique['DATE_ENGAGEMENT_JURIDIQUE']))?>" max="<?=date('Y-m-d')?>" onkeypress="return false" onblur="this.type='date'">
                                ...
                                <div class="col-md-6">
                                  <br>
                                  <label id="model_paiement"><?php if(!empty($juridique['PATH_MODELE_PAIEMENT'])): ?></label><label><button style="border:none;" type="button" onclick="docs('<?= $juridique['PATH_MODELE_PAIEMENT'] ?>')">
                                            <span class="fa fa-file-pdf" style="color:red;"></span>
                                        </button><?php endif ?></label>
                                  <input type="hidden" class="form-control " id="PATH_MODELE_PAIEMENT_OLD" name="PATH_MODELE_PAIEMENT_OLD" accept=".pdf" <?php if (!empty($juridique['PATH_MODELE_PAIEMENT'])): ?> value="<?=$juridique['PATH_MODELE_PAIEMENT']?>" <?php endif ?>>
                                  <input type="file" class="form-control " id="PATH_MODELE_PAIEMENT" name="PATH_MODELE_PAIEMENT" placeholder="...." accept=".pdf" value="<?=set_value('PATH_MODELE_PAIEMENT')?>">
                                  <?php if (isset($validation)) : ?>
                                ...
                                <?php if($details['MARCHE_PUBLIQUE'] == 1): ?>
                                  ...
                                  <div class="col-md-6" id="docu_avis">
                                    <br>
                                    <input type="hidden" name="path_avis_old" id="path_avis_old" value="<?=$details['PATH_AVIS_DNCMP']?>">
                                    <label for="">
                                      <?= lang('messages_lang.label_avis') ?>
                                      <?php if (!empty($details['PATH_AVIS_DNCMP'])) { ?>
                                          <button style="border:none;" type="button" onclick="docs('<?= $details['PATH_AVIS_DNCMP'] ?>')">
                                              <span class="fa fa-file-pdf" style="color:red;"></span>
                                          </button>
                                      <?php } ?>
                                    </label>
                                    <input type="file" accept=".pdf" class="form-control" name="path_avis" id="path_avis" value="<?=set_value("path_avis")?>">
                                  ...
                                  <div class="col-md-6" id="docu_pv">
                                    <input type="hidden" name="path_pv_old" id="path_pv_old" value="<?=$details['PATH_PV_ATTRIBUTION']?>">
                                    <br>
                                    <label for=""><?= lang('messages_lang.label_pv') ?></label><?php if(!empty($details['PATH_PV_ATTRIBUTION'])){ ?><button style="border:none;" type="button" onclick="docs('<?= $details['PATH_PV_ATTRIBUTION'] ?>')">
                                              <span class="fa fa-file-pdf" style="color:red;"></span>
                                          </button><?php } ?>
                                  ...
                                  <div class="col-md-6" id="docu_ppm">
                                    <input type="hidden" name="PATH_PPM_old" id="PATH_PPM_old" value="<?=$details['PATH_PPM']?>">
                                    <br>
                                    <label for=""><?= lang('messages_lang.label_ppm') ?></label><?php if(!empty($details['PATH_PPM'])){ ?><button style="border:none;" type="button" onclick="docs('<?= $details['PATH_PPM'] ?>')">
                                              <span class="fa fa-file-pdf" style="color:red;"></span>
                                          </button><?php } ?> 
                                  ...
                                  <div class="col-md-6">
                                    ...
                                    <input type="date" class="form-control" id="DATE_DEBUT" name="DATE_DEBUT"  <?php if (!empty($juridique['DATE_DEBUT_CONTRAT'])): ?> value="<?=date('Y-m-d', strtotime($juridique['DATE_DEBUT_CONTRAT']))?>" <?php endif ?> value="<?= date('Y-m-d') ?>" min="<?=date('Y-m-d', strtotime($debut))?>" onkeypress="return false" onblur="this.type='date'" onchange="get_min_fin(this.value)">
                                    <?php if (isset($validation)) : ?>
                                  ...
                                  <div class="col-md-6">
                                    ...
                                    <input type="date" class="form-control" id="DATE_FIN" name="DATE_FIN"  <?php if (!empty($juridique['DATE_FIN_CONTRAT'])): ?> value="<?=date('Y-m-d', strtotime($juridique['DATE_FIN_CONTRAT']))?>" <?php endif ?> value="<?= date('Y-m-d') ?>" onkeypress="return false" onblur="this.type='date'">
                                    <?php if (isset($validation)) : ?>
...
<script type="text/javascript">
  function save()
  {
    ...
    $('#error_MONTANT_EN_BIF, #error_MONTANT_EN_DEVISE, #error_DATE_HEURE_JURIDIQUE, #error_DATE_TRANSMISSION, #error_DATE_RECEPTION, #error_TYPE_BENEFICIARE, #error_FOURNISSEUR_ACQUEREUR, #error_MODEL, #error_REFERENCE, #error_COMMENTAIRE,#error_DATE_DEBUT,#error_DATE_FIN,#error_path_avis,#error_path_pv,#error_PATH_PPM,error_PATH_MODELE_PAIEMENT').html(''); 

    if(PATH_MODELE_PAIEMENT.files.length != 0)
    {
      if(PATH_MODELE_PAIEMENT.files[0].size > maxFileSize)
      {
        $('#error_PATH_MODELE_PAIEMENT').html("<?=lang('messages_lang.file_err_size')?>"+" 25 MB!");
        status = 1;
      }
    }
    ...
    if(MARCHE_PUBLIQUE == 1)
    {
      ...
      {
        if (path_avis.files[0].size > maxFileSize)
        {
      ...
      {
        if (path_pv.files[0].size > maxFileSize)
        {
      ...
      {
        if (PATH_PPM.files[0].size > maxFileSize)
        {
...
<script>
  function docs(path)
  {
    var src='<?=base_url()?>/uploads/double_commande_new/'+path;
    $('#pdf').html('<embed  src='+src+' scrolling="auto" height="500px" width="100%" frameborder="0">')
    $('#docs_doc').modal("show");
  }
...
<div class='modal fade' id='ppm_corrige'>
  ...
  <div class='modal fade' id='docs_doc'>
    <div class='modal-dialog'>
      <div class='modal-content'>
        <div class="modal-header">
