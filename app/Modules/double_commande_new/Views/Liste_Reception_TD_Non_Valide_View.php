            ...
            <div class="col-12">
              ...
              <div style="box-shadow: rgba(100, 100, 111, 0.25) 0px 7px 29px 0px" class="card">
                ...
                <div style="margin-right: 20px; float: right;">
                  <a href="<?= base_url("double_commande_new/Reception_Brb_MinFin/recevoir") ?>" class='btn btn-primary' style="float: right;"> <?= lang("messages_lang.label_reception") ?></h1> </a>
                </div>
                <div class="col-9" style="float: left;">
                  <h1 class="header-title text-dark">
                    <?= lang('messages_lang.correction_a_receptionner_titre') ?><br>
                  </h1>
                </div>
...
<script type="text/javascript">
  function liste() {
    ...
    $("#mytable").DataTable({
      ...
      "serverSide": true,
      "ajax": {
        url: "<?= base_url('double_commande_new/Reception_TD_Non_Valide/listing') ?>",
        type: "POST",
        data: {
