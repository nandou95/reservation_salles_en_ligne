                ...
                <div style="box-shadow: rgba(100, 100, 111, 0.25) 0px 7px 29px 0px" class="card">
                  <div class="card-header">
                    <div class="col-12 d-flex">
                      <?php
                        $corrige_ordo_salaire = "btn active";
                        $ordo_deja_fait = "btn";
                  ...
                  <div class="card-body" style="margin-top: -20px">
                    ...
                    <?php endif; ?>
                    <b style="font-size:30px" class="header-title text-black"><?=lang('messages_lang.titre_ordo_salaire_faire')?></b>
                    <div class="col-md-12">
                      <div class="row">
                        <div class="col-md-4">
...
<script type="text/javascript">
  ...
  function liste() 
  {
    ...
    $("#mytable").DataTable({
      ...
      "serverSide": true,
      "ajax": {
        url:"<?= base_url('double_commande_new/Ordonnancement_Salaire_Liste/listing') ?>",
        type:"POST", 
        data:
        {
          TYPE_SALAIRE_ID,
  ...
  function exporter_excel()
  {
    ...
    document.getElementById("btnexportexcel").href = "<?=base_url('double_commande_new/Ordonnancement_Salaire_Liste/exporter_Excel_Ordo_a_faire/')?>"+'/'+TYPE_SALAIRE_ID+'/'+CATEGORIE_SALAIRE_ID+'/'+MOIS_ID+'/'+DATE_DEBUT+'/'+DATE_FIN;
  }
