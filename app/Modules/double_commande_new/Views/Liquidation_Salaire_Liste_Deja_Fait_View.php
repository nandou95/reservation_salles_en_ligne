              ...
              <div class="col-12">
                <div style="box-shadow: rgba(100, 100, 111, 0.25) 0px 7px 29px 0px" class="card">
                  ...
                  <div class="card-body" style="margin-top: -20px">
                    ...
                    <?php endif; ?>
                    <b style="font-size:30px" class="header-title text-black"><?=lang('messages_lang.liquid_salaire_deja_fait')?></b>
                    <div class="col-md-12">
                      <div class="row">
                        <div class="col-md-3">
...
<script type="text/javascript">
  function liste() 
  {
    ...
    $("#mytable").DataTable({
      ...
      "serverSide": true,
      "ajax": {
        url: "<?= base_url('double_commande_new/Liquidation_Salaire_Liste/listing_Deja_Fait') ?>",
        type: "POST",
        data: {
...
<script type="text/javascript">
  ...
  function exporter_excel()
  {
    ...
    document.getElementById("btnexportexcel").href = "<?=base_url('double_commande_new/Liquidation_Salaire_Liste/exporter_Excel_deja_fait/')?>"+'/'+CATEGORIE_SALAIRE_ID+'/'+MOIS_ID+'/'+DATE_DEBUT+'/'+DATE_FIN;
  }
</script>
