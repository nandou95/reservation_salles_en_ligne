                    ...
                    <div class="table-responsive" style="width: 100%;">
                      <table id="mytable" class=" table table-striped table-bordered">
                        <thead>
                          <tr>
                            <th>#</th>
                            <th>&nbsp;&nbsp;&nbsp;LIGNEBUDGETAIRE&nbsp;&nbsp;&nbsp;</th>
                            <th>&nbsp;&nbsp;&nbsp;TACHE&nbsp;PTBA&nbsp;&nbsp;&nbsp; </th>
                            <th>&nbsp;&nbsp;&nbsp;TACHE&nbsp;PTBA&nbsp;REVISE&nbsp;&nbsp;&nbsp;</th>
...
<script type="text/javascript">
  function liste() {
    ...
    $("#mytable").DataTable({
      ...
      "serverSide": true,
      "ajax": {
        url: "<?= base_url('double_commande_new/Liste_croisement_ptba_ptba_revise/listing') ?>",
        type: "POST",
        data: {
...
<script type="text/javascript">
 function get_task(code, provenance)
 {
   ...
   table=$("#mytable3").DataTable({
    ...
    "oreder":[],
    "ajax":{
      url:"<?= base_url('/double_commande_new/Liste_croisement_ptba_ptba_revise/detail_task')?>",
      type:"POST",
      data: {
        code:code,
