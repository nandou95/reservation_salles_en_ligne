                ...
                <div style="box-shadow: rgba(100, 100, 111, 0.25) 0px 7px 29px 0px" class="card">
                  <div class="card-header">
                    <div class="row col-md-12">
                      ...
                      <div class="col-md-3">
                        <a href="<?php echo base_url('double_commande_new/Liquidation/get_liquidation_rejeter')?>" style="float: right;margin-right: 20px;margin-top:5px" class="btn btn-primary"><i class="fa fa-list" aria-hidden="true"></i><?=lang('messages_lang.liste_bouton')?></a>
                      </div>
                    </div>
                  </div>
                  <div class="card-body">
                  ...
                  <div class=" container " style="width:100%">
                    ...
                    <form enctype='multipart/form-data' id="MyFormData" action="<?=base_url('double_commande_new/Etapes_Annulations/save_rejeter_liquid/')?>" method="post" >
                      <div class="container">
