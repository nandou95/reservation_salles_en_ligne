              ...
              <div style="box-shadow: rgba(100, 100, 111, 0.25) 0px 7px 29px 0px" class="card">
                <div class="card-header">
                  <div class="col-12 d-flex">
                    ...
                    $sign_dir_dgfp = "btn";
                    $sign_dir_min = "btn";
                    $prise_charge_salaire = "btn active";
                    $class_valid_td_net="btn";
                    $class_valid_td_autr_ret="btn"; 
                    $class_decaiss_faire="btn"; 
                    $class_valid_td_autr_ret="btn"; 
                    $class_decaiss_faire="btn" ;
              ...
              <div style="box-shadow: rgba(100, 100, 111, 0.25) 0px 7px 29px 0px" class="card">
                ...
                <div class="col-12 d-flex">
                  <div class="col-9" style="float: left;">
                    ...
                    <?= lang('messages_lang.pris_charg_salaire') ?>
                    </h1>
                  </div>
                </div>
...
<script type="text/javascript">
  ...
  function exporter_excel() {
    ...
    document.getElementById("btnexportexcel").href = "<?=base_url('double_commande_new/Paiement_Salaire_Liste/exporter_Excel_prise_charge')?>/"+'/'+TYPE_SALAIRE_ID+'/'+CATEGORIE_SALAIRE_ID+'/'+MOIS_ID+'/'+DATE_DEBUT+'/'+DATE_FIN;
  }
...
<script type="text/javascript">
  function liste() {
    ...
    $("#mytable").DataTable({
      ...
      "serverSide": true,
      "ajax": {
        url: "<?= base_url('double_commande_new/Paiement_Salaire_Liste/listing_prise_charge') ?>",
        type: "POST",
        data: {
          TYPE_SALAIRE_ID,
