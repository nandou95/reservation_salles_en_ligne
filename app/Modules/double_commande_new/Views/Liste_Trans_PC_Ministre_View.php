            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <div class="col-12 d-flex">
                    ...
                    $get_ordon_BorderCabinet1="btn active";
              ...
              <div style="box-shadow: rgba(100, 100, 111, 0.25) 0px 7px 29px 0px" class="card">
                ...
                <div style="margin-right: 20px; float: right;">
                  <a href="<?= base_url("double_commande_new/Reception_First_Bord_Transmission/reception_ministre") ?>" class='btn btn-primary' style="float: right;"> <?= lang("messages_lang.Transmission_TD") ?></h1> </a>
                </div>
...
<script type="text/javascript">
  ...
  function liste()
  {
    ...
    $("#mytable").DataTable({
      ...
      "serverSide": true,
      "ajax": {
        url: "<?= base_url('double_commande_new/Liste_Trans_PC_Ministre/listing') ?>",
        type: "POST",
      },
