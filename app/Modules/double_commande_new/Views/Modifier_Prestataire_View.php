                    ...
                    <div class="row" style="margin :  5px">
                      ...
                      <div class="col-4">
                        <div class="form-group">
                          ...
                          <select class="form-control" name="EXECUTION_BUDGETAIRE_ID" id="EXECUTION_BUDGETAIRE_ID" onchange="checkSelect(this);get_info()">
                      ...
                      <div class="col-4">
                        <div class="form-group">
                          ...
                          <select class="form-control" name="PRESTATAIRE_ID" id="PRESTATAIRE_ID" onchange="checkSelect(this)" >
                            <option value=""><?=lang('messages_lang.labelle_selecte')?></option>
                          </select>
                          <?php if (isset($validation)) : ?>
