               ...
               <div class="card-body">
                 ...
                 <div class="card-body" style="margin-top: -20px">
                   ...
                   <div style="float: right;">
                     <a href="<?php echo base_url('double_commande_new/Liste_Paiement/vue_correct_etab_titre')?>"
                  ...
                  <form
                  action="<?=base_url('double_commande_new/Phase_comptable/save_correction_pc_etablissement')?>"
                  ...
                  <div class="col-md-12 container " style="border-radius:10px">
                    ...
                    <div class="row mt-3">
                      <div class="col-md-6"><br>
                        ...
                        id="numero_decaissement_id" class="form-control" value="<?=$correct['TITRE_DECAISSEMENT']?>" >
                      ...
                      <div class="col-md-6"><br>
                        ...
                        <input type="date" min="<?=date('Y-m-d', strtotime($date_trans['DATE_TRANSMISSION']))?>"  name="date_elaboration"
                        max="<?= date('Y-m-d')?>" id="date_elaboration_id" class="form-control" value="<?=date('Y-m-d')?>">
                      ...
                      <input type="text" name="NOM_PERSONNE_RETRAIT" id="NOM_PERSONNE_RETRAIT" class="form-control" value="<?=$correct['NOM_PERSONNE_RETRAIT']?>">
                    ...
                    <div class="col-md-6"><br>
                      ...
                      <select onchange="" name="DEVISE_TYPE_ID_RETRAIT" id="DEVISE_TYPE_ID_RETRAIT" class="form-control">
                        ...
                        foreach($get_device as $key) { 
                          if ($key->DEVISE_TYPE_ID==set_value('TYPE_MONTANT_ID') || $key->DEVISE_TYPE_ID==$correct['DEVISE_TYPE_ID_RETRAIT']) { 
                    ...
                    <div class="col-md-6"><br>
                      ...
                      onkeypress="return false"  max="<?= date('Y-m-d')?>"  min="<?= date('Y-m-d')?>" id="date_transmission_id" class="form-control" value="<?=date('Y-m-d')?>">
...
<script>
  function save_dossier()
  {
    ...
    var number_decaissement_id= $('#number_decaissement_id').val();
        ...
        // {
        //     statut = false;
        //     $("#NOM_PERSONNE_RETRAIT_error").html("<?= lang('messages_lang.validation_message')?>");
        // }
