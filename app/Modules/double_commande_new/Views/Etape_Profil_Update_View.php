            ...
            <div class="col-12">
              <div style="box-shadow: rgba(100, 100, 111, 0.25) 0px 7px 29px 0px" class="card">
                ...
                <div class="card-body">
                  ...
                  <form id="my_form" action="<?= base_url('double_commande_new/Etape_Double_Commande_Profil/update') ?>" method="POST">

                    <div class="row col-md-12">
                      <input type="hidden" name="ETAPE_DOUBLE_COMMANDE_ID" id="ETAPE_DOUBLE_COMMANDE_ID" value="<?=$step_prof['ETAPE_DOUBLE_COMMANDE_ID']?>">
                      <div class="col-md-6">
                        <br>
                        ...
                        <select class="form-control" name="ETAPE_DOUBLE_COMMANDE_ID" id="ETAPE_DOUBLE_COMMANDE_ID" onchange="next_step()">
                          ...
                          <?php  foreach ($etapes as $keys) { ?>
                            <?php if($keys->ETAPE_DOUBLE_COMMANDE_ID ==set_value('ETAPE_DOUBLE_COMMANDE_ID') || $keys->ETAPE_DOUBLE_COMMANDE_ID==$step_prof['ETAPE_DOUBLE_COMMANDE_ID']) { ?>
                      ...
                      <div class="col-md-6">
                        ...
                        <select class="form-control select2" multiple name="PROFIL_ID[]" id="PROFIL_ID">
                          ...
                          <?php foreach ($profil as $keys) { ?>
                            <?php if (in_array($keys->PROFIL_ID, $prof_id)) { ?>
