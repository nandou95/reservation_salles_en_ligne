            ...
            <div class="col-12">
              ...
              <div style="box-shadow: rgba(100, 100, 111, 0.25) 0px 7px 29px 0px" class="card">
                ...
                <div class="col-md-12">
                    ...
                    <h3 class="text-dark">
                    <?= lang('messages_lang.valid_td_net') ?>
                    </h3>
                </div>
...
<script type="text/javascript">
  ...
  function exporter_excel() 
  {
    ...
    document.getElementById("btnexportexcel").href = "<?=base_url('double_commande_new/Paiement_Salaire_Liste/exporter_Excel_validate_td_salaire_net')?>/"+DATE_DEBUT+'/'+DATE_FIN;
  }
</script>
...
<script type="text/javascript">
  function liste() {
    ...
    $("#mytable").DataTable({
      ...
      "serverSide": true,
      "ajax": {
        url: "<?= base_url('double_commande_new/Paiement_Salaire_Liste/listing_valide_td_net') ?>",
        type: "POST",
        data: {
