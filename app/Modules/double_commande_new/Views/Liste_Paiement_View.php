              ...
              <div style="box-shadow: rgba(100, 100, 111, 0.25) 0px 7px 29px 0px" class="card">
                ...
                <div class="col-12 d-flex">
                  <div class="col-9" style="float: left;">
                    ...
                    <?= lang('messages_lang.liste_payement') ?>
                    </h1>
                  </div>
                </div>
                <div class="row col-md-12">
                  ...
                  <div class="col-md-4">
                    ...
                    <label for="Nom" class="form-label"><?= lang('messages_lang.etape_action') ?></label>
                    <select onchange="liste();" class="form-control" name="ETAPE_DOUBLE_COMMANDE_ID" id="ETAPE_DOUBLE_COMMANDE_ID">
                    <option value=""> <?= lang('messages_lang.labelle_selecte') ?> </option>
                      <?php
                      foreach ($etapes as $key) {
                        if ($key->ETAPE_DOUBLE_COMMANDE_ID == set_value('ETAPE_DOUBLE_COMMANDE_ID')) {
                          echo "<option value='" . $key->ETAPE_DOUBLE_COMMANDE_ID . "'  selected>" . $key->DESC_ETAPE_DOUBLE_COMMANDE . "</option>";
                        } else {
                          echo "<option value='" . $key->ETAPE_DOUBLE_COMMANDE_ID . "' >" . $key->DESC_ETAPE_DOUBLE_COMMANDE . "</option>";
                        }
                      }
                      ?>
                    </select>
                  ...
                  <div class="table-responsive container ">
                    ...
                    <table id="mytable" class=" table table-bordered table-striped">
                      ...
                      <tr class="text-uppercase">
                          ...
                          <th> <?= lang('messages_lang.active_decaissement') ?> </th>
                          <th> <?= lang('messages_lang.sous_activite_decaissement') ?> </th>
                          <th> <?= lang('messages_lang.etape_action') ?> </th>
...
<script>
  function sous_titre() {
    ...
    if (INSTITUTION_ID == '') {
      ...
      $.ajax({
        url: "<?= base_url() ?>/double_commande_new/Liste_Paiement/get_sous_titre/" + INSTITUTION_ID,
        type: "GET",
        dataType: "JSON",
...
<script type="text/javascript">
  function liste() {
    ...
    $("#mytable").DataTable({
      ...
      "serverSide": true,
      "ajax": {
        url: "<?= base_url('double_commande_new/Liste_Paiement/listing') ?>",
        type: "POST",
        data: {
