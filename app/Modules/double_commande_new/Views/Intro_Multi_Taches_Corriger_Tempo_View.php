                ...
                <div style="box-shadow: rgba(100, 100, 111, 0.25) 0px 7px 29px 0px" class="card">
                  ...
                  <div class="car-body">
                    ...
                    <div class=" container " style="width:90%">
                      <form enctype='multipart/form-data' name="myEtape1" id="myEtape1" >
                        <div class="container">
                          ...
                          <div class="row" style="border:1px solid #ddd;border-radius:5px">
                            <div class="col-md-7 mt-3 ml-2"style="margin-bottom:50px" >
                              <div class="row">
                                ...
                                <input type="hidden" name="EXECUTION_BUDGETAIRE_TACHE_TEMPO_ID" id="EXECUTION_BUDGETAIRE_TACHE_TEMPO_ID" value="<?= !empty($tempo['EXECUTION_BUDGETAIRE_TACHE_TEMPO_ID']) ? $tempo['EXECUTION_BUDGETAIRE_TACHE_TEMPO_ID'] : '' ?>">
                                <input type="hidden" id="get_taux_id" value="<?=$tempo['DEVISE_TYPE_ID']?>">
                                <div class="col-md-6">
                                  <div class='form-froup'>
                                    ...
                                    <select onchange="get_sousTutel();get_inst();" class="select2 form-control" name="INSTITUTION_ID" id="INSTITUTION_ID">
                                      ...
                                      <?php  foreach ($institutions as $keys) { ?>
                                        <?php if($keys->INSTITUTION_ID==$tempo['INSTITUTION_ID']) { ?>
                                ...
                                <div class="col-md-6">
                                  ...
                                  <input type="text" class="form-control" id="NOTE_REFERENCE" name="NOTE_REFERENCE" value="<?= !empty($tempo['NOTE_REFERENCE']) ? $tempo['NOTE_REFERENCE'] : '' ?>">
                              ...
                              <div class="row">
                                  ...
                                  <div class='form-froup'>
                                    ...
                                    <select class="select2 form-control" id="SOUS_TUTEL_ID" value="<?=set_value('SOUS_TUTEL_ID') ?>" name="SOUS_TUTEL_ID" onchange="get_code()">
                                      ...
                                      <?php foreach($sous_titre as $keys) { 
                                        if ($keys->SOUS_TUTEL_ID==$tempo['SOUS_TITRE_ID']) { 
                                  ...
                                  <div class="form-froup">
                                    ...
                                    <select onchange="get_change();"  class="form-control form-select bg-light select2" id="CODE_NOMENCLATURE_BUDGETAIRE_ID" name="CODE_NOMENCLATURE_BUDGETAIRE_ID" placeholder="Sélectionnez l'action" autocomplete="off" aria-label=".form-select-lg example">
                                      ...
                                      <?php foreach($get_ligne as $ligne) { 
                                        if ($ligne->CODE_NOMENCLATURE_BUDGETAIRE_ID==$tempo['CODE_NOMENCLATURE_BUDGETAIRE_ID']) { 
                                ...
                                <div class="col-md-6" id="act_id" hidden="true" >
                                  <div class="form-froup">
                                    ...
                                    <select onchange="get_taches()" class="form-control form-select bg-light select2" id="PAP_ACTIVITE_ID" name="PAP_ACTIVITE_ID" placeholder="Sélectionnez l'activité" autocomplete="off" aria-label=".form-select-lg example" >
                                      ...
                                      {
                                        if ($activite->PAP_ACTIVITE_ID==$tempo['PAP_ACTIVITE_ID'])
                                        { 
                                ...
                                <div class="col-md-6" id="num_montant_transfert">
                                  <div class="form-froup">
                                    ...
                                    <select onchange="get_TacheMoney()" class="form-control form-select bg-light select2" id="PTBA_TACHE_ID" name="PTBA_TACHE_ID" placeholder="Sélectionnez la tache" autocomplete="off" aria-label=".form-select-lg example" >
                                      ...
                                      { 
                                        if ($tache->PTBA_TACHE_ID==$tempo['PTBA_TACHE_ID'])
                                        { 
                                ...
                                <div class="col-md-6">
                                  <div class='form-froup'>
                                    ...
                                    <select class="form-control" name="TYPE_ENGAGEMENT_ID" id="TYPE_ENGAGEMENT_ID">
                                      ...
                                      { 
                                        if ($key->TYPE_ENGAGEMENT_ID==$tempo['TYPE_ENGAGEMENT_ID'])
                                        { 
                                ...
                                <div class="col-md-6">
                                  <div class="form-froup">
                                    ...
                                    <select onchange="money_devise();" name="TYPE_MONTANT_ID" id="TYPE_MONTANT_ID" class="form-control">
                                      ...
                                      {
                                        if ($dev->DEVISE_TYPE_ID==$tempo['DEVISE_TYPE_ID'])
                                        { 
                                ...
                                <div class="col-md-6" id="mon_dev" hidden="true">
                                  ...
                                  <input onpaste="return false;" onkeyup="fois();" oninput="formatInputValue(this);" onkeydown="moneyDevise();" value="<?=number_format($tempo['MONTANT_ENG_BUDGETAIRE_DEVISE'],0,',',' ')?>" type="text" class="form-control" name="MONTANT_EN_DEVISE" id="MONTANT_EN_DEVISE">
                                  <input type="hidden" name="engagement_devise" id="engagement_devise" value="<?=$tempo['MONTANT_ENG_BUDGETAIRE_DEVISE']?>">
                                ...
                                <div class="col-md-6" id="cou_chang" hidden="true">
                                  ...
                                  <input value="<?=number_format($tempo['TAUX'],4,'.',' ')?>"  type="text" class="form-control" name="COUS_ECHANGE" id="COUS_ECHANGE" oninput="formatInputValue(this);" onkeyup="fois();" onkeydown="moneyDevise();">
                                  <input type="hidden" name="engagement_cous" id="engagement_cous" value="<?=$tempo['TAUX']?>">
                                ...
                                <div class="col-md-6" id="racc_dev"  hidden="true">
                                  <div class="form-froup">
                                    ...
                                    <input type="text" class="form-control " name="ENG_BUDGETAIRE_devise" id="ENG_BUDGETAIRE_devise" value="<?=$tempo['MONTANT_ENG_BUDGETAIRE_DEVISE']?>" readonly>
                                ...
                                <div class="col-md-6" id="date_dev"  hidden="true">
                                  ...
                                  <input type="date" value="<?= $retVal = (!empty($tempo['DATE_COUR_DEVISE'])) ? $tempo['DATE_COUR_DEVISE'] : '' ;  ?>"  max="<?= date('Y-m-d')?>"  class="form-control" onkeypress="return false" name="DATE_COUT_DEVISE" id="DATE_COUT_DEVISE">
                                ...
                                <div class="col-md-6" id="racc_bif">
                                  <div class="form-froup">
                                    <label class="form-label"><?= lang('messages_lang.label_engage') ?> <font color="red">*</font></label>
                                    <input onpaste="return false;" value="<?=number_format($tempo['MONTANT_ENG_BUDGETAIRE'],4,',',' ')?>" type="text" class="form-control " name="ENG_BUDGETAIRE" id="ENG_BUDGETAIRE" placeholder="0" onpaste="return false;" min="0" oninput="formatInputValue(this);" onkeydown="moneyRestant()" onkeyup="moneyRestant();calculer()" >
                                    <font color="red" id="error_ENG_BUDGETAIRE"></font>
                                    <?php if (isset($validation)) : ?>
                                      <?= $validation->getError('ENG_BUDGETAIRE'); ?>
                                    <?php endif ?>
                                    <br>
                                    <input type="hidden" name="engagement_budget" id="engagement_budget" value="<?=$tempo['MONTANT_ENG_BUDGETAIRE']?>">
                                  </div>
                                </div>                                                                          
                                        
                                <div class="col-md-6">
                                  <label for=""><?= lang('messages_lang.label_obje') ?><font color="red">*</font></label>
                                  <textarea class="form-control" name="COMMENTAIRE" id="COMMENTAIRE"><?= $retVal = (!empty($tempo['COMMENTAIRE'])) ? $tempo['COMMENTAIRE']:'';?></textarea>
                                ...
                                <div class="col-md-6" id="id_termine" hidden="true">
                                  <div class="form-froup">
                                    ...
                                    <input type="hidden" name="fini123" value="<?=$tempo['EST_FINI_TACHE']?>">
                                ...
                                <div class="col-md-6" id="id_qte" hidden="false">
                                  <div class="form-froup">
                                    ...
                                    <input type="hidden" name="qte123" value="<?=$tempo['QTE']?>">
                                    <input onpaste="return false;" type="text" maxlength="20" class="form-control allownumericwithdecimal" name="QTE" id="QTE" placeholder="0" value="<?=$tempo['QTE']?>" onkeydown="qte();" onkeyup="qte();" onpaste="return false;" min="1">
                                ...
                                <div class="col-md-6" id="id_res" hidden="true">
                                  <div class="form-froup">
                                    ...
                                    <input type="hidden" name="attend" value="<?=$tempo['RESULTAT_ATTENDUS']?>">
                                    <input onpaste="return false;" type="text" maxlength="20" class="form-control allownumericwithdecimal" name="resultat_attend" id="resultat_attend" placeholder="" value="<?=$tempo['RESULTAT_ATTENDUS']?>" onpaste="return false;" min="1" onkeydown="qte();" onkeyup="qte();">
                                ...
                                <div class="col-md-6" id="obs_res" hidden="true">
                                  ...
                                  <input type="hidden" name="obser11" id="obser11" value="<?=$tempo['OBSERVATION_RESULTAT']?>">
                                  <textarea maxlength="250" class="form-control" name="observ" id="observ"><?=$tempo['OBSERVATION_RESULTAT']?></textarea>
    ...
    else
    {
      $.ajax(
      {
        ...
        success: function(data)
        {
          ...
          {
            $('#montant_restant').val(data.budg_restant_annuel);
            $('#restant').val(data.budg_restant_annuel_formate);
          }
...
<script type="text/javascript">
  function save_tempo()
  {
    var TEMPO_ID = $('#EXECUTION_BUDGETAIRE_TACHE_TEMPO_ID').val();
    var INSTITUTION_ID = $('#INSTITUTION_ID').val();
    var SOUS_TUTEL_ID = $('#SOUS_TUTEL_ID').val();
    ...
    let url="<?=base_url('double_commande_new/Introduction_Budget_Multi_Taches/save_correct_tempo')?>";
    $.post(url,
    {
      TEMPO_ID:TEMPO_ID,
      INSTITUTION_ID:INSTITUTION_ID,
    ...
    function (data) {
      ...
      {   
        ...
        window.location.href = "<?=base_url('double_commande_new/Introduction_Budget_Multi_Taches/etape1')?>";
