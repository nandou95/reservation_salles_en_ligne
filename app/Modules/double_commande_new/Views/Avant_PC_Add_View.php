              ...
              <div style="box-shadow: rgba(100, 100, 111, 0.25) 0px 7px 29px 0px" class="card">
                <div class="card-header">
                  <div class="row col-md-12">
                    ...
                    <div class="col-md-3" style="float: right;">
                      <a href="<?php echo base_url('double_commande_new/Liste_Avant_PC') ?>" style="float: right;margin-right: 20px" class="btn btn-primary"><i class="fa fa-list" aria-hidden="true"></i> <?= lang('messages_lang.list_transmission_du_bordereau') ?> </a>
                    </div>
                  </div>
                </div>
                <hr>
               <br>
                ...
                <div class="card-body">
                  ...
                  <form id="my_form" action="<?= base_url('double_commande_new/Avant_PC/save') ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row col-md-12">
                      <div class="col-md-6">
                        ...
                        <select class="form-control select2" multiple name="EXECUTION_BUDGETAIRE_TITRE_DECAISSEMENT_ID[]" id="EXECUTION_BUDGETAIRE_TITRE_DECAISSEMENT_ID">
                          ...
                          <div class="col-md-6">
                        <br>
                        <label><?= lang('messages_lang.labelle_affect') ?> <span style="color: red;">*</span></label>
                        <select class="form-control select2" name="AFFECT_USER_ID" id="AFFECT_USER_ID">
                          <option value=""><?= lang('messages_lang.selectionner_transmission_du_bordereau') ?></option>
                          <?php  foreach ($pers_affect as $keys) { ?>
                            <?php if($keys->USER_ID==set_value('AFFECT_USER_ID')) { ?>
                              <option value="<?=$keys->USER_ID ?>" selected>
                                <?=$keys->NOM.'  '.$keys->PRENOM ?></option>
                              <?php }else{?>
                               <option value="<?=$keys->USER_ID ?>">
                                <?=$keys->NOM.'  '.$keys->PRENOM ?></option>
                              <?php } }?>
                            </select>
                            <span id="error_affect" class="text-danger"></span>
                            <?php if (isset($validation)) : ?>
                              <?= $validation->getError('AFFECT_USER_ID'); ?>
                            <?php endif ?>
                          </div>
                          ...
                          <div class="col-md-6">
                            <br>
                            <div class="">
                              <label for=""> <?= lang('messages_lang.date_de_reception_avant') ?> <span style="color: red;">*</span></label>
                          ...
                          <div class="col-md-6">
                            <br>
                            <label><?= lang('messages_lang.label_date_transmission_') ?><span style="color: red;">*</span></label>
            ...
            <div class="table-responsive  mt-3">
              <table class="table m-b-0 m-t-20">
                <tbody>
                  ...
                  <tr>
                    <td style="width:350px;"><i class="fa fa-cogs"></i> &nbsp;<strong><?= lang('messages_lang.labelle_affect') ?></strong></td>
                    <td id="AFFECT_VERIFY" class="text-dark"></td>
                  </tr>
                  <tr>
...
<script type="text/javascript">
  ...
  if (AFFECT_USER_ID === '') {
    $('#error_affect').html('<?= lang('messages_lang.champ_obligatoire_transmission_du_bordereau') ?>');
    statut = 1;
  }
  ...
  if (statut === 2) {
    ...
    $('#AFFECT_VERIFY').html($('#AFFECT_USER_ID option:selected').text());
