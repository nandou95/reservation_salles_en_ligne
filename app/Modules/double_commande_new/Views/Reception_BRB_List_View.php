...
<script>
  function liste()
  {
    ...
    $("#mytable").DataTable(
    {
      ...
      "ajax":
      {
        url:"<?= base_url('double_commande_new/Reception_BRB/liste_reception_brb')?>",
        type:"POST", 
        data:{} 
      },
...
function get_detail_titre(id)
  {
    ...
    var row_count ="1000000";
       table=$("#mytable2").DataTable({
          ...
          "oreder":[],
          "ajax":{
            url:"<?= base_url('/double_commande_new/Reception_BRB/liste_titre_decaissement')?>",
            type:"POST",
            data: {
              id:id
...
<div class="modal fade" id="detail">
  ...
  function get_doc(id)
  {
    ...
    $.ajax(
    {
      url:"<?=base_url()?>/double_commande_new/Reception_BRB/get_path_bord/"+id,
      type:"POST",
      dataType:"JSON",
