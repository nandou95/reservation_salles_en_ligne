...
<div class="table-responsive" style="width: 100%;">
  <div class="d-flex justify-content-between align-items-end">
    ...
    {
    ?>
      <a href="<?=base_url('double_commande_new/Controles_Decaissement/controle_brb')?>" class="<?= $sousmenu2 == 'controle_brb' ? 'btn-menu btn active' : 'btn-menu btn'?>"><div class="btn-menu-text"> <p class="menu-text"><?=lang('messages_lang.controle_brb')?></p></div> <div class="menu-link"><span><?=$controle_brb?></span></div></a>
    <?php
    }
    ?>
    <?php
    ...
    {
    ?>
      <a href="<?=base_url('double_commande_new/Controles_Decaissement/controle_besd')?>" class="<?= $sousmenu2 == 'controle_besd' ? 'btn-menu btn active' : 'btn-menu btn'?>"><div class="btn-menu-text"> <p class="menu-text"><?=lang('messages_lang.controle_besd')?></p></div> <div class="menu-link"><span><?=$controle_besd?></span></div></a>
    <?php
    }
    ?>
    <?php
    ...
    {
    ?>
      <a href="<?=base_url('double_commande_new/Controles_Decaissement/correction_a_transmettre')?>" class="<?= $sousmenu2 == 'correction_a_transmettre' ? 'btn-menu btn active' : 'btn-menu btn'?>"><div class="btn-menu-text"> <p class="menu-text"><?=lang('messages_lang.correction_a_transmettre')?></p></div> <div class="menu-link"><span><?=$controle_a_corriger?></span></div></a>
    <?php
    }
    ?>
    <?php
