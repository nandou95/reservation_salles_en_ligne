...
<div class="table-responsive" style="width: 100%;">
	<div class="d-flex justify-content-between align-items-end">
		...
		<?php
		if($session->get('SESSION_SUIVIE_PTBA_ENGAG_JURIDIQUE')==1 || $session->get('SESSION_SUIVIE_PTBA_ENGAG_JURIDIQUE_CONFIRM_CED')==1|| $session->get('SESSION_SUIVIE_PTBA_ENGAG_JURIDIQUE_CORRECTION')==1|| $session->get('SESSION_SUIVIE_PTBA_ENGAG_JURIDIQUE_ANNULER')==1)
		{
			?>
		...
		<?php
		if($session->get('SESSION_SUIVIE_PTBA_ENGAG_JURIDIQUE_ANNULER')==1)
		{
			?>
