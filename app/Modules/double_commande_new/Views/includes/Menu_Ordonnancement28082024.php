...
<div class="table-responsive" style="width: 100%;">
	<div class="d-flex justify-content-between align-items-end">
		...
		{
			?>
			<a href="<?=base_url('double_commande_new/Ordonnancement_Double_Commande/get_ordon_Afaire_sup')?>" class="<?=$get_ordon_Afaire_sup1?> btn-menu"><div class="btn-menu-text"> <p class="menu-text"><?=lang('messages_lang.ordonnancement_cabinet')?></p></div> <div class="menu-link"><span><?=$get_ordon_Afaire_sup?></span></div></a>
			<?php
		}
		?>
		...
		{
			?>
			<a href="<?=base_url('double_commande_new/Ordonnancement_Ministre')?>" class="<?=$get_ordon_AuCabinet1?> btn-menu"><div class="btn-menu-text"> <p class="menu-text"><?=lang('messages_lang.trans_bon_eng_cabinet')?></p></div> <div class="menu-link"><span><?=$get_ordon_AuCabinet?></span></div></a>
			<?php
		}
		?>
		...
		{
			?>
			<a href="<?=base_url('double_commande_new/Liste_Trans_PC_Ministre')?>" class="<?=$get_ordon_BorderCabinet1?> btn-menu"><div class="btn-menu-text"> <p class="menu-text"><?=lang('messages_lang.trans_bord_cabinet_spe')?></p></div> <div class="menu-link"><span><?=$get_ordon_BorderCabinet?></span></div></a>
			<?php
		}
		?>
		...
		{
			?>
			<a href="<?=base_url('double_commande_new/Ordonna_Dir_Budg_Vers_Ced/liste')?>" class="<?=$get_ordon_BonCED1?> btn-menu"><div class="btn-menu-text"> <p class="menu-text"><?=lang('messages_lang.trans_bon_eng_ced')?></p></div> <div class="menu-link"><span><?=$get_ordon_BonCED?></span></div></a>
			<?php
		}
		?>
	</div>
