...
<div class="table-responsive" style="width: 100%;">
  <div class="d-flex justify-content-between align-items-end">
    ...
    // {
      echo '<a href="'.base_url('double_commande_new/Liquidation_Salaire_Liste/index_Deja_Fait').'" class="'.$liq_deja_fait.' btn-menu"><div class="btn-menu-text"> <p class="menu-text">'.lang('messages_lang.liquid_salaire_deja_fait').'</p></div> <div class="menu-link"><span>'.$nbr_liq_deja_fait.'</span></div></a>';
