...
<div class="table-responsive" style="width: 100%;">
	<div class="d-flex justify-content-between align-items-end">
		...
		if($session->get('SESSION_SUIVIE_PTBA_CONFIRM_LIQUIDATION')==1)
		{
			...
			<a href="<?=base_url('double_commande_new/Ordonnancement_Vers_Ced/liste')?>" class="<?=$nbr_from_ord1?> btn-menu"><div class="btn-menu-text"> <p class="menu-text"><?=lang('messages_lang.menu_liquid_from_ordo')?></p></div> <div class="menu-link"><span><?=$nbr_from_ord?></span></div></a>
			<?php
		}
