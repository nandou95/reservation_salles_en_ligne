...
<div class="table-responsive" style="width: 100%;">
	<div class="d-flex justify-content-between align-items-end">
		...
		if($session->get('SESSION_SUIVIE_PTBA_ETABLISSEMENT_TITRE_DECAISSEMENT')==1)
		{
			...
			<a href="<?=base_url('double_commande_new/Reception_TD_Non_Valide')?>" class="<?= $sousmenu == 'Reception_TD_Non_Valide' ? 'btn-menu btn active' : 'btn-menu btn'?>"><div class="btn-menu-text"> <p class="menu-text"><?=lang('messages_lang.correction_a_receptionner')?></p></div> <div class="menu-link"><span><?=$get_recep_td_corriger?></span></div></a>
