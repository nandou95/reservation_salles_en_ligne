            ...
            <div style="box-shadow: rgba(100, 100, 111, 0.25) 0px 7px 29px 0px" class="card">
                <div class="card-header">
                 ...
                 <div class="col-12 d-flex">
                  <?php 
                    ...
                    $get_liquid_Acorriger1="btn active";
              ...
              <div style="box-shadow: rgba(100, 100, 111, 0.25) 0px 7px 29px 0px;padding: 13px !important" class="card">
                <div class="car-body">
                  ...
                  <b style="font-size:20px" class="header-title text-black"><?=lang('messages_lang.liste_liquid_corr')?></b><br><br>
             
                  <div class="col-md-12">
                    <div class="row">
                      <div class="col-md-4">
                        <label><?=lang('messages_lang.Lab_jur_instit')?></label>
                        <select autofocus onchange="getSousTutel();listing_liquid_Acorriger()" class="form-control select2" id="INSTITUTION_ID" name="INSTITUTION_ID">
                      ...
                      <div class="col-md-4">
                        ...
                        <select onchange="listing_liquid_Acorriger()" class="form-control" name="SOUS_TUTEL_ID" id="SOUS_TUTEL_ID">
                          <option value="">-<?=lang('messages_lang.selection_message')?>-</option>
                        </select>
                      </div>
                    </div>
...
function listing_liquid_Acorriger()
{
  ...
  $("#mytable").DataTable(
  {
    ...
    "ajax":
    {
      url:"<?= base_url('double_commande_new/Liquidation_Double_Commande/listing_liquid_Acorriger')?>",
      type:"POST", 
      data:
      {
