        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-12">
               ...
               <div class="col-12 d-flex">
                ...
                <div class="col-9" style="float: left;">
                  <h1 class="header-title text-dark">
                    <?= lang('messages_lang.correction_a_transmettre_titre') ?><br>
                  </h1>
                </div>
                <div style="margin-right: 20px; float: right;">
                  <a href="<?= base_url("double_commande_new/Transmission_Brb_MinFin/transmettre") ?>" class='btn btn-primary' style="float: right;"> <?= lang("messages_lang.Transmission_TD") ?></h1> </a>
                </div>
              ...
              <div class="mt-2 ml-3" style ="max-width: 15%;">
...
<script type="text/javascript">
  ...
  function exporter_excel() 
  {
    ...
    document.getElementById("btnexportexcel").href = "<?=base_url('double_commande_new/Controles_Decaissement/exporter_excel_controle_a_transmettre')?>/"+INSTITUTION_ID+"/"+SOUS_TUTEL_ID+"/"+DATE_DEBUT+"/"+DATE_FIN;
  }
</script >
...
<script type="text/javascript">
  function liste() 
  {
    ...
    $("#mytable").DataTable({
      ...
      "serverSide": true,
      "ajax": {
        url: "<?= base_url('double_commande_new/Controles_Decaissement/correction_a_transmettre_listing')?>",
        type: "POST",
        data: {
...
<script type="text/javascript">
  function exporter_pdf() 
  {
    ...
    document.getElementById("btnexportpdf").href = "<?=base_url('double_commande_new/Controles_Decaissement/generatePdf')?>/"+INSTITUTION_ID+"/"+SOUS_TUTEL_ID;
  }
</script>
...
<script type="text/javascript">
  function get_task(id)
  {
    ...
    table=$("#mytable3").DataTable({
      ...
      "oreder":[],
      "ajax":{
        url:"<?= base_url('/double_commande_new/Controles_Decaissement/detail_task')?>",
        type:"POST",
        data: {
          task_id:task_id
        }
