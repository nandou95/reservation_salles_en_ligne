    ...
    <div class="main">
      ...
      <div class="col-md-12 d-flex" style="float:left;">
        <div class="col-md-12">
          ...
          <center><h3>Détail du sous titre:<?=$get_det_vote['DESCRIPTION_SOUS_TUTEL']?><hr></h3></center>
          <div class="row">
            <div class="col-md-4">
              <div class="col-md-12">
              ...
              <div class="col-md-12">
                <table class="table table-bordered">
                  ...
                  <tr>
                    <td>Nombre</td>
                    <td><?=number_format($programme['NBR_PROG'],get_precision($programme['NBR_PROG']),',',' ')?></td>
                  </tr>
                </table>
              </div>
              <div class="col-md-12">
