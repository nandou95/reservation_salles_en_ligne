            ...
            <div class="col-12">
              ...
              <div style="box-shadow:rgba(100, 100, 111, 0.25) 0px 7px 29px 0px;padding: 13px !important" class="card">
                <div class="car-body">
                  ...
                  <b style="font-size:20px" class="header-title text-black"><?=lang('messages_lang.dir_budg_vers_ced') ?></b><br><br>

                  <div class="col-md-12">
                    <div class="row">
                      <div class="col-md-4">
                        <label><?=lang('messages_lang.Lab_jur_instit')?></label>
                        <select autofocus onchange="listing();sous_titre()" class="form-control select2" id="INSTITUTION_ID" name="INSTITUTION_ID">
                        ...
                        <div class="col-md-4">
                          ...
                          <select onchange="listing()" class="form-control" name="SOUS_TUTEL_ID" id="SOUS_TUTEL_ID">
                            <option value="">--<?=lang('messages_lang.selection_message') ?>--</option>
                          </select>
                        </div>
                      </div>
                    ...
                    <div style="margin-right: 20px; float: right;">
                      <a href="<?= base_url("double_commande_new/Ordonna_Dir_Budg_Vers_Ced/add") ?>" class='btn btn-primary' style="float: right;"> <?= lang("messages_lang.Transmission_TD") ?></h1> </a>
                    </div>
  ...
  <script>
    function listing()
    {
      ...
      $("#mytable").DataTable(
      {
        ...
        "ajax":
        {
          url:"<?= base_url('double_commande_new/Ordonna_Dir_Budg_Vers_Ced/listing')?>",
          type:"POST", 
          data:
          {
  ...
  <script>
    function sous_titre()
    {
      ...
      else
      {
        $.ajax(
        {
          url:"<?=base_url()?>/double_commande_new/Ordonna_Dir_Budg_Vers_Ced/get_sous_titre/"+INSTITUTION_ID,
          type:"GET",
          dataType:"JSON",
