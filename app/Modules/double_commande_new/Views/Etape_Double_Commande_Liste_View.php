                 ...
                 <div class="row col-md-12">
                  <div class="col-md-9" style="float: left;">
                    <h1 class="header-title text-black">
                      <?=lang('messages_lang.liste_etap_db_com')?>
                    </h1>
                  </div>
                  <div class="col-md-3" style="float: right;">
                    <a href="Etape_Double_Commande/add" style="float: right;" class="btn btn-primary"><i class="fa fa-plus" aria-hidden="true"></i> <?=lang('messages_lang.labelle_et_nouveau')?> </a>
                  </div>
                </div>
              </div>              
              <div class="card-body">
                    ...
                    <table id="mytable" class=" table table-striped table-bordered">
                      <thead>
                        <tr>
                          ...
                          <th class="text-uppercase" style="white-space: nowrap;" ><?= lang('messages_lang.label_mouv_dep')?></th>
                          <th class="text-uppercase" style="white-space: nowrap;" ><?= lang('messages_lang.table_statut')?></th>
                          <th>OPTIONS</th>
                        </tr>
                      </thead>
                      <tbody>
...
<script>
  $(document).ready(function()
  {
    ...
    $("#mytable").DataTable(
    {
      ...
      "ajax":
      {
        url:"Etape_Double_Commande/listing",
        type:"POST", 
      },
