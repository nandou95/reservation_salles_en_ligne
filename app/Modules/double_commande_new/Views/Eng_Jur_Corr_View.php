              ...
              <div style="box-shadow: rgba(100, 100, 111, 0.25) 0px 7px 29px 0px" class="card">
                <div class="card-header">
                  <div class="col-md-12">
                    ...
                    $get_jurid_Acorriger1="btn active";
                ...
                <div class="card-body">
                  <div style="margin-left: 15px;" class="row">
                    <h1 class="header-title text-dark"><?=lang('messages_lang.titre_jur_corriger')?></h1>
                  </div>
                  <div style="margin-left: 15px;" class="row">
                    <div class="col-md-6">
...
<script type="text/javascript">
  function liste() 
  {
    ...
    $("#mytable").DataTable({
      ...
      "ajax":
      {
        url: "<?= base_url('double_commande_new/Menu_Engagement_Juridique/listing_jur_corriger')?>",
        type: "POST",
        data:
        {
