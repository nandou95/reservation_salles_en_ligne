...
<script type="text/javascript">
  function liste() 
  {
    ...
    $("#mytable").DataTable({
      ...
      "serverSide": true,
      "ajax": {
        url: "<?= base_url('double_commande_new/Suivi_Execution/listing_engag_jurd_a_faire')?>",
        type: "POST",
        data: {
...
<script type="text/javascript">
  ...
  if (DATE_FIN == '' || DATE_FIN == null) {DATE_FIN = 0}
     document.getElementById("btnexportexcel").href = "<?=base_url('double_commande_new/Suivi_Execution/exporter_Excel_Eng_Jur_Faire')?>/"+INSTITUTION_ID+"/"+SOUS_TUTEL_ID+"/"+DATE_DEBUT+"/"+DATE_FIN;
  }
