            ...
            <div class="col-12">
              <div style="box-shadow: rgba(100, 100, 111, 0.25) 0px 7px 29px 0px" class="card">
                <div class="card-header">
                  <div class="col-12 d-flex">
                    ...
                    $decaissement_deja_fait="btn active";
               ...
               <div class="col-12 d-flex">
                ...
                <div class="col-9" style="float: left;">
                  <h1 class="header-title text-dark">
                    <?= lang('messages_lang.header_titre_decaisement') ?><br>
                  </h1>
                </div>
              ...
              <div class="row col-md-12">
                <div class="col-md-6">
                    ...
                    <select onchange="liste();sous_titre();vider()" class="form-control select2" name="INSTITUTION_ID" id="INSTITUTION_ID">
...
<script>
  function sous_titre()
  {
    ...
    else
    {
      $.ajax(
      {
        url:"<?=base_url()?>/double_commande_new/Liste_Decaissement_Deja_Fait/get_sous_titre/"+INSTITUTION_ID,
        type:"GET",
        dataType:"JSON",
...
<script type="text/javascript">
  function liste() 
  {
    ...
    $("#mytable").DataTable({
      ...
      "serverSide": true,
      "ajax": {
        url: "<?= base_url('double_commande_new/Liste_Decaissement_Deja_Fait/listing')?>",
        type: "POST",
        data: {
  ...
  function exporter_excel() {
   ...
   if (INSTITUTION_ID == '' || INSTITUTION_ID == null) {INSTITUTION_ID = 0}
     if (SOUS_TUTEL_ID == '' || SOUS_TUTEL_ID == null) {SOUS_TUTEL_ID = 0}
      if (INSTITUTION_ID!==0) {
       document.getElementById("btnexportexcel").href = "<?=base_url('double_commande_new/Liste_Decaissement_Deja_Fait/exporter_Excel')?>/"+INSTITUTION_ID+"/"+SOUS_TUTEL_ID;
     }else{
  ...
  function exporter_pdf() {
   ...
   if (INSTITUTION_ID == '' || INSTITUTION_ID == null) {INSTITUTION_ID = 0}
     if (SOUS_TUTEL_ID == '' || SOUS_TUTEL_ID == null) {SOUS_TUTEL_ID = 0}
       ...
       document.getElementById("btnexportpdf").href = "<?=base_url('double_commande_new/Liste_Decaissement_Deja_Fait/generatePdf')?>/"+INSTITUTION_ID+"/"+SOUS_TUTEL_ID;
   }
