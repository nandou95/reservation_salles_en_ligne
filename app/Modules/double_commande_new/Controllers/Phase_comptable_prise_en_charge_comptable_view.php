                ...
                <div class="container-fluid">
                    ...
                    <div class="row" style="margin-top: -5px">
                        <div class="col-12">
                            <div style="box-shadow: rgba(100, 100, 111, 0.25) 0px 7px 29px 0px" class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="<?= base_url('double_commande_new/Phase_comptable/save_prise_en_charge_comptable') ?>" id="MyFormData" method="post" enctype="multipart/form-data">
                                        ...
                                        <input type="hidden" name="TYPE_INSTITUTION_FIN_ID" id="TYPE_INSTITUTION_FIN_ID" value="<?= $id['TYPE_INSTITUTION_ID'] ?>">
                              ...
                              <div id="autre_banq" class="col-md-4" style="display: none">
                                <div class="">
                                    <br>
                            ...
                            <div id="autre_adresse" class="col-md-4" style="display: none">
                                <div class="">
                                    <br>
                            ...
                            <div class="col-md-4">
                                <div class="">
                                    ...
                                    <input type="" name="num_compte" onKeyDown="check_caractere1()" id="num_compte_id" class="form-control">
...
<script type="text/javascript">
  ...
  if (id.includes("-1")) {
    ...
    $('#autre_adresse').delay(100).show('hide');
    ...
    disableOption(selectElement);
  } else {
    $('#autre_banq').delay(100).hide('show');
    $('#autre_adresse').delay(100).hide('show');
    $('#DESCRIPTION_BANQUE').val('');
    $('#DESCRIPTION_BANQUE').attr('placeholder', '<?=lang('messages_lang.autr_banq')?>');
    $('#ADRESSE_BANQUE').val('');
    $('#ADRESSE_BANQUE').attr('placeholder', '<?=lang('messages_lang.labelle_adresse')?>');
...
function enableOption(selectElement) {
  for (var i = 0; i < selectElement.options.length; i++) {
    selectElement.options[i].disabled = false;
  }
}
