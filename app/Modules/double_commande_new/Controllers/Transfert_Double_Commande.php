...
class Transfert_Double_Commande extends BaseController
{
  ...
  public function liste_tempo($value='')
  {
    ...
    $sql='SELECT PTBA_TACHE_ID_TRANSFERT,TRIMESTRE_ID,MONTANT_RESTANT_TRANSFERT,MONTANT_TRANSFERT,PTBA_TACHE_ID_RECEVOIR,MONTANT_RESTANT_RECEVOIR,MONTANT_RECEVOIR,USER_ID,TEMPO_TRANSFERT_DOUBLE_COMMANDE_ID,MOTIF_TACHE_ID,NOM,PRENOM,POSTE,AUTORISATION_TRANSFERT FROM  transfert_tempo_transfert_double_commande WHERE 1 AND USER_ID='.$USER_ID.' ORDER BY TEMPO_TRANSFERT_DOUBLE_COMMANDE_ID  DESC  ';
    ...
    $html.='<br>
      ...
      <th class="text-uppercase" style="white-space: nowrap;" >Tranche</th>
  ...
  public function addToCart()
  {
    ...
    $columsinsert="PTBA_TACHE_ID_TRANSFERT,TRIMESTRE_ID,MONTANT_RESTANT_TRANSFERT,MONTANT_TRANSFERT,PTBA_TACHE_ID_RECEVOIR,MONTANT_RESTANT_RECEVOIR,MONTANT_RECEVOIR,USER_ID,MOTIF_TACHE_ID,NOM,PRENOM,POSTE,AUTORISATION_TRANSFERT";
    $datacolumsinsert=$PTBA_TACHE_ID_TRANSFERT.",".$TRIMESTRE_ID.",".$MONTANT_RESTANT_TRANSFERT.",".$MONTANT_TRANSFERT.",".$PTBA_TACHE_ID_RECEVOIR.",".$MONTANT_RESTANT_RECEVOIR.",".$MONTANT_RECEVOIR.",".$USER_ID.",".$MOTIF_TACHE_ID.",'".$NOM."','".$PRENOM."','".$POSTE."','".$AUTORISATION_TRANSFERT."'";
  ...
  public function send_data($value='')
  {
    ...
    foreach ($tempo as $key => $value)
    {
      ...
      $datacolumsinsert=$TYPE_OPERATION_ID.",".$USER_ID.",".$value->MONTANT_TRANSFERT.",".$value->PTBA_TACHE_ID_TRANSFERT.",".$value->MONTANT_RECEVOIR.",".$value->PTBA_TACHE_ID_RECEVOIR.",".$value->TRIMESTRE_ID.",'".$value->AUTORISATION_TRANSFERT."'";
      ...
      if($value->TRIMESTRE_ID==1)
      {
        ...
        //cas receptrice
        $MONTANT_RESTANT_T1_RECEVOIR = $data_tache2['BUDGET_RESTANT_T1']+$value->MONTANT_RECEVOIR;
        $data2='BUDGET_RESTANT_T1 = '.$MONTANT_RESTANT_T1_RECEVOIR.'';
      ...
      else if ($value->TRIMESTRE_ID==2)
      {
        ...
        //cas receptrice
        $MONTANT_RESTANT_T2_RECEVOIR = $data_tache2['BUDGET_RESTANT_T2']+$value->MONTANT_RECEVOIR;
        $data2='BUDGET_RESTANT_T2 = '.$MONTANT_RESTANT_T2_RECEVOIR.'';
        $this->update_all_table($table,$data2,$where2);
      }
      else if ($value->TRIMESTRE_ID==3)
      {
        ...
        //cas receptrice
        $MONTANT_RESTANT_T3_RECEVOIR = $data_tache2['BUDGET_RESTANT_T3']+$value->MONTANT_RECEVOIR;
        $data2='BUDGET_RESTANT_T3 = '.$MONTANT_RESTANT_T3_RECEVOIR.'';
        $this->update_all_table($table,$data2,$where2);
      }
      else if ($value->TRIMESTRE_ID==4)
      {
        ...
        //cas receptrice
        $MONTANT_RESTANT_T4_RECEVOIR = $data_tache2['BUDGET_RESTANT_T4']+$value->MONTANT_RECEVOIR;
        $data2='BUDGET_RESTANT_T4 = '.$MONTANT_RESTANT_T4_RECEVOIR.'';
        $this->update_all_table($table,$data2,$where2);
      }
      else if ($value->TRIMESTRE_ID==5)
      {
        ...
        else if ($dataCount==2)
        {
          ...
          $MONTANT_RESTANT_T3_RECEVOIR = $data_tache2['BUDGET_RESTANT_T3']+$value->MONTANT_RECEVOIR;
          $MONTANT_RESTANT_T4_RECEVOIR = $data_tache2['BUDGET_RESTANT_T4']+$value->MONTANT_RECEVOIR;
          $data2='BUDGET_RESTANT_T3='.$MONTANT_RESTANT_T3_RECEVOIR.', BUDGET_RESTANT_T4='.$MONTANT_RESTANT_T4_RECEVOIR.'';
          $this->update_all_table($table,$data2,$where2);
        }
        else if ($dataCount==3)
        {
          ...
          $MONTANT_RESTANT_T3_RECEVOIR = $data_tache2['BUDGET_RESTANT_T3']+$value->MONTANT_RECEVOIR;
          $MONTANT_RESTANT_T4_RECEVOIR = $data_tache2['BUDGET_RESTANT_T4']+$value->MONTANT_RECEVOIR;
          $data2='BUDGET_RESTANT_T2='.$MONTANT_RESTANT_T2_RECEVOIR.', BUDGET_RESTANT_T3='.$MONTANT_RESTANT_T3_RECEVOIR.', BUDGET_RESTANT_T4='.$MONTANT_RESTANT_T4_RECEVOIR.'';
          $this->update_all_table($table,$data2,$where2);
        }
        else if ($dataCount==4)
        {
          ...
          $MONTANT_RESTANT_T3_RECEVOIR = $data_tache2['BUDGET_RESTANT_T3']+$value->MONTANT_RECEVOIR;
          $MONTANT_RESTANT_T4_RECEVOIR = $data_tache2['BUDGET_RESTANT_T4']+$value->MONTANT_RECEVOIR;
          $data2='BUDGET_RESTANT_T4='.$MONTANT_RESTANT_T1_RECEVOIR.', BUDGET_RESTANT_T2='.$MONTANT_RESTANT_T2_RECEVOIR.', BUDGET_RESTANT_T3='.$MONTANT_RESTANT_T3_RECEVOIR.',  BUDGET_RESTANT_T4='.$MONTANT_RESTANT_T4_RECEVOIR.'';
          $this->update_all_table($table,$data2,$where2);
        }
      }
  ...
  public function listing_Transfert()
  {
    ...
    $query_principal = 'SELECT h.HISTORIQUE_TRANSFERT_ID, h.PTBA_TACHE_ID_TRANSFERT, h.TRIMESTRE_ID, h.MONTANT_RECEPTION, h.MONTANT_TRANSFERT, h.PTBA_TACHE_ID_RECEPTION, h.AUTORISATION_TRANSFERT,
                ...
                WHERE 1 AND inst.INSTITUTION_ID IN ('.$ID_INST.')';
