...
class Avant_OBR extends BaseController
{
  protected $session;
  protected $ModelPs;
  ...
  function save()
  {
    ...
    //print_r( $id_etape);exit();
    $etape_request = $this->getBindParms('ETAPE_DOUBLE_COMMANDE_SUIVANT_ID', 'execution_budgetaire_etape_double_commande_config', 'ETAPE_DOUBLE_COMMANDE_ACTUEL_ID='.$id_etape.' AND IS_SALAIRE=0', 'ETAPE_DOUBLE_COMMANDE_SUIVANT_ID ASC');
