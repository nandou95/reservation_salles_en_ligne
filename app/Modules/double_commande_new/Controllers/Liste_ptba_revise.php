...
class Liste_ptba_revise extends BaseController
{
  protected $session;
  protected $ModelPs;
  ...
  public function index ()
  {
   ...
   $data['nbre_tache_non_trouves']=$count_data_croisement['nbre_tache_non_trouves'];
    ...
    return view('App\Modules\double_commande_new\Views\Liste_ptba_revise_View', $data);
  }
  ...
  public function listing ()
  {
    ...
    return $this->response->setJSON($output); //echo json_encode($output);
     ...
     // ça retourne le nombre de chiffres après la virgule de la partie decimale du nombre passé en paramètres
