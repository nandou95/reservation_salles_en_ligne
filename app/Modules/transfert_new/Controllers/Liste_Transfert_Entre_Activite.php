...
/*
* auteur:christa
* tache: liste des transferts qui sont déjà effectués entre activités 
* date: 04/11/2023
* mail: christa@mediabox.bi
*/
...
class Liste_Transfert_Entre_Activite extends BaseController
{	
	...
	public function index()
	{
		...
		return view('App\Modules\transfert_new\Views\Liste_Transfert_Entre_Activite_View',$data);   
	}

	/* fonction pour faire la liste  des transferts entre activites */
	public function liste()
	{
		...
		$institution=' AND execution_budgetaire.INSTITUTION_ID IN(SELECT INSTITUTION_ID FROM user_affectaion WHERE USER_ID='.$user_id.')';
	...
	//affichage de la preuve de transfert
