                ...
                <div class="car-body">
                  ...
                  <div class="header-title text-black">
                    <div class="row col-md-12">
                      <div class="col-md-6">
                        <h6 style="margin-bottom:12px" class="ml-2"><?=lang('messages_lang.liste_des_transferts')?></h6>
                      </div>
                      <div class="col-md-6">
                        <a href="<?=base_url('transfert_new/Transfert_Entre_Deux_Activite/add') ?>" style="float: right;margin: 4px;" class="btn btn-primary"><span class="fa fa-plus pull-right"></span> <?=lang('messages_lang.labelle_et_nouveau')?></a>
                      </div>
                    </div>
                  </div>
...
<script type="text/javascript">
  $(document).ready(function ()
  {
    ...
    $("#mytable").DataTable(
    {
      ...
      "ajax":
      {
        url:"<?= base_url('transfert_new/Liste_Transfert_Entre_Activite/liste')?>",
        type:"POST"
      },
