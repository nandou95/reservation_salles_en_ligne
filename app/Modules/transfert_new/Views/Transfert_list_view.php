          ...
          <div class="row">
            ...
            <div style="box-shadow: rgba(100, 100, 111, 0.25) 0px 7px 29px 0px;padding: 13px !important" class="card">
              <div class="car-body">
                ...
                <div class="header-title text-black"><h4 style="margin-bottom:12px" class="ml-2"> <?=lang('messages_lang.trans_impu_ligne_budg')?> </h4></div>
...
<script type="text/javascript">
  $(document).ready(function ()
  {
    ...
    $("#mytable").DataTable(
    {
      ...
      "oreder":[[ 0, 'desc' ]],
      "ajax":{
        url:"<?= base_url('transfert_new/Transfert/listing')?>",
        type:"POST"
      },
...
<script type="text/javascript">
  function show_modal(id) {
    $.ajax({
      url: "<?= base_url() ?>/transfert_new/Transfert/libelleCall/" + id,
      type: "POST",
      dataType: "JSON",
