...
<script type="text/javascript">
  function get_rapport(){
   ...
   $.ajax({
    url : "<?=base_url('dashboard/Dashboard_Avancement_Statut/get_rapport_statut')?>",
    type : "POST",
    dataType: "JSON",
    cache:false,
    data:{
...
<script type="text/javascript">
  ...
  if (document.getElementById('IS_PRIVATE1').checked) {
    ...
    $("#list_table").DataTable(
    {
      ...
      "serverSide":true,
      "ajax":{
        url:"<?= base_url('dashboard/Dashboard_Avancement_Statut/listing')?>",
        type:"POST",
        data:{
          IS_PRIVATE:IS_PRIVATE,
          ANNEE_BUDGETAIRE_ID:ANNEE_BUDGETAIRE_ID,
...
<script type="text/javascript">
  ...
  if (document.getElementById('IS_PRIVATE1').checked) {
    ...
    if (ANNEE_BUDGETAIRE_ID == '' || ANNEE_BUDGETAIRE_ID == null) {ANNEE_BUDGETAIRE_ID = 0}
      ...
      document.getElementById("btnexport").href = "<?=base_url('dashboard/Dashboard_Avancement_Statut/exporter/')?>"+'/'+IS_PRIVATE+'/'+ANNEE_BUDGETAIRE_ID;
  }
</script>