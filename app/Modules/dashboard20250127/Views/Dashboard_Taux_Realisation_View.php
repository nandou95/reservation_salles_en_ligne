    ...
    <div class="main">
      ...
      <main class="content">
                 ...
                 <div class="row">
                   <div class="col-md-12">
                    <h1 class="header-title text-black">
                     Taux d’efficience par activité et taux de réalisation physique </h1>
                   </div>
       ...
       <?=$inst_connexion?>
        ...
        <div class="form-group col-md-3"id="id_action" style="display: none;"> 
          <label><b>Actions</b></label>
          <select class="form-control" onchange="get_rapport()" name="ACTION_ID" id="ACTION_ID">
          ...
          <div class="modal-content  ">
            ...
            <div class="modal-body">
              <table style="width: 100%;" id='mytable' class='table table-bordered table-striped table-hover table-condensed table-responsive'>
                ...
                <th style='width:90px'><center><font color="white" size="3"><label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspActivités&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</label></font></center></th>
                <th style='width:70px'><center><font color="white" size="3"><label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspResultats&nbspattendus&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</label></font></center></th>
                 <th style='width:70px'><center><font color="white" size="3"><label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspActions&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</label></font></center></th>
                  ...
                  <th style='width:70px'><center><font color="white" size="3"><label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspProgrammes&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</label></font></center></th>
                 
                
                 
                 <th style='width:70px'><center><font color="white" size="3"><label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<a id="idpro"></a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</label></font></center></th>
...
<script type="text/javascript">
  ...
  var inst_conn=$('#inst_conn').val();
    ...
    $.ajax({
      url : "<?=base_url('dashboard/Dashboard_Taux_Realisation/get_Taux_Realisation')?>",
      type : "GET",
      dataType: "JSON",
      cache:false,
      data:{
