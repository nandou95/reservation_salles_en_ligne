                 ...
                 <div class="row">
                   <div class="col-md-12">
                    <h1 class="header-title text-black">
                      <?=lang('messages_lang.tbd_comparaison_budget')?> 
                    </div>
                  </h1>
                  <?=$inst_connexion?>
                  ...
                  <div class="col-md-2" style="margin-top:35px;">
                    <input type="radio" onchange="get_rapport()" name="IS_PRIVATE" id="IS_PRIVATE5" value="5" >
                  ...
                  <div class="form-group col-md-4"> 
                    ...
                    <select class="form-control" onchange="liste();get_act()" name="ACTION_ID" id="ACTION_ID">
                        ...
                        <div class="modal-body">
                          <table style="width: 100%;" id='mytable' class='table table-bordered table-striped table-hover table-condensed table-responsive'>
                            <thead>
                             ...
                             <th style='width:70px'><center><font color="white" size="3"><label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp;<?=lang('messages_lang.labelle_activite')?>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</label></font></center></th>
                             <th style='width:70px'><center><font color="white" size="3"><label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<?=lang('messages_lang.labelle_action')?>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</label></font></center></th>
                             <th style='width:50px'><center><font color="white" size="3"><label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<?=lang('messages_lang.labelle_programme')?>s&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</label></font></center></th>
                             ...
                             <th style='width:50px'><center><font color="white" size="3"><label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbspDate&nbsp&nbsp&nbsp&nbsp&nbsp</label></font></center></th>
                           </thead>
                         </table>  
                       </div>
            ...
            <div style="box-shadow: rgba(100, 100, 111, 0.25) 0px 7px 29px 0px;padding: 13px !important" class="card">
              <div class="car-body">
                <div class="row col-md-12">
                  <div class="col-md-12">
                    <h5 class="header-title text-black"><?=lang('messages_lang.tbd_comparaison_budget')?> </h5>
...
<script type="text/javascript">
  function get_rapport(){
    ...
    $.ajax({
      url : "<?=base_url('dashboard/Dashboard_Comparaison_Budget/get_rapport')?>",
      type : "GET",
      dataType: "JSON",
      cache:false,
      data:{
...
<script type="text/javascript">
  ...
  function liste(){
    ...
    $("#list_table").DataTable(
    {
      ...
      "serverSide":true,
      "ajax":{
        url:"<?= base_url('dashboard/Dashboard_Comparaison_Budget/listing')?>",
        type:"POST",
        data:{
          TYPE_INSTITUTION_ID:TYPE_INSTITUTION_ID,
          INSTITUTION_ID:INSTITUTION_ID,
...
<script type="text/javascript">
  function exporter()
  {
    ...
    if (PAP_ACTIVITE_ID == '' || PAP_ACTIVITE_ID == null) {PAP_ACTIVITE_ID = 0}
      ...
      document.getElementById("btnexport").href = "<?=base_url('dashboard/Dashboard_Comparaison_Budget/exporter/')?>"+'/'+TYPE_INSTITUTION_ID+'/'+INSTITUTION_ID+'/'+PROGRAMME_ID+'/'+ACTION_ID+'/'+IS_PRIVATE+'/'+LIGNE_BUDGETAIRE+'/'+PAP_ACTIVITE_ID;
  }
</script>