      ...
      <div class="col-12">
        <div style="box-shadow: rgba(100, 100, 111, 0.25) 0px 7px 29px 0px" class="card">
          <div class="card-header">
           ...
           <h1 class="header-title text-black"><?=lang('messages_lang.pip_rapport_programme_budge_titre_titre')?>
       </h1>
                  ...
                  <div style="box-shadow: rgba(100, 100, 111, 0.25) 0px 7px 29px 0px;padding: 13px !important" class="card">
                    <div class="car-body">
                      <div class="row col-md-12">
                        <div class="col-md-12">
                          <h3 class="header-title text-black"><?=lang('messages_lang.pip_rapport_programme_budge_titre')?> </h3>
...
$.ajax({
  url : "<?=base_url('dashboard/Rapport_Objectif_strategique_Programme/Get_Strategique')?>",
  type : "GET",
  dataType: "JSON",
  cache:false,
  data:{
  ...
  function listing()
    {
      ...
      var inst_conn=$('#inst_conn').val();
        ...
        $("#mytable1").DataTable({
          ...
          "oreder":[[ 0, 'desc' ]],
          "ajax":{
            url:"<?= base_url('dashboard/Rapport_Objectif_strategique_Programme/liste')?>",
            type:"POST", 
             data:{
               ID_OBJECT_STRATEGIQUE:ID_OBJECT_STRATEGIQUE,
               INSTITUTION_ID:INSTITUTION_ID,
...
function exporter()
  ...
  var ID_OBJECT_STRATEGIQUE = $('#ID_OBJECT_STRATEGIQUE').val();
    ...
    document.getElementById("btnexport").href = "<?=base_url('dashboard/Rapport_Objectif_strategique_Programme/exporter/')?>"+'/'+INSTITUTION_ID+'/'+ID_OBJECT_STRATEGIQUE;
}
</script>
