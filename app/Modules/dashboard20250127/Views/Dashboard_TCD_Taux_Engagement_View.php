    ...
    <div class="main">
      ...
      <main class="content">
       ...
       <!-- Tableau croisé dynamique avec taux sur engagement -->
          <?=lang('messages_lang.titre_taux_engagement')?>
       </h1>
        </div>
       <?=$inst_connexion?>
              ...
              <div class="modal-body">
                <table style="width: 100%;" id='mytable' class='table table-bordered table-striped table-hover table-condensed table-responsive'>
                  <thead>
                   ...
                   <th style='width:100px'><font color="white" size="3"><label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<?=lang('messages_lang.admin_perso')?>/<?=lang('messages_lang.minister')?>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</label></font></th>
                    <th style='width:70px'><center><font color="white" size="3"><label>&nbsp&nbsp&nbsp&nbsp&nbsp<?=lang('messages_lang.labelle_programme')?>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</label></font></center></th>
                   <th style='width:70px'><center><font color="white" size="3"><label> &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<?=lang('messages_lang.labelle_action')?>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</label></font></center></th>
                    <th style='width:70px'><center><font color="white" size="3"><label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<?=lang('messages_lang.label_resultant_attendus')?>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</label></font></center></th>
                     <th style='width:90px'><center><font color="white" size="3"><label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<?=lang('messages_lang.labelle_activites')?>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</label></font></center></th>
                   <th style='width:70px'><center><font color="white" size="3"><label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<a id="idpro"></a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</label></font></center></th>
                    <th style='width:70px'><center><font color="white" size="3"><label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<?=lang('messages_lang.table_date_engag')?>&nbsp&nbsp</label></font></center></th>
                 </thead>
               </table>  
             </div>
             <div class="modal-footer">
              <button type="button" id="btnSave" onclick="saveData()" class="btn btn-primary"><?=lang('messages_lang.label_ferm')?></th></button>
            </div>
          </div>
        </div> 
      </div>  
...
<div  class="container" style= "width:95%">
  ...
  <table id="mytable1" class="table table-bordered" style="width:100%">
    <thead>
      ...
      <th>Nomenclature&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspBudgétaire</th>
...
// alert(IS_PRIVATE);
    ...
    $.ajax({
      url : "<?=base_url('dashboard/Dashboard_TCD_Taux_Engagement/get_Performence_Excution_engage')?>",
      type : "GET",
      dataType: "JSON",
      cache:false,
      data:{
...
<script>
  function liste_programme()
  {
    ...
    $("#mytable1").DataTable({
      ...
      "serverSide": true,
      "ajax": {
        url:"<?= base_url('dashboard/Dashboard_TCD_Taux_Engagement/liste_institution_phase_engages')?>",
        type: "POST",
...
<script type="text/javascript">
  function exporter()
  {
    ...
    document.getElementById("btnexport").href = "<?=base_url('dashboard/Dashboard_TCD_Taux_Engagement/exporter/')?>"+'/'+TYPE_INSTITUTION_ID+'/'+INSTITUTION_ID+'/'+INSTITUTION_ID+'/'+ACTION_ID+'/'+PAP_ACTIVITE_ID+'/'+LIGNE_BUDGETAIRE+'/'+SOUS_TUTEL_ID+'/'+PROGRAMME_ID;
          }
        </script>