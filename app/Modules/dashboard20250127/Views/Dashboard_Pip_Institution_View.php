...
$.ajax({
  url : "<?=base_url('dashboard/Dashboard_Pip_Institution/Get_institution')?>",
  type : "GET",
  dataType: "JSON",
  cache:false,
...
<script type="text/javascript">
  ...
  function liste(){
    ...
    $("#list_table").DataTable(
    {
      ...
      "oreder":[[ 0, 'desc' ]],
      "ajax":{
        url:"<?= base_url('dashboard/Dashboard_Pip_Institution/listing')?>",
        type:"POST",
        data:{INSTITUTION_ID:INSTITUTION_ID,
        ID_AXE_INTERVENTION_PND:ID_AXE_INTERVENTION_PND
      },
...
function exporter()
  ...
  var ID_AXE_INTERVENTION_PND = $('#ID_AXE_INTERVENTION_PND').val();
    ...
    document.getElementById("btnexport").href = "<?=base_url('dashboard/Dashboard_Pip_Institution/exporter/')?>"+'/'+INSTITUTION_ID+'/'+ID_AXE_INTERVENTION_PND;
}
</script>
