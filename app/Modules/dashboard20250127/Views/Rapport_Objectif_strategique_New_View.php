      ...
      <div class="col-12">
        <div style="box-shadow: rgba(100, 100, 111, 0.25) 0px 7px 29px 0px" class="card">
          <div class="card-header">
           ...
           <h1 class="header-title text-black"><?=lang('messages_lang.pip_rapport_institutio_budget')?>
       </h1>
...
$.ajax({
  url : "<?=base_url('dashboard/Rapport_Objectif_strategique_New/Get_Strategique')?>",
  type : "GET",
  dataType: "JSON",
  cache:false,
  data:{
  ...
  function listing()
    {
      ...
      var inst_conn=$('#inst_conn').val();
        ...
        $("#mytable1").DataTable({
          ...
          "oreder":[[ 0, 'desc' ]],
          "ajax":{
            url:"<?= base_url('dashboard/Rapport_Objectif_strategique_New/liste')?>",
            type:"POST", 
             data:{
               ID_OBJECT_STRATEGIQUE:ID_OBJECT_STRATEGIQUE,
               INSTITUTION_ID:INSTITUTION_ID,
...
function exporter()
  ...
  var ID_OBJECT_STRATEGIQUE = $('#ID_OBJECT_STRATEGIQUE').val();
    ...
    document.getElementById("btnexport").href = "<?=base_url('dashboard/Rapport_Objectif_strategique_New/exporter/')?>"+'/'+INSTITUTION_ID+'/'+ID_OBJECT_STRATEGIQUE;
}
</script>
