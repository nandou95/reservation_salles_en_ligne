  ...
  <div class="wrapper">
    ...
    <div class="main">
      ...
      <main class="content">
       ...
       Tableau de bord :: Montant par mouvement de dépenses
       </h1>
        </div>
          ...
          <select class="form-control" onchange="get_i();" name="TYPE_INSTITUTION_ID" id="TYPE_INSTITUTION_ID">
            ...
            ?>
                 ...
                 <div class="form-group col-md-4">
                      ...
                      <select class="form-control" onchange="get_add()" name="PROGRAMME_ID" id="PROGRAMME_ID" >
                        <option value="">Sélectionner</option>
                      </select>        
                 </div>  
                  ...
                  <div class="form-group col-md-4">
                      <label><b>Activités</b></label>
                      <select class="form-control" onchange="get_rapport()" name="ACTIVITE" id="ACTIVITE">
                        <option value="">Sélectionner</option>
                      </select>        
                    </div> 
                          ...
                          <div class="modal-body">
                            <table style="width: 100%;" id='mytable' class='table table-bordered table-striped table-hover table-condensed table-responsive'>
                              <thead>
                               ...
                               <th style='width:100px'><center><font color="white" size="3"><label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspMinistères/Administrations&nbsp&nbsp&nbsppersonnalisées&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</label></font></center></th>
                               ...
                               <th style='width:70px'><center><font color="white" size="3"><label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspActions&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</label></font></center></th>
                                <th style='width:70px'><center><font color="white" size="3"><label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspRésultats&nbspattendus&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</label></font></center></th>
                                 <th style='width:90px'><center><font color="white" size="3"><label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspActivités&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</label></font></center></th>
                ...
                <div  class="container" style= "width:95%">
                  <h2 class="text-black">Liste des entités responsables</h2><br>
                     
                  <table id="mytable1" class="table table-bordered" style="width:100%">
                    <thead>
                      <tr>
                      <th>#</th>
                      <th>Ministères/Administrations&nbsp;personnalisées</th>
                      <th>Entités&nbsp;responsables</th>     
...
// alert(IS_PRIVATE);
    ...
    $.ajax({
      url : "<?=base_url('dashboard/Dashboard_TCD_Engagement_Ordo/get_Performence_Excution_engage')?>",
      type : "GET",
      dataType: "JSON",
      cache:false,
      data:{
...
<script>
  ...
  function liste_programme()
  {
    ...
    $("#mytable1").DataTable({
      ...
      "serverSide": true,
      "ajax": {
        url:"<?= base_url('dashboard/Dashboard_TCD_Engagement_Ordo/liste_institution_phase_engages')?>",
        type: "POST",
