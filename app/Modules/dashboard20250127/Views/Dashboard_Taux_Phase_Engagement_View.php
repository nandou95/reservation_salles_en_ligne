      ...
      <main class="content">
        <div class="container-fluid">
          ...
          <h1 class="header-title text-black">
           <?=lang('messages_lang.execut_phase')?>
            </div>
                </h1>
                   <?=$inst_connexion?>
                  ...
                  <div class="col-md-3" style="margin-top:35px;"> 
                   ...
                   <!--  <div class="form-group col-md-4">
                    ...
                    <div class="form-group col-md-3">
                      ...
                      <select class="form-control" onchange="get_s();liste_programme()" name="PROGRAMME_ID" id="PROGRAMME_ID">
                            ...
                            <table style="width: 100%;" id='mytable' class='table table-bordered table-striped table-hover table-condensed table-responsive'>
                              <thead>
                               ...
                               <th style='width:100px'><center><font color="white" size="3"><label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<?=lang('messages_lang.admin_perso')?>/<?=lang('messages_lang.minister')?>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</label></font></center></th>
                                ...
                                <th style='width:120px'><center><font color="white" size="3"><label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<?=lang('messages_lang.entit_respo')?>&nbsp&nbsp&nbsp</label></font></center></th> 
...
<script type="text/javascript">
 ...
 var IS_PRIVATE = document.getElementById('IS_PRIVATE5').value;
    ...
    $.ajax({
      url : "<?=base_url('dashboard/Dashboard_Taux_Phase_Engagement/execution_Croise_dynamique')?>",
      type : "GET",
      dataType: "JSON",
      cache:false,
      data:{
...
<script>
  ...
  function liste_programme()
  {
    ...
    $("#mytable1").DataTable({
      ...
      "oreder":[[ 0, 'desc' ]],
      "ajax": {
        url:"<?= base_url('dashboard/Dashboard_Taux_Phase_Engagement/liste_institution_croise_dynamiques')?>",
        type: "POST",
      ...
      lengthMenu: [
      [5,10, 50, 100, row_count], [5,10, 50, 100, "All"]],
      pageLength: 5,
      "columnDefs": [{
        "targets": [],
        "orderable": false
...
function exporter()
  ...
  var IS_PRIVATE = document.getElementById('IS_PRIVATE5').value;
   ...
   if (inst_conn == '' || inst_conn == null) {inst_conn = 0}
    ...
    document.getElementById("btnexport").href = "<?=base_url('dashboard/Dashboard_Taux_Phase_Engagement/exporter/')?>"+'/'+TYPE_INSTITUTION_ID+'/'+INSTITUTION_ID+'/'+SOUS_TUTEL_ID+'/'+PROGRAMME_ID+'/'+ACTION_ID+'/'+LIGNE_BUDGETAIRE+'/'+PAP_ACTIVITE_ID+'/'+IS_PRIVATE;
}
</script>