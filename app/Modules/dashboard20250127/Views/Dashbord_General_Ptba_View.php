                        ...
                        <div class="modal-content  ">
                          ...
                          <div class="modal-body">
                            <table style="width: 100%;" id='mytable' class='table table-bordered table-striped table-hover table-condensed table-responsive'>
                              ...
                              <th style='width:120px'><center><font color="white" size="3"><label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<?=lang('messages_lang.label_quantite')?>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</label></font></center></th>
                              <th style='width:120px'><center><font color="white" size="3"><label>&nbsp;&nbsp;&nbsp;&nbsp;<?=lang('messages_lang.label_resultant_attendus')?>&nbsp;&nbsp;&nbsp;&nbsp;</label></font></center></th>
                               <th style='width:120px'><center><font color="white" size="3"><label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<?=lang('messages_lang.label_action')?>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</label></font></center></th>
                                ...
                                <th style='width:120px'><center><font color="white" size="3"><label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<?=lang('messages_lang.label_prog')?>s&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</label></font></center></th>
...
<script type="text/javascript">
 ...
 var IS_PRIVATE = document.getElementById('IS_PRIVATE5').value;
    ...
    $.ajax({
      url : "<?=base_url('dashboard/Dashbord_General_Ptba/get_general_Rapport')?>",
      type : "GET",
      dataType: "JSON",
      cache:false,
      data:{
     ...
     success:function(data){
      ...
      $('#container_phase').html("");             
      $('#nouveau2').html(data.rapp_ONGL);
      $('#container_transfert').html("");             
      $('#nouveau5').html(data.rapp_transfert_activit);
      $('#container_recu').html("");             
      $('#nouveau6').html(data.rapp_transfert_recu);
      $('#container_decaissement').html("");             
      $('#nouveau3').html(data.rapp_decaissement);
...
<script>
  function liste()
  {
    ...
    $("#mytable2").DataTable(
    {
      ...
      "ajax":
      {
        url:"<?= base_url('dashboard/Dashbord_General_Ptba/listing_budget')?>",
        type:"POST", 
        data:
        {
          TYPE_INSTITUTION_ID:TYPE_INSTITUTION_ID,
...
function exporter()
{
  if (document.getElementById('IS_PRIVATE1').checked){
    ...
    document.getElementById("btnexport").href = "<?=base_url('dashboard/Dashbord_General_Ptba/exporter/')?>"+'/'+TYPE_INSTITUTION_ID+'/'+INSTITUTION_ID+'/'+SOUS_TUTEL_ID+'/'+PROGRAMME_ID+'/'+ACTION_ID+'/'+LIGNE_BUDGETAIRE+'/'+IS_PRIVATE+'/'+PAP_ACTIVITE_ID;
}
</script>