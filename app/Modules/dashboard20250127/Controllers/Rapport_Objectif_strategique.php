...
class Rapport_Objectif_strategique extends BaseController
{
	protected $session;
	protected $ModelPs;
    ...
    if($session->get('SESSION_SUIVIE_PTBA_TABLEAU_BORD_PIP_OBJECTIF_STRATEGIQUE')!=1)
    {
      return redirect('Login_Ptba/homepage');
		...
		return view('App\Modules\dashboard\Views\Rapport_Objectif_strategique_View',$data);
	}
												...
												events: {
													click: function(){
														...
														$(\"#mytableppppp\").DataTable({
															...
															\"oreder\":[],
															\"ajax\":{
																url:\"".base_url('dashboard/Rapport_Objectif_strategique/detail_strategique')."\",
																type:\"POST\",
																data:{
																	key:this.key,
