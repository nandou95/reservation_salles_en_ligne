   ...
   Highcharts.chart('container6',{ 
	...
	$rapp_etude="<script type=\"text/javascript\">
      ...
      'copy', 'csv', 'excel', 'pdf', 'print'
		...
		if ($ACTION_ID!= '')
		{
			$ligne_budgetaire_sect="SELECT DISTINCT ptba_tache.CODE_NOMENCLATURE_BUDGETAIRE FROM  ptba_tache JOIN inst_institutions ON inst_institutions.INSTITUTION_ID=ptba.INSTITUTION_ID WHERE 1  ";
		}else{
