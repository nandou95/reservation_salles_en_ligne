...
class Rapport_Projet_Statut extends BaseController
{
	protected $session;
	protected $ModelPs;
    ...
    $data['type_connect']=$type_connect;
		return view('App\Modules\dashboard\Views\Rapport_Projet_Statut_View',$data);
	}
    ...
    // print_r($projet_Statuts);die();
		...
		Highcharts.chart('container', {                    
			chart: {
				...
				title: {
					text: '<b>".lang("messages_lang.pip_rapport_budget_projet")." :: ".number_format($data_total,0,'',' ')." BIF '
					},
					subtitle: {
						text: 'Le ".date('d-m-Y')." '
						},
												...
												events: {
													click: function(){
														...
														$(\"#mytableppppp\").DataTable({
															...
															\"oreder\":[],
															\"ajax\":{
																url:\"".base_url('dashboard/Rapport_Projet_Statut/detail_strategique')."\",
																type:\"POST\",
																data:{
																	key:this.key,
