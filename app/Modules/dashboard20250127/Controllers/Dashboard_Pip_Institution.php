...
class Dashboard_Pip_Institution extends BaseController
{
  protected $session;
  protected $ModelPs;
...
return view('App\Modules\dashboard\Views\Dashboard_Pip_Institution_View',$data);
}
											...
											point:{
												...
												click: function(){
														...
														$(\"#mytable\").DataTable({
															...
															\"oreder\":[],
															\"ajax\":{
																url:\"".base_url('dashboard/Rapport_Pip_piliers/detail_pil')."\",
																type:\"POST\",
																data:{
																key:this.key,
																key2:this.key2,
     ...
     function exporter($INSTITUTION_ID,$ID_AXE_INTERVENTION_PND)
       {
       	...
       	return redirect('dashboard/Dashboard_Pip_Institution');
       }
      }
      ?>
