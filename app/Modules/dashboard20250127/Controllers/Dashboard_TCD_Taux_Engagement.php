...
class Dashboard_TCD_Taux_Engagement extends BaseController
{
  ...
  function detail_tcd_taux_engagements() 
  {
    ...
    $search = !empty($_POST['search']['value']) ? ("AND (
      inst_institutions.DESCRIPTION_INSTITUTION  LIKE '%$var_search%' OR inst_institutions_programmes.INTITULE_PROGRAMME LIKE '%$var_search%' OR inst_institutions_actions.LIBELLE_ACTION LIKE '%$var_search%' OR RESULTAT_PAP_ACTIVITE LIKE '%$var_search%')"  ) : '';
    ...
    foreach ($fetch_data as $row) 
    {
      ...
      if ($KEY2==1) {
        ...
        // $retdate_engage = (! empty($date_engage_req['DATE_ENGAGEMENT_JURIDIQUE'])) ? $date_engage_req['DATE_ENGAGEMENT_JURIDIQUE'] : 'N/A' ;
      }else if ($KEY2==5) {
...
foreach ($fetch_projets as $row) 
{
  ...
  // $engagement[] ='<center><font color="#000000" size=2><label>'.$obs_juridiq.'</label></font> </center>';
  $data[] = $engagement;        
}
...
// {
//   $cond1.=" AND execution_budgetaire_raccrochage_activite_new.ANNEE_BUDGETAIRE_ID=".$ANNEE_BUDGETAIRE_ID.""; 

//   $cond2.=" AND ptba_tache.ANNEE_BUDGETAIRE_ID=".$ANNEE_BUDGETAIRE_ID.""; 
// }



  $engage=("SELECT  SUM(ENG_BUDGETAIRE) AS engage FROM `execution_budgetaire` JOIN inst_institutions ON inst_institutions.INSTITUTION_ID=execution_budgetaire.INSTITUTION_ID JOIN trimestre on  trimestre.TRIMESTRE_ID=execution_budgetaire.TRIMESTRE_ID JOIN inst_institutions_sous_tutel ON inst_institutions_sous_tutel.SOUS_TUTEL_ID=execution_budgetaire.SOUS_TUTEL_ID JOIN annee_budgetaire ON annee_budgetaire.ANNEE_BUDGETAIRE_ID=execution_budgetaire.ANNEE_BUDGETAIRE_ID JOIN inst_institutions_programmes ON inst_institutions_programmes.PROGRAMME_ID=execution_budgetaire.PROGRAMME_ID JOIN inst_institutions_actions actio ON actio.ACTION_ID=execution_budgetaire.ACTION_ID JOIN pap_activites ON pap_activites.PAP_ACTIVITE_ID=execution_budgetaire.PAP_ACTIVITE_ID JOIN inst_institutions_ligne_budgetaire budg ON budg.CODE_NOMENCLATURE_BUDGETAIRE_ID=execution_budgetaire.CODE_NOMENCLATURE_BUDGETAIRE_ID JOIN ptba_tache ON ptba_tache.PTBA_TACHE_ID=execution_budgetaire.PTBA_TACHE_ID WHERE 1 ".$cond_trim." ".$cond."");

  $liquide=("SELECT  SUM(LIQUIDATION) AS liquide FROM `execution_budgetaire` JOIN inst_institutions ON inst_institutions.INSTITUTION_ID=execution_budgetaire.INSTITUTION_ID JOIN trimestre on  trimestre.TRIMESTRE_ID=execution_budgetaire.TRIMESTRE_ID JOIN inst_institutions_sous_tutel ON inst_institutions_sous_tutel.SOUS_TUTEL_ID =execution_budgetaire.SOUS_TUTEL_ID JOIN annee_budgetaire ON annee_budgetaire.ANNEE_BUDGETAIRE_ID=execution_budgetaire.ANNEE_BUDGETAIRE_ID JOIN inst_institutions_programmes ON inst_institutions_programmes.PROGRAMME_ID=execution_budgetaire.PROGRAMME_ID JOIN inst_institutions_actions actio ON actio.ACTION_ID=execution_budgetaire.ACTION_ID JOIN pap_activites ON pap_activites.PAP_ACTIVITE_ID=execution_budgetaire.PAP_ACTIVITE_ID JOIN inst_institutions_ligne_budgetaire budg ON budg.CODE_NOMENCLATURE_BUDGETAIRE_ID=execution_budgetaire.CODE_NOMENCLATURE_BUDGETAIRE_ID JOIN ptba_tache ON ptba_tache.PTBA_TACHE_ID=execution_budgetaire.PTBA_TACHE_ID  WHERE 1 ".$cond_trim." ".$cond."");


  $decaissement=("SELECT  SUM(DECAISSEMENT) as decaissement FROM `execution_budgetaire` JOIN inst_institutions ON inst_institutions.INSTITUTION_ID=execution_budgetaire.INSTITUTION_ID JOIN trimestre on  trimestre.TRIMESTRE_ID=execution_budgetaire.TRIMESTRE_ID JOIN inst_institutions_sous_tutel ON inst_institutions_sous_tutel.SOUS_TUTEL_ID =execution_budgetaire.SOUS_TUTEL_ID JOIN annee_budgetaire ON annee_budgetaire.ANNEE_BUDGETAIRE_ID=execution_budgetaire.ANNEE_BUDGETAIRE_ID JOIN inst_institutions_programmes ON inst_institutions_programmes.PROGRAMME_ID=execution_budgetaire.PROGRAMME_ID JOIN inst_institutions_actions actio ON actio.ACTION_ID=execution_budgetaire.ACTION_ID JOIN pap_activites ON pap_activites.PAP_ACTIVITE_ID=execution_budgetaire.PAP_ACTIVITE_ID JOIN inst_institutions_ligne_budgetaire budg ON budg.CODE_NOMENCLATURE_BUDGETAIRE_ID=execution_budgetaire.CODE_NOMENCLATURE_BUDGETAIRE_ID JOIN ptba_tache ON ptba_tache.PTBA_TACHE_ID=execution_budgetaire.PTBA_TACHE_ID WHERE 1 ".$cond_trim." ".$cond." ");

  $jurdique=("SELECT  SUM(ENG_JURIDIQUE) as jurdique FROM `execution_budgetaire` JOIN inst_institutions ON inst_institutions.INSTITUTION_ID=execution_budgetaire.INSTITUTION_ID JOIN trimestre on  trimestre.TRIMESTRE_ID=execution_budgetaire.TRIMESTRE_ID JOIN inst_institutions_sous_tutel ON inst_institutions_sous_tutel.SOUS_TUTEL_ID =execution_budgetaire.SOUS_TUTEL_ID JOIN annee_budgetaire ON annee_budgetaire.ANNEE_BUDGETAIRE_ID=execution_budgetaire.ANNEE_BUDGETAIRE_ID JOIN inst_institutions_programmes ON inst_institutions_programmes.PROGRAMME_ID=execution_budgetaire.PROGRAMME_ID JOIN inst_institutions_actions actio ON actio.ACTION_ID=execution_budgetaire.ACTION_ID JOIN pap_activites ON pap_activites.PAP_ACTIVITE_ID=execution_budgetaire.PAP_ACTIVITE_ID JOIN inst_institutions_ligne_budgetaire budg ON budg.CODE_NOMENCLATURE_BUDGETAIRE_ID=execution_budgetaire.CODE_NOMENCLATURE_BUDGETAIRE_ID JOIN ptba_tache ON ptba_tache.PTBA_TACHE_ID=execution_budgetaire.PTBA_TACHE_ID WHERE 1 ".$cond_trim." ".$cond."  ");

  $ordonence=("SELECT  SUM(ORDONNANCEMENT) as ordonence FROM `execution_budgetaire` JOIN inst_institutions ON inst_institutions.INSTITUTION_ID=execution_budgetaire.INSTITUTION_ID JOIN trimestre on  trimestre.TRIMESTRE_ID=execution_budgetaire.TRIMESTRE_ID JOIN inst_institutions_sous_tutel ON inst_institutions_sous_tutel.SOUS_TUTEL_ID =execution_budgetaire.SOUS_TUTEL_ID JOIN annee_budgetaire ON annee_budgetaire.ANNEE_BUDGETAIRE_ID=execution_budgetaire.ANNEE_BUDGETAIRE_ID JOIN inst_institutions_programmes ON inst_institutions_programmes.PROGRAMME_ID=execution_budgetaire.PROGRAMME_ID JOIN inst_institutions_actions actio ON actio.ACTION_ID=execution_budgetaire.ACTION_ID JOIN pap_activites ON pap_activites.PAP_ACTIVITE_ID=execution_budgetaire.PAP_ACTIVITE_ID JOIN inst_institutions_ligne_budgetaire budg ON budg.CODE_NOMENCLATURE_BUDGETAIRE_ID=execution_budgetaire.CODE_NOMENCLATURE_BUDGETAIRE_ID JOIN ptba_tache ON ptba_tache.PTBA_TACHE_ID=execution_budgetaire.PTBA_TACHE_ID WHERE 1 ".$cond_trim." ".$cond." ");

  $paiement=("SELECT  SUM(PAIEMENT) as paiement FROM `execution_budgetaire` JOIN inst_institutions ON inst_institutions.INSTITUTION_ID=execution_budgetaire.INSTITUTION_ID JOIN trimestre on  trimestre.TRIMESTRE_ID=execution_budgetaire.TRIMESTRE_ID JOIN inst_institutions_sous_tutel ON inst_institutions_sous_tutel.SOUS_TUTEL_ID =execution_budgetaire.SOUS_TUTEL_ID JOIN annee_budgetaire ON annee_budgetaire.ANNEE_BUDGETAIRE_ID=execution_budgetaire.ANNEE_BUDGETAIRE_ID JOIN inst_institutions_programmes ON inst_institutions_programmes.PROGRAMME_ID=execution_budgetaire.PROGRAMME_ID JOIN inst_institutions_actions actio ON actio.ACTION_ID=execution_budgetaire.ACTION_ID JOIN pap_activites ON pap_activites.PAP_ACTIVITE_ID=execution_budgetaire.PAP_ACTIVITE_ID JOIN inst_institutions_ligne_budgetaire budg ON budg.CODE_NOMENCLATURE_BUDGETAIRE_ID=execution_budgetaire.CODE_NOMENCLATURE_BUDGETAIRE_ID JOIN ptba_tache ON ptba_tache.PTBA_TACHE_ID=execution_budgetaire.PTBA_TACHE_ID WHERE 1 ".$cond_trim." ".$cond."");
