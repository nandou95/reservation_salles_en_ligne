              ...
              <div style="box-shadow: rgba(100, 100, 111, 0.25) 0px 7px 29px 0px;padding: 13px !important" class="card">
                <div class="col-md-12 d-flex">
                  <div class="col-md-9" style="float: left;">
                    <h4 style="margin-left: 1%;margin-top:10px"><?= lang('messages_lang.labelle_et_list_pro')?></h4>
                  </div>
                  <div class="col-md-3" style="float: right;">
                    <a href="<?php echo base_url('ihm/Processus/ajout')?>" style="float: right;margin: 40px" class="btn btn-primary"><i class="fa fa-plus" aria-hidden="true"></i> <?= lang('messages_lang.labelle_et_nouveau')?>  </a>
                  </div>
                </div>
                    ...
                    <table id="mytable" class=" table table-striped table-bordered">
                      <thead>
                        <tr>
                          ...
                          <th><?= lang('messages_lang.labelle_et_table')?></th>
                          <th><?= lang('messages_lang.labelle_et_lien')?></th>
...
<script>
  $(document).ready(function()
  {
    ...
    $("#mytable").DataTable(
    {
      ...
      "ajax":
      {
        url:"<?= base_url('ihm/Processus/listing')?>",
        type:"POST", 
      },
