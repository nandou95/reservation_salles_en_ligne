...
<body>
              ...
              <div style="box-shadow: rgba(100, 100, 111, 0.25) 0px 7px 29px 0px;padding: 13px !important" class="card">
                ...
                <div class="card-header" >
                  <div class="row col-md-12">
                    <div class="col-md-8">
                      <h1 class="header-title text-dark">Liste des Taches</h1>
                    </div>
                    <div class="col-md-4">
                      <a href="<?=base_url('ihm/Taches/create')?>" style="float: right;margin-right: 90px;margin: 10px" class="btn btn-primary"><span class="fa fa-plus pull-right"></span>Nouvelle</a> 
                    </div>
                  </div>
                </div>
                <div class="card-body">
                  ...
                  <div class="table-responsive" >
                    <table id="mytable" class=" table table-striped table-bordered" style="width: 100%;">
                      <thead>
                        <tr>
                          <th><center>#</center></th>
                          <th><center>TACHE</center></th>
                          <th><center><?=lang('messages_lang.th_resultat_attendu')?></center></th>
                          <th><center><?=lang('messages_lang.th_instit')?></center></th>
                          ...
                          <th><center>BUDGET&nbsp;T1&nbsp;&nbsp;</center></th>
                          <th><center>BUDGET&nbsp;T2&nbsp;&nbsp;</center></th>
                          <th><center>BUDGET&nbsp;T3&nbsp;&nbsp;</center></th>
                          <th><center>BUDGET&nbsp;T4&nbsp;&nbsp;</center></th>
                          <th><center>BUDGET&nbsp;ANNUEL&nbsp;&nbsp;</center></th>
                          <!-- <th>DETAILS</th> -->
                        </tr>
                      </thead>
                    </table>
  ...
  <script>
    function liste()
    {
      ...
      $("#mytable").DataTable({
        ...
        "order":[],
        "ajax":{
          url:"<?= base_url('ihm/Liste_Taches/listing')?>",
          type:"POST", 
          data:
          {
  ...
  /***********   Script pour la sélection des programmes   ***********/
    function get_programme(){
      ...
      $.post('<?=base_url('ihm/Liste_Taches/get_programme')?>',
      {
        INSTITUTION_ID:INSTITUTION_ID
      },
      function(data)
  ...
  /**************   Script pour la sélection des actions   ****************/
    function get_action(){
      ...
      $.post('<?=base_url('ihm/Liste_Taches/get_action')?>',
      {
        PROGRAMME_ID:PROGRAMME_ID
      },
      function(data)
  ...
  /**************   Script pour la sélection des actions   ****************/
    function get_pap_activite(){
      ...
      $.post('<?=base_url('ihm/Liste_Taches/get_pap_activite')?>',
      {
        ACTION_ID:ACTION_ID
      },
      function(data)
