...
<body>
    ...
    <div class="main">
                  ...
                  <div class="card-body" style="">
                    ...
                    <div class="col-md-12">
                      <div class="row">
                        ...
                        <div class="col-md-4">
                          <a href="<?=base_url('ihm/Institution') ?>" style="float: right;margin: 4px;" class="btn btn-primary"><span class="fa fa-list pull-right"></span> <?= lang('messages_lang.link_list') ?> </a>
                        </div>
                        <div class="col-md-12">
                            ...
                            <div class="modal-body">
                              <table style="width: 100%;" id='mytable' class='table table-bordered table-striped table-hover table-condensed table-responsive'>
                                <thead>
                                 ...
                                 <th style='width:70px'><center><font color="black" size="3"><label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<?= lang('messages_lang.th_activite') ?><a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</label></font></center></th>
      ...
      <script type="text/javascript">
        function liste_programme(id) {
          ...
          //"oreder": [[5, 'desc']],
          "ajax": {
            url:"<?= base_url()?>/ihm/Detail_Institution/liste_programme/"+id,
            type: "POST",
            data: {},
            beforeSend: function() {}
          },
        ...
        function liste_action(id) {
          ...
          //"oreder": [[5, 'desc']],
          "ajax": {
            url:"<?= base_url()?>/ihm/Detail_Institution/liste_action/"+id,
            type: "POST",
            data: {},
            beforeSend: function() {}
          },
      ...
      $("#mytable3").DataTable({
        ...
        "serverSide": true,
          //"oreder": [[5, 'desc']],
          "ajax": {
            url:"<?= base_url()?>/ihm/Detail_Institution/liste_activite/"+id,
            type: "POST",
            data: {},
            beforeSend: function() {}
          },
    ...
    function liste_ligne_budget(id) {
      ...
      $("#mytable4").DataTable({
        ...
        "serverSide": true,
          //"oreder": [[5, 'desc']],
          "ajax": {
            url:"<?= base_url()?>/ihm/Detail_Institution/liste_ligne_budget/"+id,
            type: "POST",
            data: {},
            beforeSend: function() {}
          },
  ...
  <script type="text/javascript">
    ...
    Highcharts.chart('container', {
      ...
      title: {
        text: '<b>Montant voté (<?=number_format($data_total,0,'',' ')?>) <br/> <?= lang('messages_lang.montant_execute') ?> (<?=number_format($data_total1,0,'',' ')?>)</b>'
      },
      subtitle: {
        text: ' '
      },
         ...
         point:{
          events: {
           click: function()
           {
            ...
            $("#titre").html("Liste des activités");
            $("#myModal").modal();
            ...
            $("#mytable").DataTable({
              ...
              "oreder":[],
              "ajax":{
                url:"<?=base_url('ihm/Detail_Institution/detail_rapport')?>",
                type:"POST",
                data:{
                  key:this.key,
                  key2:this.key2
