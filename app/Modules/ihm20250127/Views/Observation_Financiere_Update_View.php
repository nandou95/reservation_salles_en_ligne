                ...
                <div class="card-body">
                  <div class="col-md-12 d-flex">
                    <div class="col-md-9" style="float: left;">
                      <h1 class="header-title text-black"><?= lang('messages_lang.modification_observation_financiere')?></h1>
                    </div>
                  ...
                  <div class="table-responsive container " style="margin-top:50px">
                    ...
                    <form name="myform" id="myform" action="<?=base_url('ihm/Observation_Financiere/update')?>" method="POST" enctype="multipart/form-data">
                      <div class="card-body">
                        <div class="row">
                          <input type="hidden" name="OBSERVATION_FINANCIER_ID" id="OBSERVATION_FINANCIER_ID" value="<?=$financ['OBSERVATION_FINANCIER_ID']?>">
                          <div class="col-md-12">
                            <div class="form-group">
                              <label for=""><?= lang('messages_lang.th_description_fin')?><span style="color: red;">*</span></label>
                              <textarea type="text" class="form-control" id="DESC_OBSERVATION_FINANCIER" name="DESC_OBSERVATION_FINANCIER" rows="3"><?=$financ['DESC_OBSERVATION_FINANCIER']?></textarea>
